export default {
  ...
  printers: {
    ...
    startPrintOn: '{{name}}에서 인쇄 시작',
    yourFiles: '내 파일',
    printableTypesHint: '지원: .gcode, .gcode.3mf',
    uploadToPrintHint: '인쇄 가능한 파일을 여기에 놓거나 내 파일에서 선택하면 이 패널에 인쇄 옵션이 열립니다.',
    pickFromLibraryHint: '내 파일에서 인쇄 가능한 파일을 선택하면 이 패널에 인쇄 옵션이 열립니다.',
    saveToYourFiles: '내 파일에 저장',
    saveToYourFilesHint: '기본값은 끔 — 업로드는 이 인쇄에만 사용되며 미분류에 보관되지 않습니다.',
    saveLocation: '저장 위치',
    changeFile: '파일 변경',
    printOptionsAdvanced: '고급 옵션',
    noPrinterSelected: '선택된 프린터 없음',
    addPreflight: {
      checking: '연결 확인 중...',
  ...
  maintenance: {
    ...
    printerLog: '프린터 로그',
    logCustomJob: '사용자 지정 작업 기록',
    logReset: '기록 및 초기화',
    logResetTitle: '{{name}}을(를) 초기화할까요?',
    logResetMessage: '간격이 초기화되고 프린터 로그에 추가됩니다. 특별한 내용이 있을 때만 메모를 남기세요.',
    jobName: '작업',
    jobNamePlaceholder: '예: 노즐 교체',
    notes: '메모',
    notesPlaceholder: '무엇을 했나요?',
    resetNotesPlaceholder: '선택 메모…',
    partLink: '부품 링크 (선택)',
    cost: '비용 (선택)',
    saveLog: '로그에 저장',
    editLog: '로그 편집',
    editLogTitle: '로그 편집',
    logUpdated: '로그 항목이 업데이트됨',
    deleteLog: '로그 삭제',
    deleteLogTitle: '로그 항목을 삭제할까요?',
    deleteLogMessage: '프린터 로그에서 "{{name}}"을(를) 제거할까요? 예약된 초기화는 취소되지 않으며, 로그 행과 비용만 삭제됩니다.',
    logDeleted: '로그 항목이 삭제됨',
    hideTask: '숨기기',
    showTask: '표시',
    hiddenTasks: '숨긴 작업',
    hiddenTasksDescription: '숨긴 기본 작업은 그대로 보관됩니다. 하나를 표시하면 전체를 복원하지 않고 되돌릴 수 있습니다.',
    hideTaskTitle: '{{name}}을(를) 숨길까요?',
    hideTaskMessage: '상태 탭에서 사라집니다. 숨긴 작업에서 다시 표시할 수 있으므로 다시 만들거나 모든 기본 작업을 복원할 필요는 없습니다.',
    taskHidden: '작업이 숨겨짐',
    taskShown: '작업이 다시 표시됨',
    totalMaintenanceCost: '유지보수 비용',
    jobLogged: '작업이 프린터 로그에 저장됨',
    customJob: '사용자 지정 작업',
  ...
  settings: {
    ...
    manageLibraryDescription: '라이브러리 파일 업로드, 이름 변경 및 삭제',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        deleted: '프리셋 삭제됨',
        updated: '프리셋 업데이트됨',
        downloadFailed: '프리셋을 다운로드할 수 없습니다',
      },
      noSearchResults: '검색어와 일치하는 프리셋이 없습니다',
      partSections: {
        title: '부품 프로세스 섹션',
        addSection: '프로세스 섹션 추가',
        sectionName: '섹션 이름',
        trackParameters: '파라미터 추적',
        trackParametersHelp: '켜면 프로세스가 인쇄 설정 계약을 공유합니다. 끄면 불일치 검사를 건너뜁니다.',
        namePlaceholder: '상단 부품',
        create: '만들기',
        empty: '부품 프로세스 섹션이 없습니다. 만들어 프로세스를 부품별로 묶으세요.',
        addProcess: '프로세스 추가',
        uploadProcess: '프로세스 업로드',
        uploadFailed: '프로세스를 업로드할 수 없습니다: {{error}}',
        confirmAttachTitle: '프로세스가 사양과 일치하지 않습니다',
        dontUpload: '업로드하지 않음',
        dontMove: '이동하지 않음',
        moveToSection: '섹션으로 이동',
        pickSection: '부품 프로세스 섹션 선택',
        noSectionsToMove: '먼저 부품 프로세스 섹션을 만드세요',
        moveFailed: '프로세스를 이동할 수 없습니다: {{error}}',
        replace: '교체',
        remove: '제거',
        noProcesses: '이 섹션에 프로세스가 없습니다',
        pickProcess: '프로세스 프리셋 선택',
        noAvailable: '추가할 프로세스 프리셋이 없습니다',
        replaceTitle: '프로세스 교체',
        incomingProcess: '새 프로세스',
        previewFailed: '교체를 미리 볼 수 없습니다: {{error}}',
        replaceFailed: '프로세스를 교체할 수 없습니다: {{error}}',
        createFailed: '섹션을 만들 수 없습니다: {{error}}',
        addFailed: '프로세스를 추가할 수 없습니다: {{error}}',
        removeFailed: '슬롯을 제거할 수 없습니다: {{error}}',
        deleteSection: '섹션 삭제',
        deleteSectionConfirm: '이 부품 섹션과 프린터 슬롯을 삭제할까요?',
        unknownPrinter: '알 수 없음',
        toast: {
          created: '부품 섹션이 만들어졌습니다',
          deleted: '부품 섹션이 삭제되었습니다',
          processAdded: '프로세스가 추가되었습니다',
          uploaded: '프로세스가 업로드되었습니다',
          replaced: '프로세스가 교체되었습니다',
          slotRemoved: '프로세스가 제거되었습니다',
        },
      },
    },
    connectedAs: '연결된 계정',
    signInExpiredTitle: 'Bambu 클라우드 로그인이 만료되었습니다',
    signInExpiredBody: 'Bambu Lab이 저장된 토큰을 더 이상 허용하지 않습니다. 클라우드 프로필, 펌웨어 확인을 복구하려면 다시 로그인하세요.',
    logout: '로그아웃',
  ...
  fileManager: {
    ...
    allFiles: '모든 파일',
    allExternal: '외부',
    backToFolders: '폴더로 돌아가기',
    chooseFolderTitle: '탐색할 폴더를 선택하세요',
    chooseFolderDescription: '폴더를 선택하여 내용을 확인하세요.',
    addSection: '섹션 추가',
    newSection: '새 섹션',
    sectionName: '섹션 이름',
    sectionNamePlaceholder: '예: Production',
    ungrouped: '미분류',
    unfiled: '미정리',
    emptySection: '이 섹션에 아직 폴더가 없습니다.',
    moveToSection: '섹션으로 이동',
    noSection: '섹션 없음',
    renameSection: '섹션 이름 변경',
    deleteSection: '섹션 삭제',
    deleteSectionConfirm: '이 섹션을 삭제할까요? 안의 폴더는 그대로 두고 미분류가 됩니다.',
    sectionCreated: '섹션이 생성되었습니다',
    sectionRenamed: '섹션 이름이 변경되었습니다',
    sectionDeleted: '섹션이 삭제되었습니다',
    folderMovedToSection: '폴더가 이동되었습니다',
    folderSection: '섹션',
    trackPrintSettings: '인쇄 설정 추적 (교체만 가능)',
    trackPrintSettingsHelp: '이 폴더는 프로덕션 슬롯을 사용합니다. 일반 업로드 대신 교체를 사용하세요.',
    trackPrintSettingsForcedHelp: '이 섹션은 추적이 필수입니다. 폴더는 비어 있는 상태로 시작됩니다. 부품을 추가한 뒤 프로덕션 파일 추가 / 교체를 사용하세요.',
    trackPrintSettingsSectionHelp: '이 섹션의 모든 폴더는 프로덕션 슬롯을 사용합니다. 새 폴더에서 추적을 끌 수 없습니다.',
    parameterTracking: '파라미터 추적',
    parameterTrackingChip: '제한',
    printerModel: '프린터 모델',
    printerModelPlaceholder: '프린터 선택',
    printerModelHelp: '이 폴더는 선택한 프린터의 프로덕션 슬롯을 사용합니다.',
    printerModelCustom: '사용자 지정 코드',
    printerModelCustomPlaceholder: '예: P1S',
    addFolderToSection: '폴더 추가',
    ...
    tags: {
      ...
      deleteAria: '{{name}} 삭제',
      fileTitle: '이 파일의 태그',
      fileTooltip: '이 파일에 태그를 추가하거나 제거',
      applySave: '태그 저장',
      applySaveSuccess: '이 파일의 태그를 업데이트했습니다.',
      addToFileAria: '이 파일에 태그 추가',
      removeFromFileAria: '이 파일에서 태그 {{name}} 제거',
    },
    allTypes: '모든 유형',
    prints: '인쇄물',
    ascending: '오름차순',
    ...
    sectionParts: {
      ...
      code: '부품 코드',
      name: '이름',
      setParameters: '파라미터 설정',
      setParametersHelp: '인쇄용 파일이 아닙니다. 이 파트의 인쇄 설정 계약만 지정합니다.',
      replaceParameters: '파라미터 교체',
      replaceParametersTitle: '파트 파라미터 교체',
      replaceParametersHelp: '3MF를 업로드해 이 파트의 인쇄 설정 계약을 교체합니다. 폴더 파일은 새 사양에 맞춰 다시 검사됩니다.',
      replaceConfirm: '파라미터 교체',
      replaceFailed: '파라미터를 교체할 수 없습니다: {{error}}',
      replaced: '파트 파라미터를 교체했습니다',
      previewFailed: '파라미터 교체를 미리 볼 수 없습니다: {{error}}',
      delete: '파트 삭제',
      deleteConfirm: '파트 템플릿 {{code}}을(를) 삭제할까요? 폴더는 나중에 이 코드를 다시 추가할 수 있습니다.',
      deleteConfirmInUse: '파트 템플릿 {{code}}을(를) 삭제할까요? 폴더 인스턴스 {{count}}개는 남아서 이 코드를 계속 사용합니다.',
      empty: '이 섹션에는 아직 파트 템플릿이 없습니다. 폴더에서 파트를 추가하면 템플릿도 만들어집니다.',
      notPrintable: '섹션 파트는 인쇄할 수 없습니다. 설정 계약만 정의합니다.',
      followsSectionSpec: '이 폴더는 섹션의 인쇄 설정 계약을 따라야 합니다.',
      seedFailed: '파라미터를 설정할 수 없습니다: {{error}}',
      created: '파트 템플릿이 생성되었습니다',
      deleted: '파트 템플릿이 삭제되었습니다',
      manage: '파트 관리',
      seeded: '파트 파라미터가 저장되었습니다',
      addFailed: '파트를 만들 수 없습니다: {{error}}',
      deleteFailed: '파트를 삭제할 수 없습니다: {{error}}',
      catalog: '섹션 파트',
      orCreate: '또는 새 파트 만들기',
      arrangeHint: '드래그해서 순서를 바꿉니다. TOP을 앞에, 옆에 BOT 등 원하는 대로요.',
      dragHandle: '순서 변경',
      reorderFailed: '파트 순서를 저장할 수 없습니다: {{error}}',
    },
    production: {
      title: '생산 파일',
      subtitle: '{{printer}} 생산 슬롯',
      addFile: '생산 파일 추가',
      replace: '교체',
      delete: '삭제',
      proceedAnyway: '그래도 진행',
      acceptBaseline: '새 기준으로 수락',
      cancel: '취소',
      reason: '사유',
      reasonPlaceholder: '기준을 바꾸는 이유는 무엇인가요?',
      parameterNote: '메모',
      parameterNotePlaceholder: '이 파라미터가 다른 이유는 무엇인가요?',
      notesRequired: '계속하기 전에 일치하지 않는 파라미터를 모두 설명하세요.',
      mismatchNote: '불일치 메모',
      newSlotConfirm: '기존 파일을 교체하지 않고 새 생산 슬롯을 만듭니다.',
      parseFailed: '파일 이름을 해석할 수 없습니다. 아래 칸을 입력하세요.',
      versionNotNewer: '들어오는 버전 {{incoming}}이(가) {{current}}보다 새롭지 않습니다.',
      matchesSpec: '사양과 일치',
      differsByDesign: '설계상 차이',
      lastReplaceMismatched: '마지막 교체에 불일치가 있었습니다',
      emptyFolder: '아직 생산 파일이 없습니다. 첫 슬롯을 만들 파일을 추가하세요.',
      quantity: '수량',
      version: '버전',
      noActiveFile: '활성 파일 없음',
      uploadIntoProductionBlocked: '일반 업로드 대신 교체 또는 생산 파일 추가를 사용하세요.',
      moveIntoProductionBlocked: 'Production에서 관리',
      mismatchCount: '{{count}}개 매개변수가 다릅니다',
      parameter: '매개변수',
      lockedValue: '잠긴 값',
      incomingValue: '들어오는 값',
      code: '부품 코드',
      printer: '프린터',
      pickFile: '파일 선택',
      confirmCreate: '슬롯 만들기',
      currentVersion: '현재 버전',
      incomingVersion: '들어오는 버전',
      printerMismatch: '파일 프린터 {{file}}이(가) 이 폴더({{folder}})와 일치하지 않습니다.',
      dropToAdd: '여기에 파일을 놓아 생산 슬롯을 추가하세요',
      print: '인쇄',
      loading: '생산 파일을 불러오는 중...',
      slotCreated: '생산 슬롯이 만들어졌습니다',
      slotReplaced: '생산 파일이 교체되었습니다',
      deleteConfirmTitle: '생산 파일 삭제',
      deleteConfirm: '{{printer}}에서 {{code}} x{{quantity}} {{version}}을(를) 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
      deleteConfirmDetail:
        '파일은 파일 관리자의 휴지통으로 옮겨지며, 필요하면 거기에서 복원할 수 있습니다.',
      slotDeleted: '생산 슬롯이 삭제되었습니다',
      deleteFailed: '슬롯을 삭제할 수 없습니다: {{error}}',
      createFailed: '슬롯을 만들 수 없습니다: {{error}}',
      replaceFailed: '파일을 교체할 수 없습니다: {{error}}',
      previewFailed: '교체 미리보기에 실패했습니다: {{error}}',
      slotExists: '이 부품과 수량의 슬롯이 이미 있습니다. 교체를 사용하세요.',
      newPartHint: '새 부품({{code}})을 추가합니다.',
      newQuantityHint: '{{code}}에 이미 슬롯이 있습니다. 수량 x{{quantity}}을(를) 추가합니다.',
      sharedContractHint: '이 프린터의 {{code}} 수량 변형은 하나의 인쇄 설정 계약을 공유합니다.',
      addPart: '파트 추가',
      addPartTitle: '이 프린터에 파트 추가',
      partName: '파트 이름',
      partCodeHint: '대문자만, 1–32자(예: TOP 또는 LID).',
      confirmAddPart: '파트 추가',
      partAdded: '파트가 추가되었습니다',
      addPartFailed: '파트를 추가할 수 없습니다: {{error}}',
      removePart: '파트 제거',
      removePartConfirmTitle: '파트 제거',
      removePartConfirmEmpty: '{{printer}}에서 {{code}}({{name}})을(를) 제거할까요? 나중에 다시 추가할 수 있습니다.',
      removePartConfirmWithFiles: '{{printer}}에서 {{code}}({{name}})을(를) 제거할까요? 생산 파일 {{count}}개가 휴지통으로 이동합니다.',
      partRemoved: '파트가 제거되었습니다',
      removePartFailed: '파트를 제거할 수 없습니다: {{error}}',
      addFileToPart: '파일 추가',
      emptyPart: '이 파트의 파일이 아직 없습니다.',
      previewing: '사양과 비교하는 중...',
      uploading: '업로드 중...',
      suggestedVersion: '권장 다음 버전: {{version}}',
      match: '일치',
      mismatch: '불일치',
      specs: {
        view: '사양 보기',
        title: '현재 출력 사양',
        layerHeight: '레이어 높이',
        initialLayerLineWidth: '첫 레이어 선 폭',
        infillDensity: '인필 밀도',
        infillPattern: '인필 패턴',
        wallLoops: '벽',
        brimType: '브림',
        brimWidth: '브림 너비',
        brimObjectGap: '브림-오브젝트 간격',
        fuzzySkin: '퍼지 스킨',
        fuzzySkinPainted: '페인트됨',
        fuzzySkinAllowPaint: '페인트 허용',
        fuzzySkinThickness: '퍼지 스킨 두께',
        fuzzySkinPointDistance: '퍼지 스킨 점 간격',
        enableSupport: '서포트',
        supportType: '서포트 유형',
        supportStyle: '서포트 스타일',
        supportTreeAuto: '트리 자동',
        supportTreeManual: '트리 수동',
        supportNormalAuto: '일반 자동',
        supportNormalManual: '일반 수동',
        supportStyleSlim: '슬림 트리',
        supportStyleHybrid: '하이브리드',
        supportStyleStrong: '강한 트리',
        supportStyleOrganic: '오가닉',
        supportStyleDefault: '기본값',
        supportStyleSnug: '밀착',
        supportStyleGrid: '그리드',
        enablePrimeTower: '프라임 타워',
        seamPosition: '심',
        nozzlesUsed: '노즐',
        bed: '베드',
        bedTypeTexturedPei: '텍스처 PEI',
        bedTypeSmoothPei: '스무스 PEI',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'SuperTack 플레이트',
        ...
        infillPatterns: {
          ...
          monotonic: '단조',
          monotonicLine: '단조선',
          alignedRectilinear: '정렬된 직선',
          hilbertCurve: '힐베르트 곡선',
          archimedeanChords: '아르키메데스 현',
          octagramSpiral: '팔각 나선형',
        },
        valueMm: '{{value}}mm',
        valuePercent: '{{value}}％',
        summaryInfill: '인필 {{value}}%',
        summarySupports: '서포트: {{detail}}',
        summaryBrimGap: '간격 {{value}}mm',
        summaryBed: '베드: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: '재료를 클릭해 AMS 슬롯 선택',
    chooseMaterialSlot: '재료 {{n}}에 사용할 압출기/색상 선택',
    mustMapMaterials: '재료를 선택/매핑해야 합니다',
    unmappedSlot: '—',
    emptySlot: '비어 있음',
    noAmsSlots: '이 프린터에서 AMS 또는 외부 스풀이 보고되지 않았습니다.',
    useAutoMatch: '자동 매칭 사용',
    reRead: '다시 읽기',
    plateN: '플레이트 {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — 용량 설정',
    applyWeekdayDefaults: '월–금 8:00–17:00 적용',
    timezone: '시간대',
    capacityConfigDescription: '주간 프린터 근무, 라인 시작, 베드 정리, 장치 BOM(부품 모델). Stats 2에서 사용.',
    lineStart: '라인 시작 (HH:MM)',
    preLineBuffer: '라인 전 버퍼(분)',
    expectedClear: '예상 베드 정리(분)',
    weeklyHours: '주간 근무 시간',
    weeklyHoursHint: '지금은 API로 교대 편집. 전체 그리드는 Stats 2 페이지에서 제공.',
    unstaffed: '근무 없음',
    saveGlobals: '라인 시작 및 정리 저장',
    configSaved: '저장됨 — 용량이 새로고침됩니다',
    unsavedChanges: '저장되지 않은 변경 사항',
    deviceRecipe: '장치 레시피(부품 모델)',
    printerTimeBlocks: '프린터 시간 블록(비어 있어야 함)',
    printerTimeBlocksHint:
      '프린터가 비어 있어야 하는 주간 반복 시간대입니다. 주간 일정은 이 블록과 겹치는 출력(클리어 시간 포함)을 배치하지 않습니다.',
    noPrintersForBlocks: '구성할 활성 프린터가 없습니다.',
    blockPrinter: '프린터',
    noBlocksYet: '이 프린터에 예약된 시간대가 없습니다.',
    blockLabel: '라벨(선택)',
    addTimeBlock: '시간 블록 추가',
    saveTimeBlocks: '프린터 시간 블록 저장',
    invalidBlockRange: '{{day}}: 블록 시작은 종료보다 앞서야 합니다({{start}} → {{end}})',
    discoveredCount: '발견된 파일 {{count}}개',
    pageTitle: 'Stats 2 — 실제 용량',
    deviceCapacity: '장치 생산 용량',
    todaysReadiness: '오늘의 준비 상태',
    printSchedule: '이번 주 인쇄 일정',
    buildPlan: '빌드 플랜',
    buildPlanHint: '각 행은 주간 스케줄이 해당 부품으로 시작하는 플레이트 파일입니다. 플레이트와 부품은 선택한 날의 정수 시작 수이며 위 타임라인 바와 같습니다.',
    targetDevicesDay: '목표 장치 / 일',
    whatIf: '가정',
    capacityMaxHint: '최대 ~{{n}}/일',
    targetNotFeasible: '목표가 인쇄 용량을 초과함',
    targetNotFeasibleBody: '요청 {{target}}/일; 스케줄은 약 {{achievable}}/일까지 가능합니다.',
    bindingPartSuffix: '병목 부품: {{binding}}.',
    scenarioAtTarget: '{{n}} 장치/일 가정 — 플레이트/부품은 위 {{day}}의 정수 시작 수입니다.',
    scenarioAtCapacity: '플레이트/부품은 위 {{day}}의 정수 시작 수입니다(현실적 용량). 목표를 입력해 가정 계산하세요.',
    dedicatedFleetHint: '전용 플릿 추정 ~{{n}}/일은 공유 프린터를 무시합니다(같은 장비를 부품마다 계산). 스케줄 가능 수치는 주간 타임라인과 일치합니다.',
    cleanupFeedback: '정리: 목표 vs 실제',
    productionYield: '생산 수율',
    leadTimes: '현장 리드 타임',
    qualityReasons: '품질 및 손실 사유',
    printerReliability: '프린터 신뢰성',
    filamentPerDevice: '장치당 필라멘트',
    configuration: '구성',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — {{models}} 프린터 최소 {{extra}}대 더 필요',
    shortPartsHeading: '부족한 부품(동일 작업자 일정):',
    shortPartUnknownModels: '대상',
    shortPartsSharedNote:
      '추가 프린터는 부품별 하한입니다(동일 일정). 공유 모델은 실제로 한 번만 셉니다 — 숫자를 더하지 마세요.',
    hypotheticalFleetNote:
      '이 요청을 위해 타임라인에 가상 프린터 +{{n}}대({{detail}})가 포함됩니다 — 점선 레인.',
    export: 'CSV 내보내기',
  },
