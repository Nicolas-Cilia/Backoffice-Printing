export default {
  ...
  printers: {
    ...
    dropToPrint: '拖放以列印',
    cannotPrint: '印表機忙碌',
    startPrintOn: '在 {{name}} 上開始列印',
    yourFiles: '你的檔案',
    printableTypesHint: '支援：.gcode、.gcode.3mf',
    uploadToPrintHint: '將可列印檔案拖到此處，或從「你的檔案」中選擇 — 列印選項會在此面板開啟。',
    pickFromLibraryHint: '從「你的檔案」中選擇可列印檔案 — 列印選項會在此面板開啟。',
    saveToYourFiles: '儲存到你的檔案',
    saveToYourFilesHint: '預設關閉 — 上傳僅用於本次列印，不會保留在未歸檔中。',
    saveLocation: '儲存位置',
    changeFile: '更換檔案',
    printOptionsAdvanced: '進階選項',
    noPrinterSelected: '未選擇印表機',
  },
  ...
  maintenance: {
    ...
    logCustomJob: '記錄自訂作業',
    logReset: '記錄並重置',
    logResetTitle: '重置 {{name}}？',
    logResetMessage: '這會重置間隔並加入印表機日誌。僅在有狀況時留下備註。',
    jobName: '作業',
    jobNamePlaceholder: '例如：更換噴嘴',
    notes: '備註',
    notesPlaceholder: '你做了什麼？',
    resetNotesPlaceholder: '選填備註…',
    partLink: '零件連結（選填）',
    cost: '費用（選填）',
    saveLog: '儲存到日誌',
    editLog: '編輯日誌',
    ...
    logUpdated: '日誌項目已更新',
    deleteLog: '刪除日誌',
    deleteLogTitle: '刪除日誌項目？',
    deleteLogMessage: '從印表機日誌移除"{{name}}"？這不會復原已排程的重置，只會刪除該日誌列及其費用。',
    logDeleted: '日誌項目已刪除',
    hideTask: '隱藏',
    showTask: '顯示',
    hiddenTasks: '隱藏的任務',
    hiddenTasksDescription: '隱藏的預設任務仍會保留。顯示其中一個即可帶回，無需全部還原。',
    hideTaskTitle: '隱藏 {{name}}？',
    hideTaskMessage: '它會離開狀態分頁。你可以在「隱藏的任務」再次顯示，無需重新建立或還原全部預設任務。',
    taskHidden: '任務已隱藏',
    taskShown: '任務已重新顯示',
    totalMaintenanceCost: '維護費用',
    jobLogged: '作業已儲存到印表機日誌',
    customJob: '自訂作業',
  ...
  settings: {
    ...
    manageLibrary: '管理資料庫',
    manageLibraryDescription: '上傳、重新命名與刪除資料庫檔案',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        deleted: '預設已刪除',
        updated: '預設已更新',
        downloadFailed: '無法下載預設',
      },
      partSections: {
        title: '零件工藝分區',
        addSection: '新增工藝分區',
        sectionName: '分區名稱',
        trackParameters: '追蹤參數',
        trackParametersHelp: '開啟後，製程會共用一套列印設定約定。關閉則略過不相符檢查。',
        namePlaceholder: '上部零件',
        create: '建立',
        empty: '尚無零件工藝分區。建立一個即可依零件分組工藝。',
        addProcess: '新增工藝',
        uploadProcess: '上傳工藝',
        uploadFailed: '無法上傳工藝：{{error}}',
        confirmAttachTitle: '工藝與規格不相符',
        dontUpload: '不上傳',
        dontMove: '不移動',
        moveToSection: '移到零件分段',
        pickSection: '選擇零件工藝分段',
        noSectionsToMove: '請先建立零件工藝分段',
        moveFailed: '無法移動工藝：{{error}}',
        replace: '取代',
        remove: '移除',
        noProcesses: '此分區沒有工藝',
        pickProcess: '選擇工藝預設',
        noAvailable: '沒有可新增的工藝預設',
        replaceTitle: '取代工藝',
        incomingProcess: '新工藝',
        previewFailed: '無法預覽取代：{{error}}',
        replaceFailed: '無法取代工藝：{{error}}',
        createFailed: '無法建立分區：{{error}}',
        addFailed: '無法新增工藝：{{error}}',
        removeFailed: '無法移除槽位：{{error}}',
        deleteSection: '刪除分區',
        deleteSectionConfirm: '刪除此零件分區及其印表機槽位？',
        unknownPrinter: '未知',
        toast: {
          created: '已建立零件分區',
          deleted: '已刪除零件分區',
    ...
    signInExpiredBody: 'Bambu Lab 不再接受已儲存的權杖。請重新登入以恢復雲端設定檔與韌體檢查。',
    logout: '登出',
  ...
  fileManager: {
    ...
    allExternal: '外部',
    backToFolders: '返回資料夾',
    chooseFolderTitle: '選擇一個資料夾進行瀏覽',
    chooseFolderDescription: '選擇一個資料夾以查看其內容。',
    addSection: '新增分區',
    newSection: '新分區',
    sectionName: '分區名稱',
    sectionNamePlaceholder: '例如：生產',
    ungrouped: '未分組',
    unfiled: '未歸檔',
    emptySection: '此分區中還沒有資料夾。',
    moveToSection: '移至分區',
    noSection: '無分區',
    renameSection: '重新命名分區',
    deleteSection: '刪除分區',
    deleteSectionConfirm: '刪除此分區？其中的資料夾會保留並變為未分組。',
    sectionCreated: '已建立分區',
    sectionRenamed: '已重新命名分區',
    sectionDeleted: '已刪除分區',
    folderMovedToSection: '已移動資料夾',
    folderSection: '分區',
    trackPrintSettings: '追蹤列印設定（僅取代上傳）',
    trackPrintSettingsHelp: '此資料夾使用生產槽位。請使用「取代」而非一般上傳。',
    trackPrintSettingsForcedHelp: '此分區必須開啟追蹤。資料夾初始為空 — 請先新增零件，然後使用「新增生產檔案 / 取代」。',
    trackPrintSettingsSectionHelp: '此分區中的每個資料夾都使用生產槽位。新資料夾無法關閉追蹤。',
    parameterTracking: '參數追蹤',
    parameterTrackingChip: '受限',
    printerModel: '印表機型號',
    printerModelPlaceholder: '選擇印表機',
    printerModelHelp: '此資料夾會為所選印表機使用生產槽位。',
    printerModelCustom: '自訂代碼',
    printerModelCustomPlaceholder: '例如：P1S',
    addFolderToSection: '新增資料夾',
    ...
    tags: {
      ...
      deleteAria: '刪除 {{name}}',
      fileTitle: '此檔案的標籤',
      fileTooltip: '為此檔案新增或移除標籤',
      applySave: '儲存標籤',
      applySaveSuccess: '已更新此檔案的標籤。',
      addToFileAria: '為此檔案新增標籤',
      removeFromFileAria: '從此檔案移除標籤 {{name}}',
    },
    allTypes: '所有類型',
    prints: '列印',
    ascending: '升序',
    ...
    sectionParts: {
      ...
      name: '名稱',
      setParameters: '設定參數',
      setParametersHelp: '這不是可列印檔案，只用來設定此零件的列印設定約定。',
      replaceParameters: '取代參數',
      replaceParametersTitle: '取代零件參數',
      replaceParametersHelp: '上傳 3MF 以取代此零件的列印設定約定。資料夾中的檔案會依新規範重新核對。',
      replaceConfirm: '取代參數',
      replaceFailed: '無法取代參數：{{error}}',
      replaced: '零件參數已取代',
      previewFailed: '無法預覽參數取代：{{error}}',
      delete: '刪除零件',
      deleteConfirm: '刪除零件範本 {{code}}？資料夾之後仍可新增此代碼。',
      deleteConfirmInUse: '刪除零件範本 {{code}}？將保留 {{count}} 個資料夾執行個體並繼續使用此代碼。',
      empty: '此分區還沒有零件範本。資料夾仍可新增零件，同時也會建立範本。',
      notPrintable: '分區零件不可列印，僅定義設定約定。',
      followsSectionSpec: '此資料夾必須遵循分區的列印設定約定。',
      seedFailed: '無法設定參數：{{error}}',
      created: '已建立零件範本',
      deleted: '已刪除零件範本',
      manage: '管理零件',
      seeded: '已儲存零件參數',
      addFailed: '無法建立零件：{{error}}',
      deleteFailed: '無法刪除零件：{{error}}',
      catalog: '分區零件',
      orCreate: '或建立新零件',
      arrangeHint: '拖曳即可重排。例如 TOP 在前、BOT 在旁——依你想要的順序。',
      dragHandle: '重新排序',
      reorderFailed: '無法儲存零件順序：{{error}}',
    },
    production: {
      title: '生產檔案',
      subtitle: '{{printer}} 生產槽位',
      addFile: '新增生產檔案',
      replace: '取代',
      delete: '刪除',
      proceedAnyway: '仍要繼續',
      acceptBaseline: '接受為新基準',
      cancel: '取消',
      reason: '原因',
      reasonPlaceholder: '為什麼要變更基準？',
      parameterNote: '備註',
      parameterNotePlaceholder: '此參數為何不同？',
      notesRequired: '繼續前請說明每一項不相符的參數。',
      mismatchNote: '不相符說明',
      newSlotConfirm: '這會建立新的生產槽位，而不是取代既有檔案。',
      parseFailed: '無法解析檔名。請填寫下方欄位。',
      versionNotNewer: '傳入版本 {{incoming}} 並不比 {{current}} 更新。',
      matchesSpec: '符合規格',
      differsByDesign: '設計上有差異',
      lastReplaceMismatched: '上次取代存在不一致',
      emptyFolder: '尚無生產檔案。請新增檔案以建立第一個槽位。',
      quantity: '數量',
      version: '版本',
      noActiveFile: '沒有作用中的檔案',
      uploadIntoProductionBlocked: '請使用取代或新增生產檔案，而不是一般上傳。',
      moveIntoProductionBlocked: '由 Production 管理',
      mismatchCount: '{{count}} 個參數不一致',
      parameter: '參數',
      lockedValue: '鎖定值',
      incomingValue: '傳入值',
      code: '零件代碼',
      ...
      confirmCreate: '建立槽位',
      currentVersion: '目前版本',
      incomingVersion: '傳入版本',
      printerMismatch: '檔案印表機 {{file}} 與此資料夾（{{folder}}）不符。',
      dropToAdd: '將檔案拖到此處以新增生產槽位',
      print: '列印',
      loading: '正在載入生產檔案...',
      slotCreated: '已建立生產槽位',
      slotReplaced: '已取代生產檔案',
      deleteConfirmTitle: '刪除生產檔案',
      deleteConfirm: '從 {{printer}} 刪除 {{code}} x{{quantity}} {{version}}？此操作無法復原。',
      deleteConfirmDetail:
        '檔案會移至檔案管理員回收筒，需要時可從那裡還原。',
      slotDeleted: '已刪除生產槽位',
      deleteFailed: '無法刪除槽位：{{error}}',
      createFailed: '無法建立槽位：{{error}}',
      replaceFailed: '無法取代檔案：{{error}}',
      previewFailed: '無法預覽取代：{{error}}',
      slotExists: '此零件與數量的槽位已存在。請使用取代。',
      newPartHint: '這會新增零件（{{code}}）。',
      newQuantityHint: '{{code}} 已有槽位。將新增數量 x{{quantity}}。',
      sharedContractHint: '此印表機上 {{code}} 的數量變體共用同一套列印設定約定。',
      addPart: '新增零件',
      addPartTitle: '為此印表機新增零件',
      partName: '零件名稱',
      partCodeHint: '僅限大寫字母，1–32 個字元（例如 TOP 或 LID）。',
      confirmAddPart: '新增零件',
      partAdded: '已新增零件',
      addPartFailed: '無法新增零件：{{error}}',
      removePart: '移除零件',
      removePartConfirmTitle: '移除零件',
      removePartConfirmEmpty: '要從 {{printer}} 移除 {{code}}（{{name}}）嗎？之後可以再加回來。',
      removePartConfirmWithFiles: '要從 {{printer}} 移除 {{code}}（{{name}}）嗎？{{count}} 個生產檔案將移至回收桶。',
      partRemoved: '已移除零件',
      removePartFailed: '無法移除零件：{{error}}',
      addFileToPart: '新增檔案',
      emptyPart: '此零件尚無檔案。',
      previewing: '正在與規格比較...',
      uploading: '正在上傳...',
      suggestedVersion: '建議的下一版本：{{version}}',
      match: '相符',
      mismatch: '不相符',
      specs: {
        view: '檢視規格',
        title: '目前列印規格',
        layerHeight: '層高',
        initialLayerLineWidth: '首層線寬',
        infillDensity: '填充密度',
        infillPattern: '填充圖案',
        wallLoops: '牆圈',
        brimType: '裙邊',
        brimWidth: '裙邊寬度',
        brimObjectGap: '裙邊與模型間隙',
        fuzzySkin: '絨毛表面',
        fuzzySkinPainted: '已塗裝',
        fuzzySkinAllowPaint: '允許塗裝',
        fuzzySkinThickness: '絨毛厚度',
        fuzzySkinPointDistance: '絨毛點距',
        enableSupport: '支撐',
        supportType: '支撐類型',
        supportStyle: '支撐樣式',
        supportTreeAuto: '樹狀自動',
        supportTreeManual: '樹狀手動',
        supportNormalAuto: '普通自動',
        supportNormalManual: '普通手動',
        supportStyleSlim: '細樹狀',
        supportStyleHybrid: '混合',
        supportStyleStrong: '粗樹狀',
        supportStyleOrganic: '有機',
        supportStyleDefault: '預設',
        supportStyleSnug: '貼合',
        supportStyleGrid: '網格',
        enablePrimeTower: '擦嘴塔',
        seamPosition: '接縫',
        nozzlesUsed: '噴嘴',
        bed: '熱床',
        bedTypeTexturedPei: '紋理 PEI',
        bedTypeSmoothPei: '光滑 PEI',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'SuperTack 板',
        ...
        infillPatterns: {
          ...
          monotonic: '單調',
          monotonicLine: '單調線',
          alignedRectilinear: '直線排列',
          hilbertCurve: '希爾伯特曲線',
          archimedeanChords: '阿基米德和弦',
          octagramSpiral: '八角螺旋',
        },
        valueMm: '{{value}} 毫米',
        valuePercent: '{{value}}％',
        summaryInfill: '{{value}}% 填充',
        summarySupports: '支撐：{{detail}}',
        summaryBrimGap: '{{value}} 毫米間隙',
        summaryBed: '熱床：{{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: '點擊材料以選擇 AMS 槽位',
    chooseMaterialSlot: '為材料 {{n}} 選擇擠出機/顏色',
    mustMapMaterials: '必須選擇/對應材料',
    unmappedSlot: '—',
    emptySlot: '空',
    noAmsSlots: '此印表機未回報 AMS 或外部線軸。',
    useAutoMatch: '使用自動配對',
    reRead: '重新讀取',
    plateN: '板 {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — 產能設定',
    applyWeekdayDefaults: '套用週一至週五 8:00–17:00',
    timezone: '時區',
    capacityConfigDescription: '每週印表機班次、產線開工、清床時間與裝置配方（零件模型），供 Stats 2 使用。',
    lineStart: '產線開工 (HH:MM)',
    preLineBuffer: '開工前緩衝（分鐘）',
    expectedClear: '預期清床時間（分鐘）',
    weeklyHours: '每週有人值守時段',
    weeklyHoursHint: '暫用 API 編輯班次；完整格線編輯器隨 Stats 2 頁提供。',
    unstaffed: '無人值守',
    saveGlobals: '儲存開工與清床設定',
    configSaved: '已儲存 — 產能將重新整理',
    unsavedChanges: '未儲存的變更',
    deviceRecipe: '裝置配方（零件模型）',
    printerTimeBlocks: '印表機時間區塊（必須空閒）',
    printerTimeBlocksHint:
      '印表機必須保持空閒的每週重複時段。週排程不會安排與這些時間區塊重疊的列印（包含清床時間）。',
    noPrintersForBlocks: '沒有可設定的作用中印表機。',
    blockPrinter: '印表機',
    noBlocksYet: '此印表機尚無預留時段。',
    blockLabel: '標籤（選填）',
    addTimeBlock: '新增時間區塊',
    saveTimeBlocks: '儲存印表機時間區塊',
    invalidBlockRange: '{{day}}：時間區塊開始必須早於結束（{{start}} → {{end}}）',
    discoveredCount: '已發現 {{count}} 個檔案',
    pageTitle: 'Stats 2 — 真實產能',
    deviceCapacity: '裝置產能',
    todaysReadiness: '今日就緒',
    printSchedule: '本週列印計畫',
    buildPlan: '組建計畫',
    buildPlanHint: '每一列列出週排程為該零件啟動的板檔案。板數與零件數為所選日的整次啟動，與上方時間軸條一致。',
    targetDevicesDay: '目標裝置 / 天',
    whatIf: '假設',
    capacityMaxHint: '上限 ~{{n}}/天',
    targetNotFeasible: '目標超過列印產能',
    targetNotFeasibleBody: '需求 {{target}}/天；排程約可完成 {{achievable}}/天。',
    bindingPartSuffix: '瓶頸零件：{{binding}}。',
    scenarioAtTarget: '{{n}} 台裝置/天假設 — 板數/零件數為上方 {{day}} 的整次啟動。',
    scenarioAtCapacity: '板數/零件數為上方 {{day}} 的整次啟動（現實產能）。輸入目標進行假設。',
    dedicatedFleetHint: '專用機隊估算 ~{{n}}/天忽略共用印表機（同一台機器被計入每個零件）。可排程數與週時間軸一致。',
    cleanupFeedback: '清床：目標 vs 實際',
    productionYield: '生產良率',
    leadTimes: '產線週期時間',
    qualityReasons: '品質與損耗原因',
    printerReliability: '印表機可靠性',
    filamentPerDevice: '每台裝置耗材',
    configuration: '設定',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — 至少還需要 {{extra}} 台 {{models}} 印表機',
    shortPartsHeading: '短缺零件（同一作業班次）：',
    shortPartUnknownModels: '可用',
    shortPartsSharedNote:
      '額外印表機是依零件的下限（同一班次）。共用機型實際只計一次 — 請勿把數字相加。',
    hypotheticalFleetNote:
      '時間軸含 +{{n}} 台假設印表機（{{detail}}）以滿足此需求 — 虛線通道。',
    export: '匯出 CSV',
  },
