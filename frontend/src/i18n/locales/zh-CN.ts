export default {
  ...
  printers: {
    ...
    dropToPrint: '拖放以打印',
    cannotPrint: '打印机忙碌',
    startPrintOn: '在 {{name}} 上开始打印',
    yourFiles: '你的文件',
    printableTypesHint: '支持：.gcode、.gcode.3mf',
    uploadToPrintHint: '将可打印文件拖到此处，或从“你的文件”中选择 — 打印选项会在此面板打开。',
    pickFromLibraryHint: '从“你的文件”中选择可打印文件 — 打印选项会在此面板打开。',
    saveToYourFiles: '保存到你的文件',
    saveToYourFilesHint: '默认关闭 — 上传仅用于本次打印，不会保留在未归档中。',
    saveLocation: '保存位置',
    changeFile: '更换文件',
    printOptionsAdvanced: '高级选项',
    noPrinterSelected: '未选择打印机',
  },
  ...
  maintenance: {
    ...
    noHistory: '无维护历史',
    printerLog: '打印机日志',
    logCustomJob: '记录自定义作业',
    logReset: '记录并重置',
    logResetTitle: '重置 {{name}}？',
    logResetMessage: '这将重置间隔并添加到打印机日志。仅在有情况时留下备注。',
    jobName: '作业',
    jobNamePlaceholder: '例如：更换喷嘴',
    notes: '备注',
    notesPlaceholder: '你做了什么？',
    resetNotesPlaceholder: '可选备注…',
    partLink: '零件链接（可选）',
    cost: '费用（可选）',
    saveLog: '保存到日志',
    editLog: '编辑日志',
    ...
    deleteLogMessage: '从打印机日志中移除"{{name}}"？这不会撤销已安排的重置，只会删除该日志行及其费用。',
    logDeleted: '日志条目已删除',
    hideTask: '隐藏',
    showTask: '显示',
    hiddenTasks: '隐藏的任务',
    hiddenTasksDescription: '隐藏的默认任务仍会保留。显示其中一个即可恢复，无需全部还原。',
    hideTaskTitle: '隐藏 {{name}}？',
    hideTaskMessage: '它将离开状态选项卡。你可以在“隐藏的任务”中再次显示，无需重新创建或还原全部默认任务。',
    taskHidden: '任务已隐藏',
    taskShown: '任务已重新显示',
    totalMaintenanceCost: '维护费用',
    jobLogged: '作业已保存到打印机日志',
    customJob: '自定义作业',
  ...
  settings: {
    ...
    manageLibrary: '管理资料库',
    manageLibraryDescription: '上传、重命名和删除资料库文件',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        deleted: '预设已删除',
        updated: '预设已更新',
        downloadFailed: '无法下载预设',
      },
      partSections: {
        title: '零件工艺分区',
        addSection: '添加工艺分区',
        sectionName: '分区名称',
        trackParameters: '跟踪参数',
        trackParametersHelp: '开启后，工艺将共享一套打印设置约定。关闭则跳过不匹配检查。',
        namePlaceholder: '上部零件',
        create: '创建',
        empty: '还没有零件工艺分区。创建一个即可按零件分组工艺。',
        addProcess: '添加工艺',
        uploadProcess: '上传工艺',
        uploadFailed: '无法上传工艺：{{error}}',
        confirmAttachTitle: '工艺与规格不匹配',
        dontUpload: '不上传',
        dontMove: '不移动',
        moveToSection: '移到零件分段',
        pickSection: '选择零件工艺分段',
        noSectionsToMove: '请先创建零件工艺分段',
        moveFailed: '无法移动工艺：{{error}}',
        replace: '替换',
        remove: '移除',
        noProcesses: '此分区中没有工艺',
        pickProcess: '选择工艺预设',
        noAvailable: '没有可添加的工艺预设',
        replaceTitle: '替换工艺',
        incomingProcess: '新工艺',
        previewFailed: '无法预览替换：{{error}}',
        replaceFailed: '无法替换工艺：{{error}}',
        createFailed: '无法创建分区：{{error}}',
        addFailed: '无法添加工艺：{{error}}',
        removeFailed: '无法移除槽位：{{error}}',
        deleteSection: '删除分区',
        deleteSectionConfirm: '删除此零件分区及其打印机槽位？',
        unknownPrinter: '未知',
        toast: {
          created: '已创建零件分区',
          deleted: '已删除零件分区',
    ...
    signInExpiredBody: 'Bambu Lab 不再接受已保存的令牌。请重新登录以恢复云配置文件和固件检查。',
    logout: '退出登录',
  ...
  fileManager: {
    ...
    allExternal: '外部',
    backToFolders: '返回文件夹',
    chooseFolderTitle: '选择一个文件夹进行浏览',
    chooseFolderDescription: '选择一个文件夹以查看其内容。',
    addSection: '添加分区',
    newSection: '新分区',
    sectionName: '分区名称',
    sectionNamePlaceholder: '例如：生产',
    ungrouped: '未分组',
    unfiled: '未归档',
    emptySection: '此分区中还没有文件夹。',
    moveToSection: '移动到分区',
    noSection: '无分区',
    renameSection: '重命名分区',
    deleteSection: '删除分区',
    deleteSectionConfirm: '删除此分区？其中的文件夹会保留并变为未分组。',
    sectionCreated: '已创建分区',
    sectionRenamed: '已重命名分区',
    sectionDeleted: '已删除分区',
    folderMovedToSection: '已移动文件夹',
    folderSection: '分区',
    trackPrintSettings: '跟踪打印设置（仅替换上传）',
    trackPrintSettingsHelp: '此文件夹使用生产槽位。请使用“替换”而不是普通上传。',
    trackPrintSettingsForcedHelp: '此分区必须开启跟踪。文件夹初始为空 — 请先添加零件，然后使用“添加生产文件 / 替换”。',
    trackPrintSettingsSectionHelp: '此分区中的每个文件夹都使用生产槽位。新文件夹无法关闭跟踪。',
    parameterTracking: '参数跟踪',
    parameterTrackingChip: '受限',
    printerModel: '打印机型号',
    printerModelPlaceholder: '选择打印机',
    printerModelHelp: '此文件夹会为所选打印机使用生产槽位。',
    printerModelCustom: '自定义代码',
    printerModelCustomPlaceholder: '例如：P1S',
    addFolderToSection: '添加文件夹',
    ...
    tags: {
      ...
      deleteAria: '删除 {{name}}',
      fileTitle: '此文件的标签',
      fileTooltip: '为此文件添加或移除标签',
      applySave: '保存标签',
      applySaveSuccess: '已更新此文件的标签。',
      addToFileAria: '为此文件添加标签',
      removeFromFileAria: '从此文件移除标签 {{name}}',
    },
    allTypes: '所有类型',
    prints: '打印',
    ascending: '升序',
    ...
    sectionParts: {
      ...
      name: '名称',
      setParameters: '设置参数',
      setParametersHelp: '这不是可打印文件，仅用于设定该零件的打印设置约定。',
      replaceParameters: '替换参数',
      replaceParametersTitle: '替换零件参数',
      replaceParametersHelp: '上传 3MF 以替换该零件的打印设置约定。文件夹中的文件会按新规范重新核对。',
      replaceConfirm: '替换参数',
      replaceFailed: '无法替换参数：{{error}}',
      replaced: '零件参数已替换',
      previewFailed: '无法预览参数替换：{{error}}',
      delete: '删除零件',
      deleteConfirm: '删除零件模板 {{code}}？文件夹之后仍可添加此代码。',
      deleteConfirmInUse: '删除零件模板 {{code}}？将保留 {{count}} 个文件夹实例并继续使用此代码。',
      empty: '此分区还没有零件模板。文件夹仍可添加零件，同时也会创建模板。',
      notPrintable: '分区零件不可打印，仅定义设置约定。',
      followsSectionSpec: '此文件夹必须遵循分区的打印设置约定。',
      seedFailed: '无法设置参数：{{error}}',
      created: '已创建零件模板',
      deleted: '已删除零件模板',
      manage: '管理零件',
      seeded: '已保存零件参数',
      addFailed: '无法创建零件：{{error}}',
      deleteFailed: '无法删除零件：{{error}}',
      catalog: '分区零件',
      orCreate: '或创建新零件',
      arrangeHint: '拖动即可重排。例如 TOP 在前、BOT 在旁——按你想要的顺序。',
      dragHandle: '重新排序',
      reorderFailed: '无法保存零件顺序：{{error}}',
    },
    production: {
      title: '生产文件',
      subtitle: '{{printer}} 生产槽位',
      addFile: '添加生产文件',
      replace: '替换',
      delete: '删除',
      proceedAnyway: '仍然继续',
      acceptBaseline: '接受为新基准',
      cancel: '取消',
      reason: '原因',
      reasonPlaceholder: '为什么要更改基准？',
      parameterNote: '备注',
      parameterNotePlaceholder: '此参数为何不同？',
      notesRequired: '继续前请说明每一项不匹配的参数。',
      mismatchNote: '不匹配说明',
      newSlotConfirm: '这将创建新的生产槽位，而不是替换现有文件。',
      parseFailed: '无法解析文件名。请填写下方字段。',
      versionNotNewer: '传入版本 {{incoming}} 不比 {{current}} 更新。',
      matchesSpec: '符合规格',
      differsByDesign: '设计上有差异',
      lastReplaceMismatched: '上次替换存在不一致',
      emptyFolder: '还没有生产文件。添加文件以创建第一个槽位。',
      quantity: '数量',
      version: '版本',
      noActiveFile: '没有活动文件',
      uploadIntoProductionBlocked: '请使用替换或添加生产文件，而不是普通上传。',
      moveIntoProductionBlocked: '由 Production 管理',
      mismatchCount: '{{count}} 个参数不一致',
      parameter: '参数',
      lockedValue: '锁定值',
      incomingValue: '传入值',
      code: '零件代码',
      ...
      printerMismatch: '文件打印机 {{file}} 与此文件夹（{{folder}}）不匹配。',
      dropToAdd: '将文件拖到此处以添加生产槽位',
      print: '打印',
      loading: '正在加载生产文件...',
      slotCreated: '已创建生产槽位',
      slotReplaced: '已替换生产文件',
      deleteConfirmTitle: '删除生产文件',
      deleteConfirm: '从 {{printer}} 删除 {{code}} x{{quantity}} {{version}}？此操作无法撤销。',
      deleteConfirmDetail:
        '文件将移至文件管理器回收站，需要时可从那里恢复。',
      slotDeleted: '已删除生产槽位',
      deleteFailed: '无法删除槽位：{{error}}',
      createFailed: '无法创建槽位：{{error}}',
      replaceFailed: '无法替换文件：{{error}}',
      previewFailed: '无法预览替换：{{error}}',
      slotExists: '该零件和数量的槽位已存在。请使用替换。',
      newPartHint: '这将添加新零件（{{code}}）。',
      newQuantityHint: '{{code}} 已有槽位。将添加数量 x{{quantity}}。',
      sharedContractHint: '此打印机上 {{code}} 的数量变体共用同一套打印设置约定。',
      addPart: '添加零件',
      addPartTitle: '为此打印机添加零件',
      partName: '零件名称',
      partCodeHint: '仅限大写字母，1–32 个字符（例如 TOP 或 LID）。',
      confirmAddPart: '添加零件',
      partAdded: '已添加零件',
      addPartFailed: '无法添加零件：{{error}}',
      removePart: '移除零件',
      removePartConfirmTitle: '移除零件',
      removePartConfirmEmpty: '要从 {{printer}} 移除 {{code}}（{{name}}）吗？以后可以再添加回来。',
      removePartConfirmWithFiles: '要从 {{printer}} 移除 {{code}}（{{name}}）吗？{{count}} 个生产文件将移至回收站。',
      partRemoved: '已移除零件',
      removePartFailed: '无法移除零件：{{error}}',
      addFileToPart: '添加文件',
      emptyPart: '此零件尚无文件。',
      previewing: '正在与规格比较...',
      uploading: '正在上传...',
      suggestedVersion: '建议的下一版本：{{version}}',
      match: '匹配',
      mismatch: '不匹配',
      specs: {
        view: '查看规格',
        title: '当前打印规格',
        layerHeight: '层高',
        initialLayerLineWidth: '首层层线宽',
        infillDensity: '填充密度',
        infillPattern: '填充图案',
        wallLoops: '墙圈',
        brimType: '裙边',
        brimWidth: '裙边宽度',
        brimObjectGap: '裙边与模型间隙',
        fuzzySkin: '绒毛表面',
        fuzzySkinPainted: '已涂装',
        fuzzySkinAllowPaint: '允许涂装',
        fuzzySkinThickness: '绒毛厚度',
        fuzzySkinPointDistance: '绒毛点距',
        enableSupport: '支撑',
        supportType: '支撑类型',
        supportStyle: '支撑样式',
        supportTreeAuto: '树状自动',
        supportTreeManual: '树状手动',
        supportNormalAuto: '普通自动',
        supportNormalManual: '普通手动',
        supportStyleSlim: '细树状',
        supportStyleHybrid: '混合',
        supportStyleStrong: '粗树状',
        supportStyleOrganic: '有机',
        supportStyleDefault: '默认',
        supportStyleSnug: '贴合',
        supportStyleGrid: '网格',
        ...
        summarySupports: '支撑：{{detail}}',
        summaryBrimGap: '{{value}} 毫米间隙',
        summaryBed: '热床：{{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: '点击材料以选择 AMS 槽位',
    chooseMaterialSlot: '为材料 {{n}} 选择挤出机/颜色',
    mustMapMaterials: '必须选择/映射材料',
    unmappedSlot: '—',
    emptySlot: '空',
    noAmsSlots: '此打印机未报告 AMS 或外部线轴。',
    useAutoMatch: '使用自动匹配',
    reRead: '重新读取',
    plateN: '板 {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — 产能配置',
    applyWeekdayDefaults: '应用周一至周五 8:00–17:00',
    timezone: '时区',
    capacityConfigDescription: '每周打印机班次、产线开工、清床时间与设备配方（零件模型），供 Stats 2 使用。',
    lineStart: '产线开工 (HH:MM)',
    preLineBuffer: '开工前缓冲（分钟）',
    expectedClear: '预期清床时间（分钟）',
    weeklyHours: '每周有人值守时段',
    weeklyHoursHint: '暂用 API 编辑班次；完整网格编辑器随 Stats 2 页面提供。',
    unstaffed: '无人值守',
    saveGlobals: '保存开工与清床设置',
    configSaved: '已保存 — 产能将刷新',
    unsavedChanges: '未保存的更改',
    deviceRecipe: '设备配方（零件模型）',
    printerTimeBlocks: '打印机时间块（必须空闲）',
    printerTimeBlocksHint:
      '打印机必须保持空闲的每周重复时段。周计划不会安排与这些时间块重叠的打印（包括清床时间）。',
    noPrintersForBlocks: '没有可配置的活动打印机。',
    blockPrinter: '打印机',
    noBlocksYet: '此打印机尚无预留时段。',
    blockLabel: '标签（可选）',
    addTimeBlock: '添加时间块',
    saveTimeBlocks: '保存打印机时间块',
    invalidBlockRange: '{{day}}：时间块开始必须早于结束（{{start}} → {{end}}）',
    discoveredCount: '已发现 {{count}} 个文件',
    pageTitle: 'Stats 2 — 真实产能',
    deviceCapacity: '设备产能',
    todaysReadiness: '今日就绪',
    printSchedule: '本周打印计划',
    buildPlan: '构建计划',
    buildPlanHint: '每行列出周计划为该零件启动的板文件。板数与零件数为所选日的整次启动，与上方时间轴条一致。',
    targetDevicesDay: '目标设备 / 天',
    whatIf: '假设',
    capacityMaxHint: '上限 ~{{n}}/天',
    targetNotFeasible: '目标超过打印产能',
    targetNotFeasibleBody: '需求 {{target}}/天；排程大约可完成 {{achievable}}/天。',
    bindingPartSuffix: '瓶颈零件：{{binding}}。',
    scenarioAtTarget: '{{n}} 台设备/天假设 — 板数/零件数为上方 {{day}} 的整次启动。',
    scenarioAtCapacity: '板数/零件数为上方 {{day}} 的整次启动（现实产能）。输入目标进行假设。',
    dedicatedFleetHint: '专用机队估算 ~{{n}}/天忽略共享打印机（同一台机器被计入每个零件）。可排程数与周时间轴一致。',
    cleanupFeedback: '清床：目标 vs 实际',
    productionYield: '生产良率',
    leadTimes: '产线周期时间',
    qualityReasons: '质量与损耗原因',
    printerReliability: '打印机可靠性',
    filamentPerDevice: '每台设备耗材',
    configuration: '配置',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — 至少还需要 {{extra}} 台 {{models}} 打印机',
    shortPartsHeading: '短缺零件（同一作业班次）：',
    shortPartUnknownModels: '可用',
    shortPartsSharedNote:
      '额外打印机是按零件的下限（同一班次）。共享机型实际只计一次 — 请勿把数字相加。',
    hypotheticalFleetNote:
      '时间线含 +{{n}} 台假设打印机（{{detail}}）以满足此需求 — 虚线通道。',
    export: '导出 CSV',
  },
