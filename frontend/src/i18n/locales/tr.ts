export default {
  ...
  printers: {
    ...
    startPrintOn: '{{name}} üzerinde yazdırmayı başlat',
    yourFiles: 'Dosyalarınız',
    printableTypesHint: 'Desteklenen: .gcode, .gcode.3mf',
    uploadToPrintHint: 'Yazdırılabilir bir dosyayı buraya bırakın veya Dosyalarınız’dan seçin — yazdırma seçenekleri bu panelde açılır.',
    pickFromLibraryHint: 'Dosyalarınız’dan yazdırılabilir bir dosya seçin — yazdırma seçenekleri bu panelde açılır.',
    saveToYourFiles: 'Dosyalarınıza kaydet',
    saveToYourFilesHint: 'Varsayılan kapalı — yükleme yalnızca bu yazdırma için kullanılır ve Sınıflandırılmamış’ta tutulmaz.',
    saveLocation: 'Kayıt konumu',
    changeFile: 'Dosyayı değiştir',
    printOptionsAdvanced: 'Gelişmiş seçenekler',
    noPrinterSelected: 'Yazıcı seçilmedi',
  },
  ...
  maintenance: {
    ...
    printerLog: 'Yazıcı günlüğü',
    logCustomJob: 'Özel iş kaydet',
    logReset: 'Kaydet ve sıfırla',
    logResetTitle: '{{name}} sıfırlansın mı?',
    logResetMessage: 'Bu, aralığı sıfırlar ve yazıcı günlüğüne ekler. Yalnızca bir şey olduysa not bırakın.',
    jobName: 'İş',
    jobNamePlaceholder: 'örn. Nozulu değiştir',
    notes: 'Notlar',
    notesPlaceholder: 'Ne yaptınız?',
    resetNotesPlaceholder: 'İsteğe bağlı notlar…',
    partLink: 'Parça bağlantısı (isteğe bağlı)',
    cost: 'Maliyet (isteğe bağlı)',
    saveLog: 'Günlüğe kaydet',
    editLog: 'Günlüğü düzenle',
    editLogTitle: 'Günlüğü düzenle',
    logUpdated: 'Günlük kaydı güncellendi',
    deleteLog: 'Günlüğü sil',
    deleteLogTitle: 'Günlük kaydı silinsin mi?',
    deleteLogMessage: '"{{name}}" yazıcı günlüğünden kaldırılsın mı? Planlanmış bir sıfırlama geri alınmaz — yalnızca günlük satırı ve maliyeti silinir.',
    logDeleted: 'Günlük kaydı silindi',
    hideTask: 'Gizle',
    showTask: 'Göster',
    hiddenTasks: 'Gizli görevler',
    hiddenTasksDescription: 'Gizlenen varsayılan görevler kayıtlarda kalır. Tümünü geri yüklemeden geri getirmek için birini gösterin.',
    hideTaskTitle: '{{name}} gizlensin mi?',
    hideTaskMessage: 'Durum sekmesinden kalkar. Gizli görevler’den yeniden gösterebilirsiniz — yeniden oluşturmanız veya tüm varsayılanları geri yüklemeniz gerekmez.',
    taskHidden: 'Görev gizlendi',
    taskShown: 'Görev yeniden gösterildi',
    totalMaintenanceCost: 'Bakım maliyeti',
    jobLogged: 'İş yazıcı günlüğüne kaydedildi',
    customJob: 'Özel iş',
  ...
  settings: {
    ...
    manageLibraryDescription: "Kütüphane dosyalarını yükle, yeniden adlandır ve sil",
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        downloadFailed: 'Ön ayar indirilemedi',
      },
      partSections: {
        title: 'Parça süreç bölümleri',
        addSection: 'Süreç bölümleri ekle',
        sectionName: 'Bölüm adı',
        trackParameters: 'Parametreleri izle',
        trackParametersHelp: 'Açıkken süreçler ortak bir yazdırma ayarı sözleşmesini paylaşır. Uyuşmazlık denetimlerini atlamak için kapatın.',
        namePlaceholder: 'Üst parça',
        create: 'Oluştur',
        empty: 'Henüz parça süreç bölümü yok. Süreçleri parçaya göre gruplamak için bir tane oluşturun.',
        addProcess: 'Süreç ekle',
        uploadProcess: 'Süreç yükle',
        uploadFailed: 'Süreç yüklenemedi: {{error}}',
        confirmAttachTitle: 'Süreç spesifikasyonla eşleşmiyor',
        dontUpload: 'Yükleme yapma',
        dontMove: 'Taşıma',
        moveToSection: 'Bölüme taşı',
        pickSection: 'Bir parça işlem bölümü seçin',
        noSectionsToMove: 'Önce bir parça işlem bölümü oluşturun',
        moveFailed: 'İşlem taşınamadı: {{error}}',
        replace: 'Değiştir',
        remove: 'Kaldır',
        noProcesses: 'Bu bölümde süreç yok',
        pickProcess: 'Bir süreç ön ayarı seçin',
        noAvailable: 'Eklenecek süreç ön ayarı kalmadı',
        replaceTitle: 'Süreci değiştir',
        incomingProcess: 'Gelen süreç',
        previewFailed: 'Değiştirme önizlenemedi: {{error}}',
        replaceFailed: 'Süreç değiştirilemedi: {{error}}',
        createFailed: 'Bölüm oluşturulamadı: {{error}}',
        addFailed: 'Süreç eklenemedi: {{error}}',
        removeFailed: 'Yuva kaldırılamadı: {{error}}',
        deleteSection: 'Bölümü sil',
        deleteSectionConfirm: 'Bu parça bölümü ve yazıcı yuvaları silinsin mi?',
        unknownPrinter: 'Bilinmiyor',
        toast: {
          created: 'Parça bölümü oluşturuldu',
          deleted: 'Parça bölümü silindi',
          processAdded: 'Süreç eklendi',
          uploaded: 'Süreç yüklendi',
          replaced: 'Süreç değiştirildi',
          slotRemoved: 'Süreç kaldırıldı',
        },
      },
    },
    connectedAs: 'Bağlı kullanıcı',
    signInExpiredTitle: 'Bambu Cloud oturumu sona erdi',
    signInExpiredBody: 'Bambu Lab kayıtlı belirteci artık kabul etmiyor. Bulut profillerini ve donanım yazılımı denetimlerini geri yüklemek için yeniden oturum açın.',
    logout: 'Çıkış',
  ...
  fileManager: {
    ...
    allExternal: 'Harici',
    backToFolders: 'Klasörlere geri dön',
    chooseFolderTitle: 'Göz atmak için bir klasör seçin',
    chooseFolderDescription: 'İçeriğini görüntülemek için bir klasör seçin.',
    addSection: 'Bölüm ekle',
    newSection: 'Yeni bölüm',
    sectionName: 'Bölüm adı',
    sectionNamePlaceholder: 'ör. Üretim',
    ungrouped: 'Gruplanmamış',
    unfiled: 'Klasörsüz',
    emptySection: 'Bu bölümde henüz klasör yok.',
    moveToSection: 'Bölüme taşı',
    noSection: 'Bölüm yok',
    renameSection: 'Bölümü yeniden adlandır',
    deleteSection: 'Bölümü sil',
    deleteSectionConfirm: 'Bu bölüm silinsin mi? İçindeki klasörler kalır ve gruplanmamış olur.',
    sectionCreated: 'Bölüm oluşturuldu',
    sectionRenamed: 'Bölüm yeniden adlandırıldı',
    sectionDeleted: 'Bölüm silindi',
    folderMovedToSection: 'Klasör taşındı',
    folderSection: 'Bölüm',
    trackPrintSettings: 'Yazdırma ayarlarını izle (yalnızca değiştir)',
    trackPrintSettingsHelp: 'Bu klasör üretim yuvalarını kullanır. Genel yükleme yerine Değiştir kullanın.',
    trackPrintSettingsForcedHelp: 'Bu bölüm izlemeyi zorunlu kılar. Klasörler boş başlar — parça ekleyin, sonra Üretim dosyası ekle / Değiştir kullanın.',
    trackPrintSettingsSectionHelp: 'Bu bölümdeki her klasör üretim yuvalarını kullanır. Yeni klasörlerde izleme kapatılamaz.',
    parameterTracking: 'Parametre izleme',
    parameterTrackingChip: 'Kısıtlı',
    printerModel: 'Yazıcı modeli',
    printerModelPlaceholder: 'Yazıcı seçin',
    printerModelHelp: 'Bu klasör, seçilen yazıcı için üretim yuvalarını kullanır.',
    printerModelCustom: 'Özel kod',
    printerModelCustomPlaceholder: 'ör. P1S',
    addFolderToSection: 'Klasör ekle',
    ...
    tags: {
      ...
      deleteAria: '{{name}} sil',
      fileTitle: 'Bu dosyanın etiketleri',
      fileTooltip: 'Bu dosyaya etiket ekle veya kaldır',
      applySave: 'Etiketleri kaydet',
      applySaveSuccess: 'Bu dosyanın etiketleri güncellendi.',
      addToFileAria: 'Bu dosyaya etiket ekle',
      removeFromFileAria: '{{name}} etiketini bu dosyadan kaldır',
    },
    allTypes: 'Tüm türler',
    prints: 'Baskılar',
    ascending: 'Artan',
    ...
    sectionParts: {
      title: 'Parçalar',
      add: 'Parça ekle',
      addTitle: 'Bölüm parçası ekle',
      code: 'Parça kodu',
      name: 'Ad',
      setParameters: 'Parametreleri ayarla',
      setParametersHelp: 'Bu yazdırılabilir bir dosya değil — yalnızca bu parçanın yazdırma ayarları sözleşmesini belirler.',
      replaceParameters: 'Parametreleri değiştir',
      replaceParametersTitle: 'Parça parametrelerini değiştir',
      replaceParametersHelp: 'Bu parçanın yazdırma ayarları sözleşmesini değiştirmek için bir 3MF yükleyin. Klasör dosyaları yeni spesifikasyona göre yeniden kontrol edilir.',
      replaceConfirm: 'Parametreleri değiştir',
      replaceFailed: 'Parametreler değiştirilemedi: {{error}}',
      replaced: 'Parça parametreleri değiştirildi',
      previewFailed: 'Parametre değişimi önizlenemedi: {{error}}',
      delete: 'Parçayı sil',
      deleteConfirm: '{{code}} parça şablonu silinsin mi? Klasörler bu kodu daha sonra yine ekleyebilir.',
      deleteConfirmInUse: '{{code}} parça şablonu silinsin mi? {{count}} klasör örneği kalır ve bu kodu kullanmaya devam eder.',
      empty: 'Bu bölümde henüz parça şablonu yok. Klasörler yine parça ekleyebilir; bu da şablonu oluşturur.',
      notPrintable: 'Bölüm parçaları yazdırılamaz — yalnızca ayar sözleşmesini tanımlar.',
      followsSectionSpec: 'Bu klasör, bölümün yazdırma ayarları sözleşmesine uymalıdır.',
      seedFailed: 'Parametreler ayarlanamadı: {{error}}',
      created: 'Parça şablonu oluşturuldu',
      deleted: 'Parça şablonu silindi',
      manage: 'Parçaları yönet',
      seeded: 'Parça parametreleri kaydedildi',
      addFailed: 'Parça oluşturulamadı: {{error}}',
      deleteFailed: 'Parça silinemedi: {{error}}',
      catalog: 'Bölüm parçaları',
      orCreate: 'Veya yeni bir parça oluştur',
      arrangeHint: 'Sürükleyerek yeniden sıralayın. TOP önde, yanında BOT — istediğiniz sıra.',
      dragHandle: 'Yeniden sırala',
      reorderFailed: 'Parça sırası kaydedilemedi: {{error}}',
    },
    production: {
      title: 'Üretim dosyaları',
      subtitle: '{{printer}} üretim yuvaları',
      addFile: 'Üretim dosyası ekle',
      replace: 'Değiştir',
      delete: 'Sil',
      proceedAnyway: 'Yine de devam et',
      acceptBaseline: 'Yeni temel olarak kabul et',
      cancel: 'Vazgeç',
      reason: 'Gerekçe',
      reasonPlaceholder: 'Temel neden değişiyor?',
      parameterNote: 'Açıklama',
      parameterNotePlaceholder: 'Bu parametre neden farklı?',
      notesRequired: 'Devam etmeden önce eşleşmeyen her parametreyi açıklayın.',
      mismatchNote: 'Uyumsuzluk notu',
      newSlotConfirm: 'Mevcut bir dosyayı değiştirmeden yeni bir üretim yuvası oluşturulacak.',
      parseFailed: 'Dosya adı çözümlenemedi. Aşağıdaki alanları doldurun.',
      versionNotNewer: 'Gelen sürüm {{incoming}}, {{current}} sürümünden daha yeni değil.',
      matchesSpec: 'Belirtimle uyumlu',
      differsByDesign: 'Tasarım gereği farklı',
      lastReplaceMismatched: 'Son değiştirmede uyumsuzluk vardı',
      emptyFolder: 'Henüz üretim dosyası yok. İlk yuvayı oluşturmak için bir dosya ekleyin.',
      quantity: 'Adet',
      version: 'Sürüm',
      noActiveFile: 'Etkin dosya yok',
      uploadIntoProductionBlocked: 'Genel yükleme yerine Değiştir veya Üretim dosyası ekle kullanın.',
      moveIntoProductionBlocked: 'Production tarafından yönetilir',
      mismatchCount: '{{count}} parametre farklı',
      parameter: 'Parametre',
      lockedValue: 'Kilitli değer',
      incomingValue: 'Gelen değer',
      code: 'Parça kodu',
      printer: 'Yazıcı',
      pickFile: 'Dosya seç',
      confirmCreate: 'Yuva oluştur',
      currentVersion: 'Geçerli sürüm',
      incomingVersion: 'Gelen sürüm',
      printerMismatch: 'Dosya yazıcısı {{file}} bu klasörle ({{folder}}) eşleşmiyor.',
      dropToAdd: 'Üretim yuvası eklemek için bir dosyayı buraya bırakın',
      print: 'Yazdır',
      loading: 'Üretim dosyaları yükleniyor...',
      slotCreated: 'Üretim yuvası oluşturuldu',
      slotReplaced: 'Üretim dosyası değiştirildi',
      deleteConfirmTitle: 'Üretim dosyasını sil',
      deleteConfirm: '{{printer}} üzerindeki {{code}} x{{quantity}} {{version}} silinsin mi? Bu işlem geri alınamaz.',
      deleteConfirmDetail:
        'Dosyalar Dosya Yöneticisi çöp kutusuna taşınır ve gerekirse oradan geri yüklenebilir.',
      slotDeleted: 'Üretim yuvası silindi',
      deleteFailed: 'Yuva silinemedi: {{error}}',
      createFailed: 'Yuva oluşturulamadı: {{error}}',
      replaceFailed: 'Dosya değiştirilemedi: {{error}}',
      previewFailed: 'Değiştirme önizlemesi başarısız: {{error}}',
      slotExists: 'Bu parça ve adet için yuva zaten var. Değiştir kullanın.',
      newPartHint: 'Yeni bir parça ({{code}}) eklenecek.',
      newQuantityHint: '{{code}} için zaten yuvalar var. x{{quantity}} adet eklenecek.',
      sharedContractHint: 'Bu yazıcıdaki {{code}} adet varyantları aynı yazdırma ayarları sözleşmesini paylaşır.',
      addPart: 'Parça ekle',
      addPartTitle: 'Bu yazıcıya parça ekle',
      partName: 'Parça adı',
      partCodeHint: 'Yalnızca büyük harf, 1–32 karakter (örneğin TOP veya LID).',
      confirmAddPart: 'Parça ekle',
      partAdded: 'Parça eklendi',
      addPartFailed: 'Parça eklenemedi: {{error}}',
      removePart: 'Parçayı kaldır',
      removePartConfirmTitle: 'Parçayı kaldır',
      removePartConfirmEmpty: '{{code}} ({{name}}) parçasını {{printer}} yazıcısından kaldırmak istiyor musunuz? Daha sonra yeniden ekleyebilirsiniz.',
      removePartConfirmWithFiles: '{{code}} ({{name}}) parçasını {{printer}} yazıcısından kaldırmak istiyor musunuz? {{count}} üretim dosyası çöpe taşınacak.',
      partRemoved: 'Parça kaldırıldı',
      removePartFailed: 'Parça kaldırılamadı: {{error}}',
      addFileToPart: 'Dosya ekle',
      emptyPart: 'Bu parça için henüz dosya yok.',
      previewing: 'Belirtimle karşılaştırılıyor...',
      uploading: 'Yükleniyor...',
      suggestedVersion: 'Önerilen sonraki sürüm: {{version}}',
      match: 'Eşleşiyor',
      mismatch: 'Uyumsuz',
      specs: {
        view: 'Özellikleri görüntüle',
        title: 'Geçerli yazdırma özellikleri',
        layerHeight: 'Katman yüksekliği',
        initialLayerLineWidth: 'İlk katman çizgi genişliği',
        infillDensity: 'Dolgu yoğunluğu',
        infillPattern: 'Dolgu deseni',
        wallLoops: 'Duvarlar',
        brimType: 'Kenar (brim)',
        brimWidth: 'Kenar genişliği',
        brimObjectGap: 'Kenar–nesne boşluğu',
        fuzzySkin: 'Pürüzlü yüzey',
        fuzzySkinPainted: 'Boyalı',
        fuzzySkinAllowPaint: 'Boyamaya izin ver',
        fuzzySkinThickness: 'Pürüzlü yüzey kalınlığı',
        fuzzySkinPointDistance: 'Pürüzlü yüzey nokta aralığı',
        enableSupport: 'Destekler',
        supportType: 'Destek türü',
        supportStyle: 'Destek stili',
        supportTreeAuto: 'Ağaç otomatik',
        supportTreeManual: 'Ağaç elle',
        supportNormalAuto: 'Normal otomatik',
        supportNormalManual: 'Normal elle',
        supportStyleSlim: 'İnce ağaç',
        supportStyleHybrid: 'Hibrit',
        supportStyleStrong: 'Güçlü ağaç',
        supportStyleOrganic: 'Organik',
        supportStyleDefault: 'Varsayılan',
        supportStyleSnug: 'Sıkı oturan',
        supportStyleGrid: 'Izgara',
        enablePrimeTower: 'Astar kulesi',
        seamPosition: 'Dikiş',
        nozzlesUsed: 'Nozullar',
        bed: 'Tabla',
        bedTypeTexturedPei: 'Dokulu PEI',
        bedTypeSmoothPei: 'Pürüzsüz PEI',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'SuperTack plaka',
        bedTypeEngineering: 'Engineering Plate',
        bedTypeHighTemp: 'High Temp Plate',
        on: 'Açık',
        off: 'Kapalı',
        brimAuto: 'Otomatik kenar',
        brimNone: 'Kenar yok',
        brimOuter: 'Yalnızca dış',
        brimInner: 'Yalnızca iç',
        brimBoth: 'Dış ve iç',
        nozzlesLeft: 'Sol',
        nozzlesRight: 'Sağ',
        nozzlesBoth: 'Her ikisi',
        infillPatterns: {
          concentric: 'Eşmerkezli',
          rectilinear: 'Doğrusal',
          monotonic: 'Monotonik',
          monotonicLine: 'Monotonik çizgi',
          alignedRectilinear: 'Hizalanmış doğrusal',
          hilbertCurve: 'Hilbert eğrisi',
          archimedeanChords: 'Arşimet kirişleri',
          octagramSpiral: 'Sekizgen spiral',
        },
        valueMm: '{{value}}\u00a0mm',
        valuePercent: '%{{value}}',
        summaryInfill: '%{{value}} dolgu',
        summarySupports: 'Destekler: {{detail}}',
        summaryBrimGap: '{{value}}\u00a0mm boşluk',
        summaryBed: 'Tabla: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: 'AMS yuvası seçmek için bir malzemeye tıklayın',
    chooseMaterialSlot: 'Malzeme {{n}} için ekstrüder/renk seçin',
    mustMapMaterials: 'Malzemeler seçilmeli/eşleştirilmeli',
    unmappedSlot: '—',
    emptySlot: 'Boş',
    noAmsSlots: 'Bu yazıcı AMS veya harici makara bildirmiyor.',
    useAutoMatch: 'Otomatik eşleştirmeyi kullan',
    reRead: 'Yeniden oku',
    plateN: 'Plaka {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Kapasite ayarı',
    applyWeekdayDefaults: 'Pzt–Cum 8:00–17:00 uygula',
    timezone: 'Saat dilimi',
    capacityConfigDescription: 'Haftalık yazıcı saatleri, hat başlangıcı, yatak temizliği ve cihaz reçetesi (parça modelleri). Stats 2 kullanır.',
    lineStart: 'Hat başlangıcı (HH:MM)',
    preLineBuffer: 'Hat öncesi tampon (dk)',
    expectedClear: 'Beklenen yatak temizliği (dk)',
    weeklyHours: 'Haftalık personel saatleri',
    weeklyHoursHint: 'Şimdilik vardiyaları API ile düzenleyin; tam ızgara Stats 2 sayfasında.',
    unstaffed: 'Personelsiz',
    saveGlobals: 'Hat başlangıcı ve temizliği kaydet',
    configSaved: 'Kaydedildi — kapasite yenilenecek',
    unsavedChanges: 'Kaydedilmemiş değişiklikler',
    deviceRecipe: 'Cihaz reçetesi (parça modelleri)',
    printerTimeBlocks: 'Yazıcı zaman blokları (boş olmalı)',
    printerTimeBlocksHint:
      'Bir yazıcının boş kalması gereken yinelenen haftalık pencereler. Haftalık plan, bu bloklarla çakışan bir baskı (temizleme süresi dahil) yerleştirmez.',
    noPrintersForBlocks: 'Yapılandırılacak etkin yazıcı yok.',
    blockPrinter: 'Yazıcı',
    noBlocksYet: 'Bu yazıcı için ayrılmış pencere yok.',
    blockLabel: 'Etiket (isteğe bağlı)',
    addTimeBlock: 'Zaman bloğu ekle',
    saveTimeBlocks: 'Yazıcı zaman bloklarını kaydet',
    invalidBlockRange: '{{day}}: blok başlangıcı bitişten önce olmalı ({{start}} → {{end}})',
    discoveredCount: '{{count}} keşfedilen dosya',
    pageTitle: 'Stats 2 — Gerçek kapasite',
    deviceCapacity: 'Cihaz kapasitesi',
    todaysReadiness: 'Bugünün hazırlığı',
    printSchedule: 'Bu haftanın baskı planı',
    buildPlan: 'Üretim planı',
    buildPlanHint: 'Her satır, haftalık planın o parça için başlattığı plaka dosya(lar)ını listeler. Plakalar ve parçalar seçilen günün tam sayı başlangıçlarıdır — üstteki zaman çizelgesindeki çubuklarla aynı.',
    targetDevicesDay: 'Hedef cihaz / gün',
    whatIf: 'Ya olsa',
    capacityMaxHint: 'En fazla ~{{n}}/gün',
    targetNotFeasible: 'Hedef baskı kapasitesinin üzerinde',
    targetNotFeasibleBody: '{{target}}/gün istendi; plan günde yaklaşık {{achievable}} temizleyebilir.',
    bindingPartSuffix: 'Darboğaz parça: {{binding}}.',
    scenarioAtTarget: '{{n}} cihaz/gün senaryosu — plaka / parçalar üstteki {{day}} tam sayı başlangıçlarıdır.',
    scenarioAtCapacity: 'Plaka / parçalar üstteki {{day}} tam sayı başlangıçlarıdır (gerçekçi kapasite). Senaryo için hedef girin.',
    dedicatedFleetHint: 'Ayrılmış filo tahmini ~{{n}}/gün paylaşılan yazıcıları yok sayar (aynı makineler her parça için sayılır). Zamanlanabilir değer haftalık zaman çizelgesiyle uyumludur.',
    cleanupFeedback: 'Temizlik: hedef vs gerçek',
    productionYield: 'Üretim verimi',
    leadTimes: 'Saha süreleri',
    qualityReasons: 'Kalite ve kayıp nedenleri',
    printerReliability: 'Yazıcı güvenilirliği',
    filamentPerDevice: 'Cihaz başına filament',
    configuration: 'Yapılandırma',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — en az {{extra}} {{models}} yazıcı daha gerekir',
    shortPartsHeading: 'Eksik parçalar (aynı operatör programı):',
    shortPartUnknownModels: 'uygun',
    shortPartsSharedNote:
      'Ek yazıcılar parça başına alt sınırdır (aynı program). Paylaşılan modeller gerçekte bir kez sayılır — sayıları toplamayın.',
    hypotheticalFleetNote:
      'Zaman çizelgesi bu istek için +{{n}} varsayımsal yazıcı ({{detail}}) içerir — kesik çizgili şeritler.',
