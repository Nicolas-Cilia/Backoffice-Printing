export default {
  ...
  printers: {
    ...
    startPrintOn: '{{name}} で印刷を開始',
    yourFiles: 'あなたのファイル',
    printableTypesHint: '対応: .gcode、.gcode.3mf',
    uploadToPrintHint: '印刷可能なファイルをここにドロップするか、「あなたのファイル」から選ぶと、このパネルに印刷オプションが開きます。',
    pickFromLibraryHint: '「あなたのファイル」から印刷可能なファイルを選ぶと、このパネルに印刷オプションが開きます。',
    saveToYourFiles: 'あなたのファイルに保存',
    saveToYourFilesHint: '既定はオフ — アップロードはこの印刷のみに使い、未整理には残しません。',
    saveLocation: '保存先',
    changeFile: 'ファイルを変更',
    printOptionsAdvanced: '詳細オプション',
    noPrinterSelected: 'プリンターが選択されていません',
  },
  ...
  maintenance: {
    ...
    printerLog: 'プリンターログ',
    logCustomJob: 'カスタム作業を記録',
    logReset: '記録してリセット',
    logResetTitle: '{{name}}をリセットしますか？',
    logResetMessage: '間隔をリセットし、プリンターログに追加します。何かあればメモを残してください。',
    jobName: '作業',
    jobNamePlaceholder: '例: ノズル交換',
    notes: 'メモ',
    notesPlaceholder: '何をしましたか？',
    resetNotesPlaceholder: '任意のメモ…',
    partLink: 'パーツリンク（任意）',
    cost: '費用（任意）',
    saveLog: 'ログに保存',
    editLog: 'ログを編集',
    editLogTitle: 'ログを編集',
    logUpdated: 'ログエントリを更新しました',
    deleteLog: 'ログを削除',
    deleteLogTitle: 'ログエントリを削除しますか？',
    deleteLogMessage: 'プリンターログから「{{name}}」を削除しますか？予定されたリセットは取り消されません。ログ行とその費用だけが削除されます。',
    logDeleted: 'ログエントリを削除しました',
    hideTask: '非表示',
    showTask: '表示',
    hiddenTasks: '非表示のタスク',
    hiddenTasksDescription: '非表示にしたデフォルトタスクは保存されたままです。1つを表示すれば、すべてを復元せずに戻せます。',
    hideTaskTitle: '「{{name}}」を非表示にしますか？',
    hideTaskMessage: 'ステータスタブから外れます。非表示のタスクから再表示できるので、作り直したりすべてのデフォルトを復元したりする必要はありません。',
    taskHidden: 'タスクを非表示にしました',
    taskShown: 'タスクを再表示しました',
    totalMaintenanceCost: 'メンテナンス費用',
    jobLogged: '作業をプリンターログに保存しました',
    customJob: 'カスタム作業',
  ...
  settings: {
    ...
    manageLibraryDescription: 'ライブラリファイルのアップロード、名前変更、削除。',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        downloadFailed: 'プリセットをダウンロードできませんでした',
      },
      partSections: {
        title: 'パーツプロセスセクション',
        addSection: 'プロセスセクションを追加',
        sectionName: 'セクション名',
        trackParameters: 'パラメータを追跡',
        trackParametersHelp: 'オンにするとプロセスは共通の印刷設定契約を共有します。オフにすると不一致チェックを省略します。',
        namePlaceholder: '上部パーツ',
        create: '作成',
        empty: 'パーツプロセスセクションはまだありません。作成してプロセスをパーツごとにまとめます。',
        addProcess: 'プロセスを追加',
        uploadProcess: 'プロセスをアップロード',
        uploadFailed: 'プロセスをアップロードできませんでした: {{error}}',
        confirmAttachTitle: 'プロセスが仕様と一致しません',
        dontUpload: 'アップロードしない',
        dontMove: '移動しない',
        moveToSection: 'セクションへ移動',
        pickSection: '部品プロセスセクションを選択',
        noSectionsToMove: '先に部品プロセスセクションを作成してください',
        moveFailed: 'プロセスを移動できませんでした: {{error}}',
        replace: '置き換え',
        remove: '削除',
        noProcesses: 'このセクションにプロセスはありません',
        pickProcess: 'プロセスプリセットを選択',
        noAvailable: '追加できるプロセスプリセットがありません',
        replaceTitle: 'プロセスを置き換え',
        incomingProcess: '新しいプロセス',
        previewFailed: '置き換えのプレビューに失敗しました: {{error}}',
        replaceFailed: 'プロセスを置き換えできませんでした: {{error}}',
        createFailed: 'セクションを作成できませんでした: {{error}}',
        addFailed: 'プロセスを追加できませんでした: {{error}}',
        removeFailed: 'スロットを削除できませんでした: {{error}}',
        deleteSection: 'セクションを削除',
        deleteSectionConfirm: 'このパーツセクションとプリンタースロットを削除しますか？',
        unknownPrinter: '不明',
        toast: {
          created: 'パーツセクションを作成しました',
          deleted: 'パーツセクションを削除しました',
          processAdded: 'プロセスを追加しました',
          uploaded: 'プロセスをアップロードしました',
          replaced: 'プロセスを置き換えました',
          slotRemoved: 'プロセスを削除しました',
        },
      },
    },
    connectedAs: '接続中:',
    signInExpiredTitle: 'Bambu Cloud のサインインの有効期限が切れました',
    signInExpiredBody: '保存されたトークンは Bambu Lab に受け付けられなくなりました。クラウドプロファイル、ファームウェア確認を復元するには、再度サインインしてください。',
    logout: 'ログアウト',
  ...
  fileManager: {
    ...
    allFiles: 'すべてのファイル',
    allExternal: '外部',
    backToFolders: 'フォルダに戻る',
    chooseFolderTitle: '閲覧するフォルダを選択してください',
    chooseFolderDescription: 'フォルダを選択して内容を表示します。',
    addSection: 'セクションを追加',
    newSection: '新しいセクション',
    sectionName: 'セクション名',
    sectionNamePlaceholder: '例：Production',
    ungrouped: '未分類',
    unfiled: '未整理',
    emptySection: 'このセクションにはまだフォルダがありません。',
    moveToSection: 'セクションへ移動',
    noSection: 'セクションなし',
    renameSection: 'セクション名を変更',
    deleteSection: 'セクションを削除',
    deleteSectionConfirm: 'このセクションを削除しますか？中のフォルダは残し、未分類になります。',
    sectionCreated: 'セクションを作成しました',
    sectionRenamed: 'セクション名を変更しました',
    sectionDeleted: 'セクションを削除しました',
    folderMovedToSection: 'フォルダを移動しました',
    folderSection: 'セクション',
    trackPrintSettings: '印刷設定を追跡（差し替えのみ）',
    trackPrintSettingsHelp: 'このフォルダは本番スロットを使います。通常のアップロードではなく差し替えを使用してください。',
    trackPrintSettingsForcedHelp: 'このセクションでは追跡が必須です。フォルダは空で始まります。部品を追加してから本番ファイルの追加／差し替えを使ってください。',
    trackPrintSettingsSectionHelp: 'このセクションのすべてのフォルダは本番スロットを使います。新規フォルダで追跡をオフにはできません。',
    parameterTracking: 'パラメータ追跡',
    parameterTrackingChip: '制限',
    printerModel: 'プリンターモデル',
    printerModelPlaceholder: 'プリンターを選択',
    printerModelHelp: 'このフォルダは選択したプリンターの本番スロットを使います。',
    printerModelCustom: 'カスタムコード',
    printerModelCustomPlaceholder: '例：P1S',
    addFolderToSection: 'フォルダを追加',
    ...
    tags: {
      ...
      deleteAria: '{{name}}を削除',
      fileTitle: 'このファイルのタグ',
      fileTooltip: 'このファイルのタグを追加または削除',
      applySave: 'タグを保存',
      applySaveSuccess: 'このファイルのタグを更新しました。',
      addToFileAria: 'このファイルにタグを追加',
      removeFromFileAria: 'このファイルからタグ「{{name}}」を削除',
    },
    allTypes: 'すべての種類',
    prints: '印刷回数',
    ascending: '昇順',
    ...
    sectionParts: {
      title: 'パーツ',
      add: 'パーツを追加',
      addTitle: 'セクションパーツを追加',
      code: '部品コード',
      name: '名称',
      setParameters: 'パラメータを設定',
      setParametersHelp: 'これは印刷用ファイルではありません。このパーツの印刷設定契約だけを設定します。',
      replaceParameters: 'パラメータを置き換え',
      replaceParametersTitle: 'パーツパラメータを置き換え',
      replaceParametersHelp: '3MFをアップロードして、このパーツの印刷設定契約を置き換えます。フォルダ内のファイルは新しい仕様に照らして再確認されます。',
      replaceConfirm: 'パラメータを置き換え',
      replaceFailed: 'パラメータを置き換えできませんでした: {{error}}',
      replaced: 'パーツパラメータを置き換えました',
      previewFailed: 'パラメータ置き換えのプレビューに失敗しました: {{error}}',
      delete: 'パーツを削除',
      deleteConfirm: 'パーツテンプレート {{code}} を削除しますか？フォルダはこのコードを後から追加できます。',
      deleteConfirmInUse: 'パーツテンプレート {{code}} を削除しますか？{{count}} 件のフォルダインスタンスは残り、このコードを使い続けます。',
      empty: 'このセクションにはまだパーツテンプレートがありません。フォルダでパーツを追加すると、テンプレートも作成されます。',
      notPrintable: 'セクションパーツは印刷できません。設定契約だけを定義します。',
      followsSectionSpec: 'このフォルダはセクションの印刷設定契約に従う必要があります。',
      seedFailed: 'パラメータを設定できませんでした: {{error}}',
      created: 'パーツテンプレートを作成しました',
      deleted: 'パーツテンプレートを削除しました',
      manage: 'パーツを管理',
      seeded: 'パーツのパラメータを保存しました',
      addFailed: 'パーツを作成できませんでした: {{error}}',
      deleteFailed: 'パーツを削除できませんでした: {{error}}',
      catalog: 'セクションパーツ',
      orCreate: 'または新しいパーツを作成',
      arrangeHint: 'ドラッグして並べ替えます。TOPを先頭、隣にBOTなど、好きな順にできます。',
      dragHandle: '並べ替え',
      reorderFailed: 'パーツの順序を保存できませんでした: {{error}}',
    },
    production: {
      title: '生産ファイル',
      subtitle: '{{printer}} の生産スロット',
      addFile: '生産ファイルを追加',
      replace: '差し替え',
      delete: '削除',
      proceedAnyway: 'このまま進める',
      acceptBaseline: '新しい基準として採用',
      cancel: 'キャンセル',
      reason: '理由',
      reasonPlaceholder: '基準を変える理由は？',
      parameterNote: 'メモ',
      parameterNotePlaceholder: 'このパラメータが異なる理由は？',
      notesRequired: '続行する前に、一致しないパラメータをすべて説明してください。',
      mismatchNote: '不一致のメモ',
      newSlotConfirm: '既存ファイルの差し替えではなく、新しい生産スロットを作成します。',
      parseFailed: 'ファイル名を解析できませんでした。下の欄を入力してください。',
      versionNotNewer: '取り込みバージョン {{incoming}} は {{current}} より新しくありません。',
      matchesSpec: '仕様と一致',
      differsByDesign: '設計上の差異',
      lastReplaceMismatched: '前回の差し替えで不一致がありました',
      emptyFolder: 'まだ生産ファイルがありません。最初のスロットを作成するファイルを追加してください。',
      quantity: '数量',
      version: '版',
      noActiveFile: '有効なファイルなし',
      uploadIntoProductionBlocked: '通常のアップロードではなく、差し替えまたは生産ファイルの追加を使ってください。',
      moveIntoProductionBlocked: 'Productionで管理',
      mismatchCount: '{{count}} 件のパラメータが異なります',
      parameter: 'パラメータ',
      lockedValue: 'ロック値',
      incomingValue: '取り込み値',
      code: '部品コード',
      printer: 'プリンタ',
      pickFile: 'ファイルを選択',
      confirmCreate: 'スロットを作成',
      currentVersion: '現在の版',
      incomingVersion: '取り込み版',
      printerMismatch: 'ファイルのプリンタ {{file}} はこのフォルダ ({{folder}}) と一致しません。',
      dropToAdd: 'ここにファイルをドロップして生産スロットを追加',
      print: '印刷',
      loading: '生産ファイルを読み込み中...',
      slotCreated: '生産スロットを作成しました',
      slotReplaced: '生産ファイルを差し替えました',
      deleteConfirmTitle: '生産ファイルを削除',
      deleteConfirm: '{{printer}} の {{code}} x{{quantity}} {{version}} を削除しますか？この操作は元に戻せません。',
      deleteConfirmDetail:
        'ファイルはファイルマネージャーのゴミ箱に移され、必要ならそこから復元できます。',
      slotDeleted: '生産スロットを削除しました',
      deleteFailed: 'スロットを削除できませんでした: {{error}}',
      createFailed: 'スロットを作成できませんでした: {{error}}',
      replaceFailed: 'ファイルを差し替えできませんでした: {{error}}',
      previewFailed: '差し替えプレビューに失敗しました: {{error}}',
      slotExists: 'この部品と数量のスロットは既にあります。差し替えを使ってください。',
      newPartHint: '新しい部品 ({{code}}) を追加します。',
      newQuantityHint: '{{code}} には既にスロットがあります。数量 x{{quantity}} を追加します。',
      sharedContractHint: 'このプリンターの {{code}} の数量バリエーションは、同じ印刷設定契約を共有します。',
      addPart: 'パーツを追加',
      addPartTitle: 'このプリンターにパーツを追加',
      partName: 'パーツ名',
      partCodeHint: '大文字のみ、1～32文字（例: TOP または LID）。',
      confirmAddPart: 'パーツを追加',
      partAdded: 'パーツを追加しました',
      addPartFailed: 'パーツを追加できませんでした: {{error}}',
      removePart: 'パーツを削除',
      removePartConfirmTitle: 'パーツを削除',
      removePartConfirmEmpty: '{{printer}} から {{code}}（{{name}}）を削除しますか？後で再追加できます。',
      removePartConfirmWithFiles: '{{printer}} から {{code}}（{{name}}）を削除しますか？生産ファイル {{count}} 件がゴミ箱に移動されます。',
      partRemoved: 'パーツを削除しました',
      removePartFailed: 'パーツを削除できませんでした: {{error}}',
      addFileToPart: 'ファイルを追加',
      emptyPart: 'このパーツのファイルはまだありません。',
      previewing: '仕様と比較しています...',
      uploading: 'アップロード中...',
      suggestedVersion: '推奨される次の版: {{version}}',
      match: '一致',
      mismatch: '不一致',
      specs: {
        view: '仕様を表示',
        title: '現在の印刷仕様',
        layerHeight: '積層ピッチ',
        initialLayerLineWidth: '初層の線幅',
        infillDensity: 'インフィル密度',
        infillPattern: 'インフィルパターン',
        wallLoops: 'ウォール',
        brimType: 'ブリム',
        brimWidth: 'ブリム幅',
        brimObjectGap: 'ブリムとオブジェクトの隙間',
        fuzzySkin: 'ファジースキン',
        fuzzySkinPainted: 'ペイント済み',
        fuzzySkinAllowPaint: 'ペイント可',
        fuzzySkinThickness: 'ファジースキンの厚さ',
        fuzzySkinPointDistance: 'ファジースキンの点間隔',
        enableSupport: 'サポート',
        supportType: 'サポートタイプ',
        supportStyle: 'サポートスタイル',
        supportTreeAuto: 'ツリー自動',
        supportTreeManual: 'ツリー手動',
        supportNormalAuto: '通常自動',
        supportNormalManual: '通常手動',
        supportStyleSlim: 'スリムツリー',
        supportStyleHybrid: 'ハイブリッド',
        supportStyleStrong: '強ツリー',
        supportStyleOrganic: 'オーガニック',
        supportStyleDefault: 'デフォルト',
        supportStyleSnug: '密着',
        supportStyleGrid: 'グリッド',
        enablePrimeTower: 'プライムタワー',
        seamPosition: 'シーム',
        nozzlesUsed: 'ノズル',
        bed: 'ベッド',
        bedTypeTexturedPei: 'テクスチャ PEI',
        bedTypeSmoothPei: 'スムース PEI',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'SuperTackプレート',
        ...
        infillPatterns: {
          ...
          monotonic: '単調',
          monotonicLine: '単調線',
          alignedRectilinear: '整列直線',
          hilbertCurve: 'ヒルベルト曲線',
          archimedeanChords: 'アルキメデス螺旋',
          octagramSpiral: 'オクタグラムスパイラル',
        },
        valueMm: '{{value}}mm',
        valuePercent: '{{value}}％',
        summaryInfill: 'インフィル {{value}}%',
        summarySupports: 'サポート: {{detail}}',
        summaryBrimGap: 'ギャップ {{value}}mm',
        summaryBed: 'ベッド: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: '素材をクリックして AMS スロットを選択',
    chooseMaterialSlot: '材料 {{n}} に使うエクストルーダー/色を選択',
    mustMapMaterials: '材料を選択/マッピングする必要があります',
    unmappedSlot: '—',
    emptySlot: '空',
    noAmsSlots: 'このプリンターから AMS または外部スプールは報告されていません。',
    useAutoMatch: '自動マッチを使用',
    reRead: '再読み込み',
    plateN: 'プレート {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — 生産能力設定',
    applyWeekdayDefaults: '月〜金 8:00–17:00 を適用',
    timezone: 'タイムゾーン',
    capacityConfigDescription: '週次プリンター稼働、ライン開始、ベッド片付け、デバイスBOM（部品モデル）。Stats 2で使用。',
    lineStart: 'ライン開始 (HH:MM)',
    preLineBuffer: 'ライン前バッファ（分）',
    expectedClear: '想定ベッド片付け（分）',
    weeklyHours: '週次稼働時間',
    weeklyHoursHint: '当面はAPIでシフト編集。完全なグリッドはStats 2ページで提供。',
    unstaffed: '無人',
    saveGlobals: 'ライン開始と片付けを保存',
    configSaved: '保存しました — 生産能力を更新します',
    unsavedChanges: '未保存の変更',
    deviceRecipe: 'デバイスレシピ（部品モデル）',
    printerTimeBlocks: 'プリンター時間ブロック（空き必須）',
    printerTimeBlocksHint:
      'プリンターを空けておく必要がある毎週の時間帯です。週次スケジュールは、これらのブロックと重なる印刷（クリア時間を含む）を配置しません。',
    noPrintersForBlocks: '設定できる稼働中のプリンターがありません。',
    blockPrinter: 'プリンター',
    noBlocksYet: 'このプリンターの予約時間帯はありません。',
    blockLabel: 'ラベル（任意）',
    addTimeBlock: '時間ブロックを追加',
    saveTimeBlocks: 'プリンター時間ブロックを保存',
    invalidBlockRange: '{{day}}: ブロックの開始は終了より前である必要があります（{{start}} → {{end}}）',
    discoveredCount: '検出ファイル {{count}} 件',
    pageTitle: 'Stats 2 — 真の生産能力',
    deviceCapacity: 'デバイス生産能力',
    todaysReadiness: '本日の準備状況',
    printSchedule: '今週の印刷スケジュール',
    buildPlan: 'ビルドプラン',
    buildPlanHint: '各行は週間スケジュールがその部品で開始するプレートファイルです。プレート数と部品数は選択日の整数の開始数で、上のタイムラインのバーと同じです。',
    targetDevicesDay: '目標デバイス / 日',
    whatIf: '仮定',
    capacityMaxHint: '上限 ~{{n}}/日',
    targetNotFeasible: '目標が印刷能力を超えています',
    targetNotFeasibleBody: '要求 {{target}}/日；スケジュールでは約 {{achievable}}/日までクリア可能です。',
    bindingPartSuffix: 'ボトルネック部品: {{binding}}。',
    scenarioAtTarget: '{{n}} デバイス/日の仮定 — プレート/部品は上の {{day}} の整数開始数です。',
    scenarioAtCapacity: 'プレート/部品は上の {{day}} の整数開始数です（現実的な能力）。目標を入力して仮定計算します。',
    dedicatedFleetHint: '専有フリート見積もり ~{{n}}/日は共有プリンタを無視します（同じ機械を各部品に計上）。スケジュール可能数は週間タイムラインと一致します。',
    cleanupFeedback: '片付け：目標と実績',
    productionYield: '生産歩留まり',
    leadTimes: 'フロアリードタイム',
    qualityReasons: '品質・ロス理由',
    printerReliability: 'プリンター信頼性',
    filamentPerDevice: 'デバイスあたりフィラメント',
    configuration: '設定',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — 少なくとも{{extra}}台の追加{{models}}プリンターが必要',
    shortPartsHeading: '不足パーツ（同じオペレーター予定）:',
    shortPartUnknownModels: '対象',
    shortPartsSharedNote:
      '追加プリンター数はパーツごとの下限です（同じ予定）。共有モデルは実際には1回だけ数えます — 足し合わせないでください。',
    hypotheticalFleetNote:
      'この要求のためタイムラインに仮説プリンター+{{n}}台（{{detail}}）を含みます — 破線レーン。',
    export: 'CSVを書き出す',
  },
