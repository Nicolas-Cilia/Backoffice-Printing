export default {
  ...
  printers: {
    ...
    startPrintOn: 'Druck starten auf {{name}}',
    yourFiles: 'Deine Dateien',
    printableTypesHint: 'Unterstützt: .gcode, .gcode.3mf',
    uploadToPrintHint: 'Lege hier eine druckbare Datei ab oder wähle eine aus Deinen Dateien — die Druckoptionen öffnen sich in diesem Bereich.',
    pickFromLibraryHint: 'Wähle eine druckbare Datei aus Deinen Dateien — die Druckoptionen öffnen sich in diesem Bereich.',
    saveToYourFiles: 'In Deinen Dateien speichern',
    saveToYourFilesHint: 'Standardmäßig aus — der Upload wird nur für diesen Druck verwendet und nicht unter Unsortiert behalten.',
    saveLocation: 'Speicherort',
    changeFile: 'Datei wechseln',
    printOptionsAdvanced: 'Erweiterte Optionen',
    noPrinterSelected: 'Kein Drucker ausgewählt',
  },
  ...
  maintenance: {
    ...
    printerLog: 'Druckerprotokoll',
    logCustomJob: 'Eigenen Auftrag protokollieren',
    logReset: 'Protokollieren und zurücksetzen',
    logResetTitle: '{{name}} zurücksetzen?',
    logResetMessage: 'Dadurch wird das Intervall zurückgesetzt und der Eintrag ins Druckerprotokoll aufgenommen. Hinterlassen Sie nur dann eine Notiz, wenn etwas Besonderes vorgefallen ist.',
    jobName: 'Auftrag',
    jobNamePlaceholder: 'z.B. Düse ersetzen',
    notes: 'Notizen',
    notesPlaceholder: 'Was haben Sie gemacht?',
    resetNotesPlaceholder: 'Optionale Notizen…',
    partLink: 'Teile-Link (optional)',
    cost: 'Kosten (optional)',
    saveLog: 'Im Protokoll speichern',
    editLog: 'Protokoll bearbeiten',
    editLogTitle: 'Protokoll bearbeiten',
    logUpdated: 'Protokolleintrag aktualisiert',
    deleteLog: 'Protokoll löschen',
    deleteLogTitle: 'Protokolleintrag löschen?',
    deleteLogMessage: '"{{name}}" aus dem Druckerprotokoll entfernen? Ein geplantes Zurücksetzen wird dadurch nicht rückgängig gemacht — es wird nur die Protokollzeile und ihre Kosten gelöscht.',
    logDeleted: 'Protokolleintrag gelöscht',
    hideTask: 'Ausblenden',
    showTask: 'Anzeigen',
    hiddenTasks: 'Ausgeblendete Aufgaben',
    hiddenTasksDescription: 'Ausgeblendete Standardaufgaben bleiben gespeichert. Blenden Sie eine wieder ein, um sie zurückzuholen, ohne alles wiederherzustellen.',
    hideTaskTitle: '{{name}} ausblenden?',
    hideTaskMessage: 'Die Aufgabe verschwindet vom Status-Tab. Sie können sie unter Ausgeblendete Aufgaben wieder einblenden — Sie müssen sie nicht neu anlegen oder alle Standardaufgaben wiederherstellen.',
    taskHidden: 'Aufgabe ausgeblendet',
    taskShown: 'Aufgabe wieder eingeblendet',
    totalMaintenanceCost: 'Wartungskosten',
    jobLogged: 'Auftrag im Druckerprotokoll gespeichert',
    customJob: 'Eigener Auftrag',
  ...
  settings: {
    ...
    manageLibraryDescription: 'Bibliotheksdateien hochladen, umbenennen und löschen',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      filament: 'Filament',
      process: 'Nicht zugeordnete Prozesse',
      printer: 'Drucker',
      toast: {
        ...
        downloadFailed: 'Voreinstellung konnte nicht heruntergeladen werden',
      },
      partSections: {
        title: 'Teile-Prozessabschnitte',
        addSection: 'Prozessabschnitte hinzufügen',
        sectionName: 'Abschnittsname',
        trackParameters: 'Parameter verfolgen',
        trackParametersHelp: 'Wenn aktiv, teilen Prozesse einen Drucksettings-Vertrag. Deaktivieren, um Abweichungsprüfungen zu überspringen.',
        namePlaceholder: 'Oberteil',
        create: 'Anlegen',
        empty: 'Noch keine Teile-Prozessabschnitte. Legen Sie einen an, um Prozesse nach Teil zu gruppieren.',
        addProcess: 'Prozess hinzufügen',
        uploadProcess: 'Prozess hochladen',
        uploadFailed: 'Prozess konnte nicht hochgeladen werden: {{error}}',
        confirmAttachTitle: 'Prozess entspricht nicht der Spezifikation',
        dontUpload: 'Nicht hochladen',
        dontMove: 'Nicht verschieben',
        moveToSection: 'In Abschnitt verschieben',
        pickSection: 'Teile-Prozessabschnitt wählen',
        noSectionsToMove: 'Legen Sie zuerst einen Teile-Prozessabschnitt an',
        moveFailed: 'Prozess konnte nicht verschoben werden: {{error}}',
        replace: 'Ersetzen',
        remove: 'Entfernen',
        noProcesses: 'Keine Prozesse in diesem Abschnitt',
        pickProcess: 'Prozess-Voreinstellung wählen',
        noAvailable: 'Keine Prozess-Voreinstellungen mehr zum Hinzufügen',
        replaceTitle: 'Prozess ersetzen',
        incomingProcess: 'Eingehender Prozess',
        previewFailed: 'Vorschau des Ersetzens fehlgeschlagen: {{error}}',
        replaceFailed: 'Prozess konnte nicht ersetzt werden: {{error}}',
        createFailed: 'Abschnitt konnte nicht angelegt werden: {{error}}',
        addFailed: 'Prozess konnte nicht hinzugefügt werden: {{error}}',
        removeFailed: 'Slot konnte nicht entfernt werden: {{error}}',
        deleteSection: 'Abschnitt löschen',
        deleteSectionConfirm: 'Diesen Teilabschnitt und seine Drucker-Slots löschen?',
        unknownPrinter: 'Unbekannt',
        toast: {
          created: 'Teilabschnitt angelegt',
          deleted: 'Teilabschnitt gelöscht',
          processAdded: 'Prozess hinzugefügt',
          uploaded: 'Prozess hochgeladen',
          replaced: 'Prozess ersetzt',
          slotRemoved: 'Prozess entfernt',
        },
      },
    },
    connectedAs: 'Verbunden als',
    signInExpiredTitle: 'Bambu-Cloud-Anmeldung abgelaufen',
    signInExpiredBody: 'Bambu Lab akzeptiert das gespeicherte Token nicht mehr. Melden Sie sich erneut an, um Cloud-Profile und Firmware-Prüfungen wiederherzustellen.',
    logout: 'Abmelden',
  ...
  fileManager: {
    ...
    chooseFolderTitle: 'Wählen Sie einen Ordner zum Durchsuchen',
    chooseFolderDescription: 'Wählen Sie einen Ordner, um dessen Inhalt anzuzeigen.',
    addSection: 'Bereich hinzufügen',
    newSection: 'Neuer Bereich',
    sectionName: 'Bereichsname',
    sectionNamePlaceholder: 'z. B. Produktion',
    ungrouped: 'Ohne Bereich',
    unfiled: 'Ohne Ordner',
    emptySection: 'Noch keine Ordner in diesem Bereich.',
    moveToSection: 'In Bereich verschieben',
    noSection: 'Kein Bereich',
    renameSection: 'Bereich umbenennen',
    deleteSection: 'Bereich löschen',
    deleteSectionConfirm: 'Diesen Bereich löschen? Ordner darin bleiben erhalten und werden ohne Bereich angezeigt.',
    sectionCreated: 'Bereich erstellt',
    sectionRenamed: 'Bereich umbenannt',
    sectionDeleted: 'Bereich gelöscht',
    folderMovedToSection: 'Ordner verschoben',
    folderSection: 'Bereich',
    trackPrintSettings: 'Druckeinstellungen verfolgen (nur Ersetzen)',
    trackPrintSettingsHelp: 'Dieser Ordner nutzt Produktions-Slots. Verwenden Sie Ersetzen statt des normalen Uploads.',
    trackPrintSettingsForcedHelp: 'Dieser Bereich verlangt Tracking. Ordner starten leer — Teile hinzufügen, dann Produktionsdatei hinzufügen / Ersetzen.',
    trackPrintSettingsSectionHelp: 'Jeder Ordner in diesem Bereich nutzt Produktions-Slots. Neue Ordner können Tracking nicht abschalten.',
    parameterTracking: 'Parameterverfolgung',
    parameterTrackingChip: 'Eingeschränkt',
    printerModel: 'Druckermodell',
    printerModelPlaceholder: 'Drucker auswählen',
    printerModelHelp: 'Dieser Ordner nutzt Produktions-Slots für den gewählten Drucker.',
    printerModelCustom: 'Eigener Code',
    printerModelCustomPlaceholder: 'z. B. P1S',
    addFolderToSection: 'Ordner hinzufügen',
    ...
    tags: {
      ...
      fileTitle: 'Tags an dieser Datei',
      fileTooltip: 'Tags an dieser Datei hinzufügen oder entfernen',
      applySave: 'Tags speichern',
      applySaveSuccess: 'Tags an dieser Datei aktualisiert.',
      addToFileAria: 'Tags zu dieser Datei hinzufügen',
      removeFromFileAria: 'Tag {{name}} von dieser Datei entfernen',
    },
    allTypes: 'Alle Typen',
    prints: 'Drucke',
    ascending: 'Aufsteigend',
    ...
    sectionParts: {
      title: 'Teile',
      add: 'Teil hinzufügen',
      addTitle: 'Abschnittsteil hinzufügen',
      code: 'Teilcode',
      name: 'Bezeichnung',
      setParameters: 'Parameter festlegen',
      setParametersHelp: 'Das ist keine druckbare Datei — sie legt nur den Druckeinstellungs-Vertrag für dieses Teil fest.',
      replaceParameters: 'Parameter ersetzen',
      replaceParametersTitle: 'Teilparameter ersetzen',
      replaceParametersHelp: 'Laden Sie eine 3MF hoch, um den Druckeinstellungs-Vertrag dieses Teils zu ersetzen. Ordnerdateien werden gegen die neue Spezifikation geprüft.',
      replaceConfirm: 'Parameter ersetzen',
      replaceFailed: 'Parameter konnten nicht ersetzt werden: {{error}}',
      replaced: 'Teilparameter ersetzt',
      previewFailed: 'Parametertausch-Vorschau fehlgeschlagen: {{error}}',
      delete: 'Teil löschen',
      deleteConfirm: 'Teilvorlage {{code}} löschen? Ordner können diesen Code später weiterhin hinzufügen.',
      deleteConfirmInUse: 'Teilvorlage {{code}} löschen? {{count}} Ordnerinstanz(en) bleiben erhalten und nutzen diesen Code weiter.',
      empty: 'Dieser Abschnitt hat noch keine Teilvorlagen. Ordner können weiterhin Teile hinzufügen; dabei entsteht auch die Vorlage.',
      notPrintable: 'Abschnittsteile sind nicht druckbar — sie definieren nur den Einstellungsvertrag.',
      followsSectionSpec: 'Dieser Ordner muss dem Druckeinstellungs-Vertrag des Abschnitts folgen.',
      seedFailed: 'Parameter konnten nicht gesetzt werden: {{error}}',
      created: 'Teilvorlage erstellt',
      deleted: 'Teilvorlage gelöscht',
      manage: 'Teile verwalten',
      seeded: 'Teilparameter gespeichert',
      addFailed: 'Teil konnte nicht erstellt werden: {{error}}',
      deleteFailed: 'Teil konnte nicht gelöscht werden: {{error}}',
      catalog: 'Abschnittsteile',
      orCreate: 'Oder ein neues Teil anlegen',
      arrangeHint: 'Ziehen zum Umsortieren. TOP zuerst, BOT daneben — in beliebiger Reihenfolge.',
      dragHandle: 'Neu anordnen',
      reorderFailed: 'Teilreihenfolge konnte nicht gespeichert werden: {{error}}',
    },
    production: {
      title: 'Produktionsdateien',
      subtitle: '{{printer}}-Produktionsslots',
      addFile: 'Produktionsdatei hinzufügen',
      replace: 'Ersetzen',
      delete: 'Löschen',
      proceedAnyway: 'Trotzdem fortfahren',
      acceptBaseline: 'Als neue Basis akzeptieren',
      cancel: 'Abbrechen',
      reason: 'Begründung',
      reasonPlaceholder: 'Warum ändert sich die Basis?',
      parameterNote: 'Hinweis',
      parameterNotePlaceholder: 'Warum weicht dieser Parameter ab?',
      notesRequired: 'Erklären Sie jeden abweichenden Parameter, bevor Sie fortfahren.',
      mismatchNote: 'Abweichungshinweis',
      newSlotConfirm: 'Dadurch wird ein neuer Produktionsslot erstellt, keine vorhandene Datei ersetzt.',
      parseFailed: 'Dateiname konnte nicht gelesen werden. Bitte Felder unten ausfüllen.',
      versionNotNewer: 'Eingehende Version {{incoming}} ist nicht neuer als {{current}}.',
      matchesSpec: 'Entspricht der Spezifikation',
      differsByDesign: 'Weicht per Design ab',
      lastReplaceMismatched: 'Letztes Ersetzen hatte Abweichungen',
      emptyFolder: 'Noch keine Produktionsdateien. Fügen Sie eine Datei hinzu, um den ersten Slot zu erstellen.',
      quantity: 'Stückzahl',
      version: 'Version',
      noActiveFile: 'Keine aktive Datei',
      uploadIntoProductionBlocked: 'Nutzen Sie Ersetzen oder Produktionsdatei hinzufügen statt des normalen Uploads.',
      moveIntoProductionBlocked: 'Von Production verwaltet',
      mismatchCount: '{{count}} Parameter weichen ab',
      parameter: 'Kennwert',
      lockedValue: 'Gesperrter Wert',
      incomingValue: 'Eingehender Wert',
      code: 'Teilcode',
      printer: 'Drucker',
      pickFile: 'Datei wählen',
      confirmCreate: 'Slot erstellen',
      currentVersion: 'Aktuelle Version',
      incomingVersion: 'Eingehende Version',
      printerMismatch: 'Dateidrucker {{file}} stimmt nicht mit diesem Ordner ({{folder}}) überein.',
      dropToAdd: 'Datei hier ablegen, um einen Produktionsslot hinzuzufügen',
      print: 'Drucken',
      loading: 'Produktionsdateien werden geladen...',
      slotCreated: 'Produktionsslot erstellt',
      slotReplaced: 'Produktionsdatei ersetzt',
      deleteConfirmTitle: 'Produktionsdatei löschen',
      deleteConfirm: '{{code}} x{{quantity}} {{version}} von {{printer}} löschen? Das kann nicht rückgängig gemacht werden.',
      deleteConfirmDetail:
        'Die Dateien werden in den Papierkorb des Dateimanagers verschoben und können von dort wiederhergestellt werden.',
      slotDeleted: 'Produktionsslot gelöscht',
      deleteFailed: 'Slot konnte nicht gelöscht werden: {{error}}',
      createFailed: 'Slot konnte nicht erstellt werden: {{error}}',
      replaceFailed: 'Datei konnte nicht ersetzt werden: {{error}}',
      previewFailed: 'Vorschau des Ersetzens fehlgeschlagen: {{error}}',
      slotExists: 'Ein Slot für dieses Teil und diese Stückzahl existiert bereits. Bitte Ersetzen verwenden.',
      newPartHint: 'Dadurch wird ein neues Teil ({{code}}) hinzugefügt.',
      newQuantityHint: '{{code}} hat bereits Slots. Es wird Stückzahl x{{quantity}} hinzugefügt.',
      sharedContractHint: 'Stückzahlvarianten von {{code}} an diesem Drucker teilen denselben Druckeinstellungs-Vertrag.',
      addPart: 'Teil hinzufügen',
      addPartTitle: 'Teil zu diesem Drucker hinzufügen',
      partName: 'Teilname',
      partCodeHint: 'Nur Großbuchstaben, 1–32 Zeichen (z. B. TOP oder LID).',
      confirmAddPart: 'Teil hinzufügen',
      partAdded: 'Teil hinzugefügt',
      addPartFailed: 'Teil konnte nicht hinzugefügt werden: {{error}}',
      removePart: 'Teil entfernen',
      removePartConfirmTitle: 'Teil entfernen',
      removePartConfirmEmpty: '{{code}} ({{name}}) von {{printer}} entfernen? Sie können es später wieder hinzufügen.',
      removePartConfirmWithFiles: '{{code}} ({{name}}) von {{printer}} entfernen? {{count}} Produktionsdatei(en) werden in den Papierkorb verschoben.',
      partRemoved: 'Teil entfernt',
      removePartFailed: 'Teil konnte nicht entfernt werden: {{error}}',
      addFileToPart: 'Datei hinzufügen',
      emptyPart: 'Noch keine Dateien für dieses Teil.',
      previewing: 'Wird mit der Spezifikation verglichen...',
      uploading: 'Wird hochgeladen...',
      suggestedVersion: 'Vorgeschlagene nächste Version: {{version}}',
      match: 'Übereinstimmung',
      mismatch: 'Abweichung',
      specs: {
        view: 'Spezifikationen anzeigen',
        title: 'Aktuelle Druckspezifikationen',
        layerHeight: 'Schichthöhe',
        initialLayerLineWidth: 'Linienbreite der ersten Schicht',
        infillDensity: 'Fülldichte',
        infillPattern: 'Füllmuster',
        wallLoops: 'Wände',
        brimType: 'Haftkrempe',
        brimWidth: 'Haftkrempe-Breite',
        brimObjectGap: 'Abstand Brim–Objekt',
        fuzzySkin: 'Fuzzy-Skin',
        fuzzySkinPainted: 'Bemalt',
        fuzzySkinAllowPaint: 'Farbe erlaubt',
        fuzzySkinThickness: 'Fuzzy-Skin-Dicke',
        fuzzySkinPointDistance: 'Fuzzy-Skin-Punktabstand',
        enableSupport: 'Stützen',
        supportType: 'Stützentyp',
        supportStyle: 'Stützenstil',
        supportTreeAuto: 'Baum automatisch',
        supportTreeManual: 'Baum manuell',
        supportNormalAuto: 'Normal automatisch',
        supportNormalManual: 'Normal manuell',
        supportStyleSlim: 'Schlanker Baum',
        supportStyleHybrid: 'Hybridstil',
        supportStyleStrong: 'Starker Baum',
        supportStyleOrganic: 'Organisch',
        supportStyleDefault: 'Vorgabe',
        supportStyleSnug: 'Anliegend',
        supportStyleGrid: 'Gitter',
        enablePrimeTower: 'Spülturm',
        seamPosition: 'Naht',
        nozzlesUsed: 'Düsen',
        bed: 'Bett',
        bedTypeTexturedPei: 'Texturiertes PEI',
        bedTypeSmoothPei: 'Glattes PEI',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'SuperTack-Platte',
        bedTypeEngineering: 'Engineering Plate',
        bedTypeHighTemp: 'High Temp Plate',
        on: 'Ein',
        off: 'Aus',
        brimAuto: 'Automatischer Brim',
        brimNone: 'Kein Brim',
        brimOuter: 'Nur außen',
        brimInner: 'Nur innen',
        brimBoth: 'Außen und innen',
        nozzlesLeft: 'Links',
        nozzlesRight: 'Rechts',
        nozzlesBoth: 'Beide',
        infillPatterns: {
          ...
          monotonic: 'Monotonisch',
          monotonicLine: 'Monotonische Linie',
          alignedRectilinear: 'Geradlinig ausgerichtet',
          hilbertCurve: 'Hilbert-Kurve',
          archimedeanChords: 'Archimedische Akkorde',
          octagramSpiral: 'Oktagramm-Spirale',
        },
        valueMm: '{{value}}\u00a0mm',
        valuePercent: '{{value}} %',
        summaryInfill: '{{value}} % Füllung',
        summarySupports: 'Stützen: {{detail}}',
        summaryBrimGap: '{{value}}\u00a0mm Abstand',
        summaryBed: 'Bett: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: 'Material anklicken, um AMS-Steckplatz zu wählen',
    chooseMaterialSlot: 'Extruder/Farbe für Material {{n}} wählen',
    mustMapMaterials: 'Materialien müssen ausgewählt/zugeordnet werden',
    unmappedSlot: '—',
    emptySlot: 'Leer',
    noAmsSlots: 'Dieser Drucker meldet keine AMS- oder externe Spulen.',
    useAutoMatch: 'Autom. Zuordnung verwenden',
    reRead: 'Neu einlesen',
    plateN: 'Platte {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Kapazitätskonfiguration',
    applyWeekdayDefaults: 'Mo–Fr 8:00–17:00 übernehmen',
    timezone: 'Zeitzone',
    capacityConfigDescription: 'Wöchentliche Druckerzeiten, Produktionslinienstart, Bett-Räumzeit und Geräte-Rezept (Teilmodelle). Für Stats-2-Kapazität und Planung.',
    lineStart: 'Linienstart (HH:MM)',
    preLineBuffer: 'Vorlaufpuffer (Min.)',
    expectedClear: 'Erwartete Bett-Räumzeit (Min.)',
    weeklyHours: 'Wöchentliche Betriebszeiten',
    weeklyHoursHint: 'Schichten vorerst per API bearbeiten; voller Raster-Editor kommt mit der Stats-2-Seite.',
    unstaffed: 'Nicht besetzt',
    saveGlobals: 'Linienstart & Räumzeit speichern',
    configSaved: 'Gespeichert — Kapazität wird aktualisiert',
    unsavedChanges: 'Ungespeicherte Änderungen',
    deviceRecipe: 'Geräte-Rezept (Teilmodelle)',
    printerTimeBlocks: 'Drucker-Zeitblöcke (muss frei sein)',
    printerTimeBlocksHint:
      'Wöchentlich wiederkehrende Fenster, in denen ein Drucker frei bleiben muss. Der Wochenplan legt keinen Druck, der diese Blöcke überschneidet (inkl. Räumzeit).',
    noPrintersForBlocks: 'Keine aktiven Drucker zum Konfigurieren.',
    blockPrinter: 'Drucker',
    noBlocksYet: 'Keine reservierten Fenster für diesen Drucker.',
    blockLabel: 'Bezeichnung (optional)',
    addTimeBlock: 'Zeitblock hinzufügen',
    saveTimeBlocks: 'Drucker-Zeitblöcke speichern',
    invalidBlockRange: '{{day}}: Blockbeginn muss vor dem Ende liegen ({{start}} → {{end}})',
    discoveredCount: '{{count}} gefundene Datei(en)',
    pageTitle: 'Stats 2 — Echte Kapazität',
    deviceCapacity: 'Gerätekapazität',
    todaysReadiness: 'Bereitschaft heute',
    printSchedule: 'Druckplan diese Woche',
    buildPlan: 'Bauplan',
    buildPlanHint: 'Jede Zeile listet die Plattendatei(en), die der Wochenplan für dieses Teil startet. Platten und Teile sind ganze Starts am gewählten Tag — dieselben Balken wie in der Zeitachse darüber.',
    targetDevicesDay: 'Ziel-Geräte / Tag',
    whatIf: 'Was-wäre-wenn',
    capacityMaxHint: 'Max. ~{{n}}/Tag',
    targetNotFeasible: 'Ziel über Druckkapazität',
    targetNotFeasibleBody: 'Angefragt {{target}}/Tag; Plan kann etwa {{achievable}}/Tag freimachen.',
    bindingPartSuffix: 'Engpassteil: {{binding}}.',
    scenarioAtTarget: 'Was-wäre-wenn für {{n}} Geräte/Tag — Platten / Teile sind ganze Starts von {{day}} oben.',
    scenarioAtCapacity: 'Platten / Teile sind ganze Starts von {{day}} oben (realistische Kapazität). Ziel eingeben für Was-wäre-wenn.',
    dedicatedFleetHint: 'Dedicated-Fleet-Schätzung ~{{n}}/Tag ignoriert geteilte Drucker (dieselben Maschinen für jedes Teil). Schedulable entspricht der Wochen-Zeitachse.',
    cleanupFeedback: 'Aufräumen: Soll vs Ist',
    productionYield: 'Produktionsausbeute',
    leadTimes: 'Lead Times am Floor',
    qualityReasons: 'Qualität & Verlustgründe',
    printerReliability: 'Druckerzuverlässigkeit',
    filamentPerDevice: 'Filament pro Gerät',
    configuration: 'Konfiguration',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — mindestens {{extra}} weitere {{models}}-Drucker nötig',
    shortPartsHeading: 'Fehlende Teile (gleicher Schichtplan):',
    shortPartUnknownModels: 'geeignet',
    shortPartsSharedNote:
      'Zusätzliche Drucker sind Untergrenzen je Teil (gleicher Schichtplan). Geteilte Modelle zählen in der Praxis nur einmal — Zahlen nicht addieren.',
    hypotheticalFleetNote:
      'Zeitachse enthält +{{n}} hypothetische Drucker ({{detail}}) für diese Anfrage — gestrichelte Spuren.',
