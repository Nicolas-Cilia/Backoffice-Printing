export default {
  ...
  printers: {
    ...
    startPrintOn: 'Lancer l\'impression sur {{name}}',
    yourFiles: 'Vos fichiers',
    printableTypesHint: 'Formats pris en charge : .gcode, .gcode.3mf',
    uploadToPrintHint: 'Déposez un fichier imprimable ici, ou choisissez-en un dans Vos fichiers — les options d\'impression s\'ouvrent dans ce panneau.',
    pickFromLibraryHint: 'Choisissez un fichier imprimable dans Vos fichiers — les options d\'impression s\'ouvrent dans ce panneau.',
    saveToYourFiles: 'Enregistrer dans vos fichiers',
    saveToYourFilesHint: 'Désactivé par défaut — le téléversement ne sert qu\'à cette impression et n\'est pas conservé dans Non classés.',
    saveLocation: 'Emplacement d\'enregistrement',
    changeFile: 'Changer de fichier',
    printOptionsAdvanced: 'Options avancées',
  ...
  maintenance: {
    ...
    printerLog: 'Journal imprimante',
    logCustomJob: 'Enregistrer une intervention personnalisée',
    logReset: 'Enregistrer et réinitialiser',
    logResetTitle: 'Réinitialiser {{name}} ?',
    logResetMessage: 'Cela réinitialise l\'intervalle et l\'ajoute au journal de l\'imprimante. Laissez une note seulement s\'il s\'est passé quelque chose.',
    jobName: 'Intervention',
    jobNamePlaceholder: 'ex. Remplacer la buse',
    notes: 'Notes',
    notesPlaceholder: 'Qu\'avez-vous fait ?',
    resetNotesPlaceholder: 'Notes optionnelles…',
    partLink: 'Lien de pièce (optionnel)',
    cost: 'Coût (optionnel)',
    saveLog: 'Enregistrer dans le journal',
    editLog: 'Modifier le journal',
    editLogTitle: 'Modifier le journal',
    logUpdated: 'Entrée de journal mise à jour',
    deleteLog: 'Supprimer le journal',
    deleteLogTitle: 'Supprimer l\'entrée du journal ?',
    deleteLogMessage: 'Retirer "{{name}}" du journal de l\'imprimante ? Cela n\'annule pas une réinitialisation planifiée — seule la ligne du journal et son coût sont supprimés.',
    logDeleted: 'Entrée de journal supprimée',
    hideTask: 'Masquer',
    showTask: 'Afficher',
    hiddenTasks: 'Tâches masquées',
    hiddenTasksDescription: 'Les tâches par défaut masquées restent enregistrées. Affichez-en une pour la ramener sans tout restaurer.',
    hideTaskTitle: 'Masquer {{name}} ?',
    hideTaskMessage: 'Elle quittera l\'onglet Statut. Vous pourrez la réafficher depuis Tâches masquées — sans la recréer ni restaurer toutes les tâches par défaut.',
    taskHidden: 'Tâche masquée',
    taskShown: 'Tâche réaffichée',
    totalMaintenanceCost: 'Coût de maintenance',
    jobLogged: 'Intervention enregistrée dans le journal',
    customJob: 'Intervention personnalisée',
  ...
  settings: {
    ...
    manageLibraryDescription: 'Téléverser, renommer et supprimer des fichiers de la bibliothèque',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        downloadFailed: 'Impossible de télécharger le preset',
      },
      partSections: {
        title: 'Sections de processus de pièce',
        addSection: 'Ajouter des sections de processus',
        sectionName: 'Nom de la section',
        trackParameters: 'Suivre les paramètres',
        trackParametersHelp: 'Activé, les processus partagent un contrat de réglages d’impression. Désactivez pour ignorer les contrôles d’écart.',
        namePlaceholder: 'Pièce supérieure',
        create: 'Créer',
        empty: 'Aucune section de processus de pièce. Créez-en une pour regrouper les processus par pièce.',
        addProcess: 'Ajouter un processus',
        uploadProcess: 'Importer un processus',
        uploadFailed: 'Impossible d\'importer le processus : {{error}}',
        confirmAttachTitle: 'Le processus ne correspond pas à la spécification',
        dontUpload: 'Ne pas importer',
        dontMove: 'Ne pas déplacer',
        moveToSection: 'Déplacer vers une section',
        pickSection: 'Choisir une section de processus de pièce',
        noSectionsToMove: 'Créez d’abord une section de processus de pièce',
        moveFailed: 'Impossible de déplacer le processus : {{error}}',
        replace: 'Remplacer',
        remove: 'Retirer',
        noProcesses: 'Aucun processus dans cette section',
        pickProcess: 'Choisir un profil de processus',
        noAvailable: 'Plus aucun profil de processus à ajouter',
        replaceTitle: 'Remplacer le processus',
        incomingProcess: 'Processus entrant',
        previewFailed: 'Impossible de prévisualiser le remplacement : {{error}}',
        replaceFailed: 'Impossible de remplacer le processus : {{error}}',
        createFailed: 'Impossible de créer la section : {{error}}',
        addFailed: 'Impossible d\'ajouter le processus : {{error}}',
        removeFailed: 'Impossible de retirer l\'emplacement : {{error}}',
        deleteSection: 'Supprimer la section',
        deleteSectionConfirm: 'Supprimer cette section de pièce et ses emplacements d\'imprimante ?',
        unknownPrinter: 'Inconnu',
        toast: {
          created: 'Section de pièce créée',
          deleted: 'Section de pièce supprimée',
          processAdded: 'Processus ajouté',
          uploaded: 'Processus importé',
          replaced: 'Processus remplacé',
          slotRemoved: 'Processus retiré',
        },
      },
    },
    connectedAs: 'Connecté en tant que',
    signInExpiredTitle: 'Session Bambu Cloud expirée',
    signInExpiredBody: 'Bambu Lab n\'accepte plus le jeton enregistré. Reconnectez-vous pour rétablir les profils cloud et la vérification des firmwares.',
    logout: 'Déconnexion',
  ...
  fileManager: {
    ...
    chooseFolderTitle: 'Choisissez un dossier à parcourir',
    chooseFolderDescription: 'Sélectionnez un dossier pour afficher son contenu.',
    addSection: 'Ajouter une section',
    newSection: 'Nouvelle section',
    sectionName: 'Nom de la section',
    sectionNamePlaceholder: 'ex. Production',
    ungrouped: 'Non groupés',
    unfiled: 'Non classés',
    emptySection: 'Aucun dossier dans cette section pour le moment.',
    moveToSection: 'Déplacer vers la section',
    noSection: 'Aucune section',
    renameSection: 'Renommer la section',
    deleteSection: 'Supprimer la section',
    deleteSectionConfirm: 'Supprimer cette section ? Les dossiers qu’elle contient resteront et ne seront plus groupés.',
    sectionCreated: 'Section créée',
    sectionRenamed: 'Section renommée',
    sectionDeleted: 'Section supprimée',
    folderMovedToSection: 'Dossier déplacé',
    folderSection: 'Section de dossiers',
    trackPrintSettings: 'Suivre les paramètres d’impression (remplacement uniquement)',
    trackPrintSettingsHelp: 'Ce dossier utilise les emplacements de production. Utilisez Remplacer plutôt que le téléversement générique.',
    trackPrintSettingsForcedHelp: 'Cette section impose le suivi. Les dossiers commencent vides — ajoutez des pièces, puis Ajouter un fichier de production / Remplacer.',
    trackPrintSettingsSectionHelp: 'Tous les dossiers de cette section utilisent les emplacements de production. Les nouveaux dossiers ne peuvent pas désactiver le suivi.',
    parameterTracking: 'Suivi des paramètres',
    parameterTrackingChip: 'Restreint',
    printerModel: 'Modèle d’imprimante',
    printerModelPlaceholder: 'Sélectionner une imprimante',
    printerModelHelp: 'Ce dossier utilise les emplacements de production pour l’imprimante sélectionnée.',
    printerModelCustom: 'Code personnalisé',
    printerModelCustomPlaceholder: 'ex. P1S',
    addFolderToSection: 'Ajouter un dossier',
    ...
    tags: {
      ...
      fileTitle: 'Étiquettes de ce fichier',
      fileTooltip: 'Ajouter ou retirer des étiquettes sur ce fichier',
      applySave: 'Enregistrer les étiquettes',
      applySaveSuccess: 'Étiquettes de ce fichier mises à jour.',
      addToFileAria: 'Ajouter des étiquettes à ce fichier',
      removeFromFileAria: 'Retirer l\'étiquette {{name}} de ce fichier',
    },
    allTypes: 'Tous types',
    prints: 'Impressions',
    ascending: 'Croissant',
    ...
    sectionParts: {
      ...
      addTitle: 'Ajouter une pièce de section',
      code: 'Code de pièce',
      name: 'Libellé',
      setParameters: 'Définir les paramètres',
      setParametersHelp: 'Ce n’est pas un fichier imprimable — il définit uniquement le contrat de réglages d’impression de cette pièce.',
      replaceParameters: 'Remplacer les paramètres',
      replaceParametersTitle: 'Remplacer les paramètres de la pièce',
      replaceParametersHelp: 'Importez un 3MF pour remplacer le contrat de réglages de cette pièce. Les fichiers des dossiers sont revérifiés par rapport à la nouvelle spécification.',
      replaceConfirm: 'Remplacer les paramètres',
      replaceFailed: 'Impossible de remplacer les paramètres : {{error}}',
      replaced: 'Paramètres de la pièce remplacés',
      previewFailed: 'Impossible de prévisualiser le remplacement des paramètres : {{error}}',
      delete: 'Supprimer la pièce',
      deleteConfirm: 'Supprimer le modèle de pièce {{code}} ? Les dossiers pourront encore ajouter ce code plus tard.',
      deleteConfirmInUse: 'Supprimer le modèle de pièce {{code}} ? {{count}} instance(s) de dossier resteront et continueront d’utiliser ce code.',
      empty: 'Cette section n’a pas encore de modèles de pièces. Les dossiers peuvent tout de même en ajouter, ce qui crée aussi le modèle.',
      notPrintable: 'Les pièces de section ne sont pas imprimables — elles définissent seulement le contrat de réglages.',
      followsSectionSpec: 'Ce dossier doit respecter le contrat de réglages d’impression de la section.',
      seedFailed: 'Impossible de définir les paramètres : {{error}}',
      created: 'Modèle de pièce créé',
      deleted: 'Modèle de pièce supprimé',
      manage: 'Gérer les pièces',
      seeded: 'Paramètres de la pièce enregistrés',
      addFailed: 'Impossible de créer la pièce : {{error}}',
      deleteFailed: 'Impossible de supprimer la pièce : {{error}}',
      catalog: 'Pièces de la section',
      orCreate: 'Ou créer une nouvelle pièce',
      arrangeHint: 'Glissez pour réordonner. TOP en premier, BOT à côté — dans l’ordre que vous voulez.',
      dragHandle: 'Réordonner',
      reorderFailed: 'Impossible d’enregistrer l’ordre des pièces : {{error}}',
    },
    production: {
      title: 'Fichiers de production',
      subtitle: 'Emplacements de production {{printer}}',
      addFile: 'Ajouter un fichier de production',
      replace: 'Remplacer',
      delete: 'Supprimer',
      proceedAnyway: 'Continuer quand même',
      acceptBaseline: 'Accepter comme nouvelle base',
      cancel: 'Annuler',
      reason: 'Motif',
      reasonPlaceholder: 'Pourquoi la base change-t-elle ?',
      parameterNote: 'Remarque',
      parameterNotePlaceholder: 'Pourquoi ce paramètre diffère-t-il ?',
      notesRequired: 'Expliquez chaque paramètre en écart avant de continuer.',
      mismatchNote: 'Justification de l’écart',
      newSlotConfirm: 'Cela créera un nouvel emplacement de production, sans remplacer un fichier existant.',
      parseFailed: 'Impossible d’analyser le nom de fichier. Remplissez les champs ci-dessous.',
      versionNotNewer: 'La version entrante {{incoming}} n’est pas plus récente que {{current}}.',
      matchesSpec: 'Conforme à la spécification',
      differsByDesign: 'Diffère par conception',
      lastReplaceMismatched: 'Le dernier remplacement avait des écarts',
      emptyFolder: 'Pas encore de fichiers de production. Ajoutez-en un pour créer le premier emplacement.',
      quantity: 'Quantité',
      version: 'Version',
      noActiveFile: 'Aucun fichier actif',
      uploadIntoProductionBlocked: 'Utilisez Remplacer ou Ajouter un fichier de production plutôt que l’envoi générique.',
      moveIntoProductionBlocked: 'Géré par Production',
      mismatchCount: '{{count}} paramètre(s) différent(s)',
      parameter: 'Paramètre',
      lockedValue: 'Valeur verrouillée',
      incomingValue: 'Valeur entrante',
      code: 'Code de pièce',
      printer: 'Imprimante',
      pickFile: 'Choisir un fichier',
      confirmCreate: 'Créer l’emplacement',
      currentVersion: 'Version actuelle',
      incomingVersion: 'Version entrante',
      printerMismatch: 'L’imprimante du fichier {{file}} ne correspond pas à ce dossier ({{folder}}).',
      dropToAdd: 'Déposez un fichier ici pour ajouter un emplacement de production',
      print: 'Imprimer',
      loading: 'Chargement des fichiers de production...',
      slotCreated: 'Emplacement de production créé',
      slotReplaced: 'Fichier de production remplacé',
      deleteConfirmTitle: 'Supprimer le fichier de production',
      deleteConfirm: 'Supprimer {{code}} x{{quantity}} {{version}} de {{printer}} ? Cette action est irréversible.',
      deleteConfirmDetail:
        'Les fichiers seront déplacés vers la corbeille du gestionnaire de fichiers, d’où ils pourront être restaurés si besoin.',
      slotDeleted: 'Emplacement de production supprimé',
      deleteFailed: 'Impossible de supprimer l’emplacement : {{error}}',
      createFailed: 'Impossible de créer l’emplacement : {{error}}',
      replaceFailed: 'Impossible de remplacer le fichier : {{error}}',
      previewFailed: 'Impossible de prévisualiser le remplacement : {{error}}',
      slotExists: 'Un emplacement existe déjà pour cette pièce et cette quantité. Utilisez Remplacer.',
      newPartHint: 'Cela ajoutera une nouvelle pièce ({{code}}).',
      newQuantityHint: '{{code}} a déjà des emplacements. La quantité x{{quantity}} sera ajoutée.',
      sharedContractHint: 'Les variantes de quantité de {{code}} sur cette imprimante partagent le même contrat de paramètres d’impression.',
      addPart: 'Ajouter une pièce',
      addPartTitle: 'Ajouter une pièce à cette imprimante',
      partName: 'Nom de la pièce',
      partCodeHint: 'Lettres majuscules uniquement, 1–32 caractères (par exemple TOP ou LID).',
      confirmAddPart: 'Ajouter la pièce',
      partAdded: 'Pièce ajoutée',
      addPartFailed: 'Impossible d’ajouter la pièce : {{error}}',
      removePart: 'Retirer la pièce',
      removePartConfirmTitle: 'Retirer la pièce',
      removePartConfirmEmpty: 'Retirer {{code}} ({{name}}) de {{printer}} ? Vous pourrez la rajouter plus tard.',
      removePartConfirmWithFiles: 'Retirer {{code}} ({{name}}) de {{printer}} ? {{count}} fichier(s) de production seront déplacés vers la corbeille.',
      partRemoved: 'Pièce retirée',
      removePartFailed: 'Impossible de retirer la pièce : {{error}}',
      addFileToPart: 'Ajouter un fichier',
      emptyPart: 'Aucun fichier pour cette pièce pour le moment.',
      previewing: 'Comparaison avec la spécification...',
      uploading: 'Envoi en cours...',
      suggestedVersion: 'Prochaine version suggérée : {{version}}',
      match: 'Correspondance',
      mismatch: 'Écart',
      specs: {
        view: 'Voir les spécifications',
        title: 'Spécifications d’impression actuelles',
        layerHeight: 'Hauteur de couche',
        initialLayerLineWidth: 'Largeur de ligne de la première couche',
        infillDensity: 'Densité de remplissage',
        infillPattern: 'Motif de remplissage',
        wallLoops: 'Parois',
        brimType: 'Bordure',
        brimWidth: 'Largeur de bordure',
        brimObjectGap: 'Écart bordure–objet',
        fuzzySkin: 'Peau floue',
        fuzzySkinPainted: 'Peint',
        fuzzySkinAllowPaint: 'Peinture autorisée',
        fuzzySkinThickness: 'Épaisseur de la peau floue',
        fuzzySkinPointDistance: 'Distance des points de peau floue',
        enableSupport: 'Supports d’impression',
        supportType: 'Type de support',
        supportStyle: 'Style de support',
        supportTreeAuto: 'Arborescent auto',
        supportTreeManual: 'Arborescent manuel',
        supportNormalAuto: 'Normal automatique',
        supportNormalManual: 'Normal manuel',
        supportStyleSlim: 'Arbre fin',
        supportStyleHybrid: 'Hybride',
        supportStyleStrong: 'Arbre fort',
        supportStyleOrganic: 'Organique',
        supportStyleDefault: 'Par défaut',
        supportStyleSnug: 'Ajusté',
        supportStyleGrid: 'Grille',
        enablePrimeTower: 'Tour de purge',
        seamPosition: 'Joint',
        nozzlesUsed: 'Buses',
        bed: 'Plateau',
        bedTypeTexturedPei: 'PEI texturé',
        bedTypeSmoothPei: 'PEI lisse',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'Plaque SuperTack',
        bedTypeEngineering: 'Engineering Plate',
        bedTypeHighTemp: 'High Temp Plate',
        on: 'Activé',
        off: 'Désactivé',
        brimAuto: 'Bordure automatique',
        brimNone: 'Sans bordure',
        brimOuter: 'Extérieur uniquement',
        brimInner: 'Intérieur uniquement',
        brimBoth: 'Extérieur et intérieur',
        nozzlesLeft: 'Gauche',
        nozzlesRight: 'Droite',
        nozzlesBoth: 'Les deux',
        infillPatterns: {
          concentric: 'Concentrique',
          rectilinear: 'Rectiligne',
          monotonic: 'Monotone',
          monotonicLine: 'Ligne monotone',
          alignedRectilinear: 'Rectiligne aligné',
          hilbertCurve: 'Courbe de Hilbert',
          archimedeanChords: 'Spirale d’Archimède',
          octagramSpiral: 'Spirale octagramme',
        },
        valueMm: '{{value}}\u00a0mm',
        valuePercent: '{{value}} %',
        summaryInfill: '{{value}} % de remplissage',
        summarySupports: 'Supports d’impression : {{detail}}',
        summaryBrimGap: '{{value}}\u00a0mm d’écart',
        summaryBed: 'Plateau : {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: 'Cliquez sur un matériau pour choisir le slot AMS',
    chooseMaterialSlot: 'Choisissez l\'extrudeuse/couleur pour le matériau {{n}}',
    mustMapMaterials: 'Vous devez sélectionner/mapper les matériaux',
    unmappedSlot: '—',
    emptySlot: 'Vide',
    noAmsSlots: 'Aucune bobine AMS ou externe signalée par cette imprimante.',
    useAutoMatch: 'Utiliser la correspondance auto',
    reRead: 'Relire',
    plateN: 'Plateau {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Config capacité',
    applyWeekdayDefaults: 'Appliquer lun–ven 8h00–17h00',
    timezone: 'Fuseau horaire',
    capacityConfigDescription: 'Horaires imprimantes, démarrage de ligne, dépose plateau et nomenclature (modèles de pièces) pour Stats 2.',
    lineStart: 'Démarrage ligne (HH:MM)',
    preLineBuffer: 'Buffer avant ligne (min)',
    expectedClear: 'Dépose plateau attendue (min)',
    weeklyHours: 'Horaires hebdomadaires',
    weeklyHoursHint: 'Modifier les postes via l’API pour l’instant ; éditeur complet avec Stats 2.',
    unstaffed: 'Sans opérateur',
    saveGlobals: 'Enregistrer démarrage & dépose',
    configSaved: 'Enregistré — la capacité va se rafraîchir',
    unsavedChanges: 'Modifications non enregistrées',
    deviceRecipe: 'Nomenclature (modèles de pièces)',
    printerTimeBlocks: 'Créneaux imprimante (doit être libre)',
    printerTimeBlocksHint:
      'Fenêtres hebdomadaires récurrentes pendant lesquelles une imprimante doit rester libre. Le planning ne placera pas d’impression qui chevauche ces créneaux (y compris le temps de déchargement).',
    noPrintersForBlocks: 'Aucune imprimante active à configurer.',
    blockPrinter: 'Imprimante',
    noBlocksYet: 'Aucune fenêtre réservée pour cette imprimante.',
    blockLabel: 'Libellé (optionnel)',
    addTimeBlock: 'Ajouter un créneau',
    saveTimeBlocks: 'Enregistrer les créneaux',
    invalidBlockRange: '{{day}} : le début du créneau doit précéder la fin ({{start}} → {{end}})',
    discoveredCount: '{{count}} fichier(s) découvert(s)',
    pageTitle: 'Stats 2 — Capacité réelle',
    deviceCapacity: 'Capacité appareils',
    todaysReadiness: 'Disponibilité du jour',
    printSchedule: 'Planning d’impression de la semaine',
    buildPlan: 'Plan de fabrication',
    buildPlanHint: 'Chaque ligne liste le(s) fichier(s) de plaque démarrés par le planning pour cette pièce. Plaques et pièces sont des démarrages entiers du jour sélectionné — les mêmes barres que la timeline ci-dessus.',
    targetDevicesDay: 'Appareils cibles / jour',
    whatIf: 'Et si',
    capacityMaxHint: 'Max ~{{n}}/jour',
    targetNotFeasible: 'Cible au-dessus de la capacité d’impression',
    targetNotFeasibleBody: 'Demandé {{target}}/jour ; le planning peut dégager environ {{achievable}}/jour.',
    bindingPartSuffix: 'Pièce limitante : {{binding}}.',
    scenarioAtTarget: 'Scénario pour {{n}} appareils/jour — plaques / pièces sont des démarrages entiers de {{day}} ci-dessus.',
    scenarioAtCapacity: 'Plaques / pièces sont des démarrages entiers de {{day}} ci-dessus (capacité réaliste). Saisir une cible pour un scénario.',
    dedicatedFleetHint: 'L’estim. flotte dédiée ~{{n}}/jour ignore les imprimantes partagées (mêmes machines comptées pour chaque pièce). Le chiffre planifiable correspond au planning hebdo.',
    cleanupFeedback: 'Nettoyage : cible vs réel',
    productionYield: 'Rendement de production',
    leadTimes: 'Délais atelier',
    qualityReasons: 'Qualité et causes de perte',
    printerReliability: 'Fiabilité des imprimantes',
    filamentPerDevice: 'Filament par appareil',
    configuration: 'Configuration',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — il faut au moins {{extra}} imprimante(s) {{models}} de plus',
    shortPartsHeading: 'Pièces manquantes (même planning opérateurs) :',
    shortPartUnknownModels: 'éligibles',
    shortPartsSharedNote:
      'Les imprimantes supplémentaires sont des planchers par pièce (même planning). Les modèles partagés ne comptent qu’une fois — ne pas additionner.',
    hypotheticalFleetNote:
      'La chronologie inclut +{{n}} imprimantes hypothétiques ({{detail}}) pour cette demande — voies en pointillés.',
    export: 'Exporter CSV',
  },
