export default {
  ...
  printers: {
    ...
    startPrintOn: 'Avvia stampa su {{name}}',
    yourFiles: 'I tuoi file',
    printableTypesHint: 'Supportati: .gcode, .gcode.3mf',
    uploadToPrintHint: 'Trascina qui un file stampabile, oppure scegline uno da I tuoi file — le opzioni di stampa si aprono in questo pannello.',
    pickFromLibraryHint: 'Scegli un file stampabile da I tuoi file — le opzioni di stampa si aprono in questo pannello.',
    saveToYourFiles: 'Salva nei tuoi file',
    saveToYourFilesHint: 'Disattivato di default — il caricamento serve solo a questa stampa e non resta in Non classificati.',
    saveLocation: 'Posizione di salvataggio',
    changeFile: 'Cambia file',
    printOptionsAdvanced: 'Opzioni avanzate',
    noPrinterSelected: 'Nessuna stampante selezionata',
  },
  ...
  maintenance: {
    ...
    printerLog: 'Registro stampante',
    logCustomJob: 'Registra intervento personalizzato',
    logReset: 'Registra e reimposta',
    logResetTitle: 'Reimpostare {{name}}?',
    logResetMessage: 'Questo reimposta l\'intervallo e lo aggiunge al registro della stampante. Lascia una nota solo se è successo qualcosa.',
    jobName: 'Intervento',
    jobNamePlaceholder: 'es. Sostituisci ugello',
    notes: 'Note',
    notesPlaceholder: 'Cosa hai fatto?',
    resetNotesPlaceholder: 'Note opzionali…',
    partLink: 'Link del ricambio (opzionale)',
    cost: 'Costo (opzionale)',
    saveLog: 'Salva nel registro',
    editLog: 'Modifica registro',
    editLogTitle: 'Modifica registro',
    logUpdated: 'Voce di registro aggiornata',
    deleteLog: 'Elimina registro',
    deleteLogTitle: 'Eliminare la voce di registro?',
    deleteLogMessage: 'Rimuovere "{{name}}" dal registro della stampante? Questo non annulla un reset programmato — elimina solo la riga del registro e il relativo costo.',
    logDeleted: 'Voce di registro eliminata',
    hideTask: 'Nascondi',
    showTask: 'Mostra',
    hiddenTasks: 'Attività nascoste',
    hiddenTasksDescription: 'Le attività predefinite nascoste restano salvate. Mostrane una per ripristinarla senza ripristinare tutto.',
    hideTaskTitle: 'Nascondere {{name}}?',
    hideTaskMessage: 'Uscirà dalla scheda Stato. Potrai mostrarla di nuovo da Attività nascoste, senza ricrearla né ripristinare tutte le predefinite.',
    taskHidden: 'Attività nascosta',
    taskShown: 'Attività mostrata di nuovo',
    totalMaintenanceCost: 'Costo manutenzione',
    jobLogged: 'Intervento salvato nel registro stampante',
    customJob: 'Intervento personalizzato',
  ...
  settings: {
    ...
    manageLibraryDescription: 'Carica, rinomina ed elimina file della libreria',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      filament: 'Filamento',
      process: 'Processi non assegnati',
      printer: 'Stampante',
      toast: {
        ...
        downloadFailed: 'Impossibile scaricare il preset',
      },
      partSections: {
        title: 'Sezioni processo pezzo',
        addSection: 'Aggiungi sezioni processo',
        sectionName: 'Nome sezione',
        trackParameters: 'Traccia parametri',
        trackParametersHelp: 'Se attivo, i processi condividono un contratto di impostazioni di stampa. Disattiva per saltare i controlli di discrepanza.',
        namePlaceholder: 'Pezzo superiore',
        create: 'Crea',
        empty: 'Nessuna sezione processo pezzo. Creane una per raggruppare i processi per pezzo.',
        addProcess: 'Aggiungi processo',
        uploadProcess: 'Carica processo',
        uploadFailed: 'Impossibile caricare il processo: {{error}}',
        confirmAttachTitle: 'Il processo non corrisponde alle specifiche',
        dontUpload: 'Non caricare',
        dontMove: 'Non spostare',
        moveToSection: 'Sposta nella sezione',
        pickSection: 'Scegli una sezione processo del pezzo',
        noSectionsToMove: 'Crea prima una sezione processo del pezzo',
        moveFailed: 'Impossibile spostare il processo: {{error}}',
        replace: 'Sostituisci',
        remove: 'Rimuovi',
        noProcesses: 'Nessun processo in questa sezione',
        pickProcess: 'Scegli un preset di processo',
        noAvailable: 'Nessun preset di processo rimasto da aggiungere',
        replaceTitle: 'Sostituisci processo',
        incomingProcess: 'Processo in arrivo',
        previewFailed: 'Impossibile anteprima della sostituzione: {{error}}',
        replaceFailed: 'Impossibile sostituire il processo: {{error}}',
        createFailed: 'Impossibile creare la sezione: {{error}}',
        addFailed: 'Impossibile aggiungere il processo: {{error}}',
        removeFailed: 'Impossibile rimuovere lo slot: {{error}}',
        deleteSection: 'Elimina sezione',
        deleteSectionConfirm: 'Eliminare questa sezione pezzo e i relativi slot stampante?',
        unknownPrinter: 'Sconosciuta',
        toast: {
          created: 'Sezione pezzo creata',
          deleted: 'Sezione pezzo eliminata',
          processAdded: 'Processo aggiunto',
          uploaded: 'Processo caricato',
          replaced: 'Processo sostituito',
          slotRemoved: 'Processo rimosso',
        },
      },
    },
    connectedAs: 'Connesso come',
    signInExpiredTitle: 'Accesso a Bambu Cloud scaduto',
    signInExpiredBody: 'Bambu Lab non accetta più il token salvato. Accedi di nuovo per ripristinare i profili cloud e i controlli del firmware.',
    logout: 'Esci',
    noLogoutPermission: 'Non hai il permesso di disconnetterti',
  ...
  fileManager: {
    ...
    allExternal: 'Esterni',
    backToFolders: 'Torna alle cartelle',
    chooseFolderTitle: 'Scegli una cartella da sfogliare',
    chooseFolderDescription: 'Seleziona una cartella per visualizzarne il contenuto.',
    addSection: 'Aggiungi sezione',
    newSection: 'Nuova sezione',
    sectionName: 'Nome della sezione',
    sectionNamePlaceholder: 'es. Produzione',
    ungrouped: 'Non raggruppate',
    unfiled: 'Senza cartella',
    emptySection: 'Nessuna cartella in questa sezione.',
    moveToSection: 'Sposta nella sezione',
    noSection: 'Nessuna sezione',
    renameSection: 'Rinomina sezione',
    deleteSection: 'Elimina sezione',
    deleteSectionConfirm: 'Eliminare questa sezione? Le cartelle al suo interno resteranno e non saranno più raggruppate.',
    sectionCreated: 'Sezione creata',
    sectionRenamed: 'Sezione rinominata',
    sectionDeleted: 'Sezione eliminata',
    folderMovedToSection: 'Cartella spostata',
    folderSection: 'Sezione',
    trackPrintSettings: 'Traccia impostazioni di stampa (solo sostituzione)',
    trackPrintSettingsHelp: 'Questa cartella usa gli slot di produzione. Usa Sostituisci invece del caricamento generico.',
    trackPrintSettingsForcedHelp: 'Questa sezione richiede il tracciamento. Le cartelle partono vuote: aggiungi parti, poi Aggiungi file di produzione / Sostituisci.',
    trackPrintSettingsSectionHelp: 'Tutte le cartelle in questa sezione usano gli slot di produzione. Le nuove cartelle non possono disattivare il tracciamento.',
    parameterTracking: 'Tracciamento parametri',
    parameterTrackingChip: 'Limitato',
    printerModel: 'Modello stampante',
    printerModelPlaceholder: 'Seleziona una stampante',
    printerModelHelp: 'Questa cartella usa gli slot di produzione per la stampante selezionata.',
    printerModelCustom: 'Codice personalizzato',
    printerModelCustomPlaceholder: 'es. P1S',
    addFolderToSection: 'Aggiungi cartella',
    ...
    tags: {
      ...
      fileTitle: 'Etichette su questo file',
      fileTooltip: 'Aggiungi o rimuovi etichette su questo file',
      applySave: 'Salva etichette',
      applySaveSuccess: 'Etichette del file aggiornate.',
      addToFileAria: 'Aggiungi etichette a questo file',
      removeFromFileAria: 'Rimuovi etichetta {{name}} da questo file',
    },
    ...
    sectionParts: {
      title: 'Parti',
      add: 'Aggiungi parte',
      addTitle: 'Aggiungi parte di sezione',
      code: 'Codice pezzo',
      name: 'Nome',
      setParameters: 'Imposta parametri',
      setParametersHelp: 'Questo non è un file stampabile: imposta solo il contratto di impostazioni di stampa per questa parte.',
      replaceParameters: 'Sostituisci parametri',
      replaceParametersTitle: 'Sostituisci parametri della parte',
      replaceParametersHelp: 'Carica un 3MF per sostituire il contratto di impostazioni di questa parte. I file nelle cartelle vengono ricontrollati rispetto alla nuova specifica.',
      replaceConfirm: 'Sostituisci parametri',
      replaceFailed: 'Impossibile sostituire i parametri: {{error}}',
      replaced: 'Parametri della parte sostituiti',
      previewFailed: 'Impossibile anteprima della sostituzione parametri: {{error}}',
      delete: 'Elimina parte',
      deleteConfirm: 'Eliminare il modello di parte {{code}}? Le cartelle potranno ancora aggiungere questo codice in seguito.',
      deleteConfirmInUse: 'Eliminare il modello di parte {{code}}? Resteranno {{count}} istanza/e di cartella che continueranno a usare questo codice.',
      empty: 'Questa sezione non ha ancora modelli di parte. Le cartelle possono comunque aggiungere parti, creando anche il modello.',
      notPrintable: 'Le parti di sezione non sono stampabili: definiscono solo il contratto di impostazioni.',
      followsSectionSpec: 'Questa cartella deve seguire il contratto di impostazioni di stampa della sezione.',
      seedFailed: 'Impossibile impostare i parametri: {{error}}',
      created: 'Modello di parte creato',
      deleted: 'Modello di parte eliminato',
      manage: 'Gestisci parti',
      seeded: 'Parametri della parte salvati',
      addFailed: 'Impossibile creare la parte: {{error}}',
      deleteFailed: 'Impossibile eliminare la parte: {{error}}',
      catalog: 'Parti della sezione',
      orCreate: 'Oppure crea una nuova parte',
      arrangeHint: 'Trascina per riordinare. TOP per primo, BOT accanto — nell’ordine che preferisci.',
      dragHandle: 'Riordina',
      reorderFailed: 'Impossibile salvare l’ordine delle parti: {{error}}',
    },
    production: {
      title: 'File di produzione',
      subtitle: 'Slot di produzione {{printer}}',
      addFile: 'Aggiungi file di produzione',
      replace: 'Sostituisci',
      delete: 'Elimina',
      proceedAnyway: 'Procedi comunque',
      acceptBaseline: 'Accetta come nuova base',
      cancel: 'Annulla',
      reason: 'Motivo',
      reasonPlaceholder: 'Perché cambia la base?',
      parameterNote: 'Nota',
      parameterNotePlaceholder: 'Perché questo parametro è diverso?',
      notesRequired: 'Spiega ogni parametro non corrispondente prima di procedere.',
      mismatchNote: 'Nota sulla differenza',
      newSlotConfirm: 'Questo creerà un nuovo slot di produzione, senza sostituire un file esistente.',
      parseFailed: 'Impossibile analizzare il nome file. Compila i campi sotto.',
      versionNotNewer: 'La versione in arrivo {{incoming}} non è più recente di {{current}}.',
      matchesSpec: 'Conforme alla specifica',
      differsByDesign: 'Differisce per progetto',
      lastReplaceMismatched: 'L’ultima sostituzione aveva discrepanze',
      emptyFolder: 'Nessun file di produzione. Aggiungine uno per creare il primo slot.',
      quantity: 'Quantità',
      version: 'Versione',
      noActiveFile: 'Nessun file attivo',
      uploadIntoProductionBlocked: 'Usa Sostituisci o Aggiungi file di produzione invece del caricamento generico.',
      moveIntoProductionBlocked: 'Gestito da Production',
      mismatchCount: '{{count}} parametro/i differiscono',
      parameter: 'Parametro',
      lockedValue: 'Valore bloccato',
      incomingValue: 'Valore in arrivo',
      code: 'Codice pezzo',
      printer: 'Stampante',
      pickFile: 'Scegli file',
      confirmCreate: 'Crea slot',
      currentVersion: 'Versione attuale',
      incomingVersion: 'Versione in arrivo',
      printerMismatch: 'La stampante del file {{file}} non corrisponde a questa cartella ({{folder}}).',
      dropToAdd: 'Trascina un file qui per aggiungere uno slot di produzione',
      print: 'Stampa',
      loading: 'Caricamento file di produzione...',
      slotCreated: 'Slot di produzione creato',
      slotReplaced: 'File di produzione sostituito',
      deleteConfirmTitle: 'Elimina file di produzione',
      deleteConfirm: 'Eliminare {{code}} x{{quantity}} {{version}} da {{printer}}? L’operazione non può essere annullata.',
      deleteConfirmDetail:
        'I file verranno spostati nel cestino del File Manager, da cui potranno essere ripristinati se necessario.',
      slotDeleted: 'Slot di produzione eliminato',
      deleteFailed: 'Impossibile eliminare lo slot: {{error}}',
      createFailed: 'Impossibile creare lo slot: {{error}}',
      replaceFailed: 'Impossibile sostituire il file: {{error}}',
      previewFailed: 'Impossibile anteprima della sostituzione: {{error}}',
      slotExists: 'Esiste già uno slot per questo pezzo e quantità. Usa Sostituisci.',
      newPartHint: 'Questo aggiungerà un nuovo pezzo ({{code}}).',
      newQuantityHint: '{{code}} ha già slot. Verrà aggiunta la quantità x{{quantity}}.',
      sharedContractHint: 'Le varianti di quantità di {{code}} su questa stampante condividono lo stesso contratto di impostazioni di stampa.',
      addPart: 'Aggiungi parte',
      addPartTitle: 'Aggiungi parte a questa stampante',
      partName: 'Nome della parte',
      partCodeHint: 'Solo lettere maiuscole, 1–32 caratteri (ad esempio TOP o LID).',
      confirmAddPart: 'Aggiungi parte',
      partAdded: 'Parte aggiunta',
      addPartFailed: 'Impossibile aggiungere la parte: {{error}}',
      removePart: 'Rimuovi parte',
      removePartConfirmTitle: 'Rimuovi parte',
      removePartConfirmEmpty: 'Rimuovere {{code}} ({{name}}) da {{printer}}? Potrai aggiungerla di nuovo in seguito.',
      removePartConfirmWithFiles: 'Rimuovere {{code}} ({{name}}) da {{printer}}? {{count}} file di produzione verranno spostati nel cestino.',
      partRemoved: 'Parte rimossa',
      removePartFailed: 'Impossibile rimuovere la parte: {{error}}',
      addFileToPart: 'Aggiungi file',
      emptyPart: 'Nessun file per questa parte al momento.',
      previewing: 'Confronto con la specifica...',
      uploading: 'Caricamento...',
      suggestedVersion: 'Prossima versione suggerita: {{version}}',
      match: 'Corrisponde',
      mismatch: 'Non corrisponde',
      specs: {
        view: 'Vedi specifiche',
        title: 'Specifiche di stampa attuali',
        layerHeight: 'Altezza strato',
        initialLayerLineWidth: 'Larghezza linea del primo strato',
        infillDensity: 'Densità di riempimento',
        infillPattern: 'Motivo di riempimento',
        wallLoops: 'Pareti',
        brimType: 'Bordatura',
        brimWidth: 'Larghezza del brim',
        brimObjectGap: 'Distanza brim–oggetto',
        fuzzySkin: 'Pelle sfocata',
        fuzzySkinPainted: 'Dipinto',
        fuzzySkinAllowPaint: 'Consente pittura',
        fuzzySkinThickness: 'Spessore della pelle sfocata',
        fuzzySkinPointDistance: 'Distanza punti della pelle sfocata',
        enableSupport: 'Supporti',
        supportType: 'Tipo di supporto',
        supportStyle: 'Stile del supporto',
        supportTreeAuto: 'Albero automatico',
        supportTreeManual: 'Albero manuale',
        supportNormalAuto: 'Normale automatico',
        supportNormalManual: 'Normale manuale',
        supportStyleSlim: 'Albero sottile',
        supportStyleHybrid: 'Ibrido',
        supportStyleStrong: 'Albero robusto',
        supportStyleOrganic: 'Organico',
        supportStyleDefault: 'Predefinito',
        supportStyleSnug: 'Aderente',
        supportStyleGrid: 'Griglia',
        enablePrimeTower: 'Torre di spurgo',
        seamPosition: 'Giunzione',
        nozzlesUsed: 'Ugelli',
        bed: 'Piano',
        bedTypeTexturedPei: 'PEI testurizzato',
        bedTypeSmoothPei: 'PEI liscio',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'Piastra SuperTack',
        bedTypeEngineering: 'Engineering Plate',
        bedTypeHighTemp: 'High Temp Plate',
        on: 'Attivo',
        off: 'Disattivo',
        brimAuto: 'Brim automatico',
        brimNone: 'Nessun brim',
        brimOuter: 'Solo esterno',
        brimInner: 'Solo interno',
        brimBoth: 'Esterno e interno',
        nozzlesLeft: 'Sinistro',
        nozzlesRight: 'Destro',
        nozzlesBoth: 'Entrambi',
        infillPatterns: {
          concentric: 'Concentrico',
          rectilinear: 'Rettilineo',
          monotonic: 'Monotonico',
          monotonicLine: 'Linea monotonica',
          alignedRectilinear: 'Rettilineo allineato',
          hilbertCurve: 'Curva di Hilbert',
          archimedeanChords: 'Corde di Archimede',
          octagramSpiral: 'Spirale a ottogramma',
        },
        valueMm: '{{value}}\u00a0mm',
        valuePercent: '{{value}}\u00a0%',
        summaryInfill: '{{value}}% di riempimento',
        summarySupports: 'Supporti: {{detail}}',
        summaryBrimGap: '{{value}}\u00a0mm di distacco',
        summaryBed: 'Piano: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: 'Clicca un materiale per scegliere lo slot AMS',
    chooseMaterialSlot: 'Scegli estrusore/colore per il Materiale {{n}}',
    mustMapMaterials: 'Devi selezionare/mappare i materiali',
    unmappedSlot: '—',
    emptySlot: 'Vuoto',
    noAmsSlots: 'Nessuna bobina AMS o esterna segnalata da questa stampante.',
    useAutoMatch: 'Usa abbinamento automatico',
    reRead: 'Rileggi',
    plateN: 'Piatto {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Config capacità',
    applyWeekdayDefaults: 'Applica lun–ven 8:00–17:00',
    timezone: 'Fuso orario',
    capacityConfigDescription: 'Ore stampanti, avvio linea, pulizia piano e ricetta dispositivo (modelli pezzo) per Stats 2.',
    lineStart: 'Avvio linea (HH:MM)',
    preLineBuffer: 'Buffer pre-linea (min)',
    expectedClear: 'Pulizia piano prevista (min)',
    weeklyHours: 'Ore settimanali con personale',
    weeklyHoursHint: 'Modifica turni via API per ora; editor completo con Stats 2.',
    unstaffed: 'Senza personale',
    saveGlobals: 'Salva avvio linea e pulizia',
    configSaved: 'Salvato — la capacità verrà aggiornata',
    unsavedChanges: 'Modifiche non salvate',
    deviceRecipe: 'Ricetta dispositivo (modelli pezzo)',
    printerTimeBlocks: 'Blocchi orari stampante (deve essere libera)',
    printerTimeBlocksHint:
      'Finestre settimanali ricorrenti in cui una stampante deve restare libera. Il piano settimanale non pianifica stampe che si sovrappongono a questi blocchi (incluso il tempo di sgombero).',
    noPrintersForBlocks: 'Nessuna stampante attiva da configurare.',
    blockPrinter: 'Stampante',
    noBlocksYet: 'Nessuna finestra riservata per questa stampante.',
    blockLabel: 'Etichetta (opzionale)',
    addTimeBlock: 'Aggiungi blocco orario',
    saveTimeBlocks: 'Salva blocchi orari stampante',
    invalidBlockRange: '{{day}}: l’inizio del blocco deve precedere la fine ({{start}} → {{end}})',
    discoveredCount: '{{count}} file scoperti',
    pageTitle: 'Stats 2 — Capacità reale',
    deviceCapacity: 'Capacità dispositivi',
    todaysReadiness: 'Prontezza di oggi',
    printSchedule: 'Piano stampa della settimana',
    buildPlan: 'Piano di costruzione',
    buildPlanHint: 'Ogni riga elenca i file piastra avviati dal piano settimanale per quel pezzo. Piastre e pezzi sono avvii interi del giorno selezionato — le stesse barre della timeline sopra.',
    targetDevicesDay: 'Dispositivi target / giorno',
    whatIf: 'Cosa-se',
    capacityMaxHint: 'Max ~{{n}}/giorno',
    targetNotFeasible: 'Target oltre la capacità di stampa',
    targetNotFeasibleBody: 'Richiesti {{target}}/giorno; il piano può liberare circa {{achievable}}/giorno.',
    bindingPartSuffix: 'Parte vincolante: {{binding}}.',
    scenarioAtTarget: 'Scenario per {{n}} dispositivi/giorno — piastre / pezzi sono avvii interi di {{day}} sopra.',
    scenarioAtCapacity: 'Piastre / pezzi sono avvii interi di {{day}} sopra (capacità realistica). Inserisci un target per lo scenario.',
    dedicatedFleetHint: 'Stima flotta dedicata ~{{n}}/giorno ignora stampanti condivise (stesse macchine contate per ogni pezzo). Lo schedulabile coincide con la timeline settimanale.',
    cleanupFeedback: 'Pulizia: obiettivo vs reale',
    productionYield: 'Resa di produzione',
    leadTimes: 'Tempi di attraversamento',
    qualityReasons: 'Qualità e motivi di perdita',
    printerReliability: 'Affidabilità stampanti',
    filamentPerDevice: 'Filamento per dispositivo',
    configuration: 'Configurazione',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — servono almeno {{extra}} stampanti {{models}} in più',
    shortPartsHeading: 'Parti mancanti (stesso turno operatori):',
    shortPartUnknownModels: 'idonee',
    shortPartsSharedNote:
      'Le stampanti extra sono minimi per parte (stesso turno). I modelli condivisi contano una sola volta — non sommare i numeri.',
    hypotheticalFleetNote:
      'La timeline include +{{n}} stampanti ipotetiche ({{detail}}) per questa richiesta — corsie tratteggiate.',
    export: 'Esporta CSV',
  },
