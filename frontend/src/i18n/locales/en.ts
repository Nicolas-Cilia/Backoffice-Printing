export default {
  ...
  maintenance: {
    ...
    printerLog: 'Printer log',
    logCustomJob: 'Log custom job',
    logReset: 'Log & reset',
    logResetTitle: 'Reset {{name}}?',
    logResetMessage: 'This resets the interval and adds it to the printer log. Leave a note only if something came up.',
    jobName: 'Job',
    jobNamePlaceholder: 'e.g. Replace nozzle',
    notes: 'Notes',
    notesPlaceholder: 'What did you do?',
    resetNotesPlaceholder: 'Optional notes…',
    partLink: 'Part link (optional)',
    cost: 'Cost (optional)',
    saveLog: 'Save to log',
    editLog: 'Edit log',
    ...
    deleteLogMessage: 'Remove "{{name}}" from the printer log? This does not undo a scheduled reset — it only deletes the log row and its cost.',
    logDeleted: 'Log entry deleted',
    hideTask: 'Hide',
    showTask: 'Show',
    hiddenTasks: 'Hidden tasks',
    hiddenTasksDescription: 'Hidden default tasks stay on file. Show one to bring it back without restoring everything.',
    hideTaskTitle: 'Hide {{name}}?',
    hideTaskMessage: 'It will leave the Status tab. You can show this task again from Hidden tasks — you will not have to recreate it or restore every default.',
    taskHidden: 'Task hidden',
    taskShown: 'Task shown again',
    totalMaintenanceCost: 'Maintenance cost',
    jobLogged: 'Job saved to printer log',
    ...
    deleteSystemTypeTitle: 'Hide default maintenance task?',
    deleteSystemTypeMessage: 'Hide "{{name}}" from Status? You can show it again later from Hidden tasks.',
    // Permissions
  ...
  settings: {
    ...
    manageLibraryDescription: 'Upload, rename, and delete library files',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        downloadFailed: 'Could not download preset',
      },
      partSections: {
        title: 'Part process sections',
        addSection: 'Add process sections',
        sectionName: 'Section name',
        trackParameters: 'Track parameters',
        trackParametersHelp: 'When on, processes share a print-settings contract. Turn off to skip mismatch checks.',
        namePlaceholder: 'Top part',
        create: 'Create',
        empty: 'No part process sections yet. Create one to group processes by part.',
        addProcess: 'Add process',
        uploadProcess: 'Upload process',
        uploadFailed: 'Could not upload process: {{error}}',
        confirmAttachTitle: 'Process does not match spec',
        dontUpload: "Don't upload",
        dontMove: "Don't move",
        moveToSection: 'Move to section',
        pickSection: 'Choose a part process section',
        noSectionsToMove: 'Create a part process section first',
        moveFailed: 'Could not move process: {{error}}',
        replace: 'Replace',
        remove: 'Remove',
        noProcesses: 'No processes in this section',
        pickProcess: 'Choose a process preset',
        noAvailable: 'No process presets left to add',
        replaceTitle: 'Replace process',
        incomingProcess: 'Incoming process',
        previewFailed: 'Could not preview replace: {{error}}',
        replaceFailed: 'Could not replace process: {{error}}',
        createFailed: 'Could not create section: {{error}}',
        addFailed: 'Could not add process: {{error}}',
        removeFailed: 'Could not remove slot: {{error}}',
        deleteSection: 'Delete section',
        deleteSectionConfirm: 'Delete this part section and its printer slots?',
        unknownPrinter: 'Unknown',
        toast: {
          created: 'Part section created',
          deleted: 'Part section deleted',
          processAdded: 'Process added',
          uploaded: 'Process uploaded',
          replaced: 'Process replaced',
          slotRemoved: 'Process removed',
        },
      },
    },
    connectedAs: 'Connected as',
    signInExpiredTitle: 'Bambu Cloud sign-in expired',
    signInExpiredBody: 'Bambu Lab no longer accepts the stored token. Sign in again to restore cloud profiles and firmware checks.',
    logout: 'Logout',
  ...
  fileManager: {
    ...
    chooseFolderDescription: 'Select a folder to view its contents.',
    addSection: 'Add section',
    newSection: 'New section',
    sectionName: 'Section name',
    sectionNamePlaceholder: 'e.g., Production',
    ungrouped: 'Ungrouped',
    unfiled: 'Unfiled',
    emptySection: 'No folders in this section yet.',
    moveToSection: 'Move to section',
    noSection: 'No section',
    renameSection: 'Rename section',
    deleteSection: 'Delete section',
    deleteSectionConfirm: 'Delete this section? Folders inside it will stay and become ungrouped.',
    sectionCreated: 'Section created',
    sectionRenamed: 'Section renamed',
    sectionDeleted: 'Section deleted',
    folderMovedToSection: 'Folder moved',
    folderSection: 'Section',
    trackPrintSettings: 'Track print settings (replace-only uploads)',
    trackPrintSettingsHelp: 'This folder uses production slots. Use Replace instead of generic upload.',
    trackPrintSettingsForcedHelp: 'This section requires tracking. Folders start empty — add parts, then use Add production file / Replace.',
    trackPrintSettingsSectionHelp: 'Every folder in this section uses production slots. New folders cannot turn tracking off.',
    parameterTracking: 'Parameter tracking',
    parameterTrackingChip: 'Restricted',
    printerModel: 'Printer model',
    printerModelPlaceholder: 'Select a printer',
    printerModelHelp: 'This folder uses production slots for the selected printer.',
    printerModelCustom: 'Custom code',
    printerModelCustomPlaceholder: 'e.g. P1S',
    addFolderToSection: 'Add folder',
    ...
    tags: {
      ...
      fileTitle: 'Tags on this file',
      fileTooltip: 'Add or remove tags on this file',
      applySave: 'Save tags',
      applySaveSuccess: 'Updated tags on this file.',
      addToFileAria: 'Add tags to this file',
      removeFromFileAria: 'Remove tag {{name}} from this file',
    },
    allTypes: 'All types',
    prints: 'Prints',
    ascending: 'Ascending',
    ...
    sectionParts: {
      title: 'Parts',
      add: 'Add part',
      addTitle: 'Add section part',
      code: 'Part code',
      name: 'Name',
      setParameters: 'Set parameters',
      setParametersHelp: 'This is not a printable file — it only sets the print-settings contract for this part.',
      replaceParameters: 'Replace parameters',
      replaceParametersTitle: 'Replace part parameters',
      replaceParametersHelp: 'Upload a 3MF to replace this part’s print-settings contract. Folder files are re-checked against the new spec.',
      replaceConfirm: 'Replace parameters',
      replaceFailed: 'Could not replace parameters: {{error}}',
      replaced: 'Part parameters replaced',
      previewFailed: 'Could not preview parameter replace: {{error}}',
      delete: 'Delete part',
      deleteConfirm: 'Delete part template {{code}}? Folders can still add this code later.',
      deleteConfirmInUse: 'Delete part template {{code}}? {{count}} folder instance(s) will remain and keep using this code.',
      empty: 'This section has no part templates yet. Folders can still add parts, which also create the template.',
      notPrintable: 'Section parts are not printable — they only define the settings contract.',
      followsSectionSpec: 'This folder must follow the section print-settings contract.',
      seedFailed: 'Could not set parameters: {{error}}',
      created: 'Part template created',
      deleted: 'Part template deleted',
      manage: 'Manage parts',
      seeded: 'Part parameters saved',
      addFailed: 'Could not create part: {{error}}',
      deleteFailed: 'Could not delete part: {{error}}',
      catalog: 'Section parts',
      orCreate: 'Or create a new part',
      arrangeHint: 'Drag to rearrange. TOP first, BOT beside it — whatever order you want.',
      dragHandle: 'Reorder',
      reorderFailed: 'Could not save part order: {{error}}',
    },
    production: {
      title: 'Production files',
      subtitle: '{{printer}} production slots',
      addFile: 'Add production file',
      replace: 'Replace',
      delete: 'Delete',
      proceedAnyway: 'Proceed anyway',
      acceptBaseline: 'Accept as new baseline',
      cancel: 'Cancel',
      reason: 'Reason',
      reasonPlaceholder: 'Why is the baseline changing?',
      parameterNote: 'Note',
      parameterNotePlaceholder: 'Why does this parameter differ?',
      notesRequired: 'Explain every mismatched parameter before proceeding.',
      mismatchNote: 'Mismatch note',
      newSlotConfirm: 'This will create a new production slot, not replace an existing file.',
      parseFailed: 'Could not parse the filename. Fill in the fields below.',
      versionNotNewer: 'Incoming version {{incoming}} is not newer than {{current}}.',
      matchesSpec: 'Matches spec',
      differsByDesign: 'Differs by design',
      lastReplaceMismatched: 'Last replace had mismatches',
      emptyFolder: 'No production files yet. Add a file to create the first slot.',
      quantity: 'Quantity',
      version: 'Version',
      noActiveFile: 'No active file',
      uploadIntoProductionBlocked: 'Use Replace or Add production file instead of generic upload.',
      moveIntoProductionBlocked: 'Managed by Production',
      mismatchCount: '{{count}} parameter(s) differ',
      parameter: 'Parameter',
      ...
      confirmCreate: 'Create slot',
      currentVersion: 'Current version',
      incomingVersion: 'Incoming version',
      printerMismatch: 'File printer {{file}} does not match this folder ({{folder}}).',
      dropToAdd: 'Drop a file here to add a production slot',
      print: 'Print',
      loading: 'Loading production files...',
      slotCreated: 'Production slot created',
      slotReplaced: 'Production file replaced',
      deleteConfirmTitle: 'Delete production file',
      deleteConfirm: 'Delete {{code}} x{{quantity}} {{version}} from {{printer}}? This cannot be undone.',
      deleteConfirmDetail:
        'The files will be moved to File Manager trash, where they can be restored if needed.',
      slotDeleted: 'Production slot deleted',
      deleteFailed: 'Could not delete slot: {{error}}',
      createFailed: 'Could not create slot: {{error}}',
      replaceFailed: 'Could not replace file: {{error}}',
      previewFailed: 'Could not preview replace: {{error}}',
      slotExists: 'A slot for this part and quantity already exists. Use Replace instead.',
      newPartHint: 'This will add a new part ({{code}}).',
      newQuantityHint: '{{code}} already has slots. This will add quantity x{{quantity}}.',
      sharedContractHint: 'Quantity variants of {{code}} on this printer share one print-settings contract.',
      addPart: 'Add part',
      addPartTitle: 'Add part to this printer',
      partName: 'Part name',
      partCodeHint: 'Uppercase letters only, 1–32 characters (for example TOP or LID).',
      confirmAddPart: 'Add part',
      partAdded: 'Part added',
      addPartFailed: 'Could not add part: {{error}}',
      removePart: 'Remove part',
      removePartConfirmTitle: 'Remove part',
      removePartConfirmEmpty: 'Remove {{code}} ({{name}}) from {{printer}}? You can add it back later.',
      removePartConfirmWithFiles: 'Remove {{code}} ({{name}}) from {{printer}}? {{count}} production file(s) will be moved to trash.',
      partRemoved: 'Part removed',
      removePartFailed: 'Could not remove part: {{error}}',
      addFileToPart: 'Add file',
      emptyPart: 'No files for this part yet.',
      previewing: 'Comparing against spec...',
      uploading: 'Uploading...',
      suggestedVersion: 'Suggested next version: {{version}}',
      match: 'Match',
      mismatch: 'Mismatch',
      specs: {
        view: 'View specs',
        title: 'Current print specs',
        layerHeight: 'Layer height',
        initialLayerLineWidth: 'First layer line width',
        infillDensity: 'Infill density',
        infillPattern: 'Infill pattern',
        wallLoops: 'Walls',
        brimType: 'Brim',
        brimWidth: 'Brim width',
        brimObjectGap: 'Brim-object gap',
        fuzzySkin: 'Fuzzy skin',
        fuzzySkinPainted: 'Painted',
        fuzzySkinAllowPaint: 'Allow paint',
        fuzzySkinThickness: 'Fuzzy skin thickness',
        fuzzySkinPointDistance: 'Fuzzy skin point distance',
        enableSupport: 'Supports',
        supportType: 'Support type',
        supportStyle: 'Support style',
        supportTreeAuto: 'Tree auto',
        supportTreeManual: 'Tree manual',
        supportNormalAuto: 'Normal auto',
        supportNormalManual: 'Normal manual',
        supportStyleSlim: 'Tree slim',
        supportStyleHybrid: 'Hybrid',
        supportStyleStrong: 'Strong',
        supportStyleOrganic: 'Organic',
        supportStyleDefault: 'Default',
        supportStyleSnug: 'Snug',
        supportStyleGrid: 'Grid',
        enablePrimeTower: 'Prime tower',
        seamPosition: 'Seam',
        nozzlesUsed: 'Nozzles',
        bed: 'Bed',
        bedTypeTexturedPei: 'Textured PEI',
        bedTypeSmoothPei: 'Smooth PEI',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'SuperTack',
        ...
        brimAuto: 'Auto brim',
        brimNone: 'No brim',
        brimOuter: 'Outer only',
        brimInner: 'Inner only',
        brimBoth: 'Outer and inner',
        nozzlesLeft: 'Left',
        nozzlesRight: 'Right',
        nozzlesBoth: 'Both',
        infillPatterns: {
        ...
        valueMm: '{{value}} mm',
        valuePercent: '{{value}}%',
        summaryInfill: '{{value}}% infill',
        summarySupports: 'Supports: {{detail}}',
        summaryBrimGap: '{{value}} mm gap',
        summaryBed: 'Bed: {{value}}',
      },
    },
  },
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Capacity config',
    capacityConfigDescription: 'Weekly printer hours, production line start, bed clear assumption, and device recipe (Part Models). Used by Stats 2 capacity and schedule.',
    lineStart: 'Line start',
    applyWeekdayDefaults: 'Apply Mon–Fri 8:00 AM–5:00 PM',
    timezone: 'Timezone',
    preLineBuffer: 'Pre-line buffer (min)',
    expectedClear: 'Expected bed clear (min)',
    weeklyHours: 'Weekly staffed hours',
    weeklyHoursHint: 'Edit shifts via API for now; full grid editor ships with Stats 2 page.',
    unstaffed: 'Unstaffed',
    saveGlobals: 'Save line start & clear',
    configSaved: 'Saved — capacity will refresh',
    unsavedChanges: 'Unsaved changes',
    deviceRecipe: 'Device recipe (Part Models)',
    printerTimeBlocks: 'Printer time blocks (must be free)',
    ...
    noPrintersForBlocks: 'No active printers to configure.',
    blockPrinter: 'Printer',
    noBlocksYet: 'No reserved windows for this printer.',
    blockLabel: 'Label (optional)',
    addTimeBlock: 'Add time block',
    saveTimeBlocks: 'Save printer time blocks',
    invalidBlockRange: '{{day}}: block start must be before end (got {{start}} → {{end}})',
    discoveredCount: '{{count}} discovered file(s)',
    pageTitle: 'Stats 2 — True Capacity',
    deviceCapacity: 'Device capacity',
    todaysReadiness: 'Today\'s readiness',
    printSchedule: 'This week\'s print schedule',
    ...
    targetDevicesDay: 'Devices / day',
    whatIf: 'Run what-if',
    capacityMaxHint: 'Capacity ~{{n}}/day',
    targetNotFeasible: 'Ask is above print capacity',
    targetNotFeasibleBody: 'Asked for {{target}}/day; fleet can schedule about {{achievable}}/day.',
    bindingPartSuffix: 'Binding part: {{binding}}.',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — need at least {{extra}} more {{models}} printer(s)',
    shortPartsHeading: 'Short parts (same operator schedule):',
    shortPartUnknownModels: 'eligible',
    ...
    scenarioAtTarget: 'Showing plate starts for {{n}} devices/day on {{day}} (same bars as the timeline).',
    scenarioAtCapacity:
      'Showing plate starts for {{day}} at measured capacity. Enter a number and Run what-if to simulate a different daily ask.',
    dedicatedFleetHint:
      'A naive dedicated-fleet estimate (~{{n}}/day) double-counts printers shared across parts. Theoretical above matches the weekly timeline.',
    cleanupFeedback: 'Cleanup: target vs reality',
    productionYield: 'Production yield',
    leadTimes: 'Floor lead times',
    qualityReasons: 'Quality & loss reasons',
    printerReliability: 'Printer reliability',
    filamentPerDevice: 'Filament per device',
    configuration: 'Configuration',
    export: 'Export CSV',
  },
