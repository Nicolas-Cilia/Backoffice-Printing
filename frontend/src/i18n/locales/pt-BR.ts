export default {
  ...
  printers: {
    ...
    startPrintOn: 'Iniciar impressão em {{name}}',
    yourFiles: 'Seus arquivos',
    printableTypesHint: 'Suportados: .gcode, .gcode.3mf',
    uploadToPrintHint: 'Solte um arquivo imprimível aqui, ou escolha um em Seus arquivos — as opções de impressão abrem neste painel.',
    pickFromLibraryHint: 'Escolha um arquivo imprimível em Seus arquivos — as opções de impressão abrem neste painel.',
    saveToYourFiles: 'Salvar nos seus arquivos',
    saveToYourFilesHint: 'Desligado por padrão — o upload só é usado nesta impressão e não fica em Não classificados.',
    saveLocation: 'Local de salvamento',
    changeFile: 'Trocar arquivo',
    printOptionsAdvanced: 'Opções avançadas',
  ...
  maintenance: {
    ...
    printerLog: 'Registro da impressora',
    logCustomJob: 'Registrar trabalho personalizado',
    logReset: 'Registrar e redefinir',
    logResetTitle: 'Redefinir {{name}}?',
    logResetMessage: 'Isso redefine o intervalo e adiciona ao registro da impressora. Deixe uma nota apenas se algo tiver ocorrido.',
    jobName: 'Trabalho',
    jobNamePlaceholder: 'ex. Substituir bico',
    notes: 'Notas',
    notesPlaceholder: 'O que você fez?',
    resetNotesPlaceholder: 'Notas opcionais…',
    partLink: 'Link da peça (opcional)',
    cost: 'Custo (opcional)',
    saveLog: 'Salvar no registro',
    editLog: 'Editar registro',
    editLogTitle: 'Editar registro',
    logUpdated: 'Entrada do registro atualizada',
    deleteLog: 'Excluir registro',
    deleteLogTitle: 'Excluir entrada do registro?',
    deleteLogMessage: 'Remover "{{name}}" do registro da impressora? Isso não desfaz uma redefinição agendada — apenas exclui a linha do registro e o respectivo custo.',
    logDeleted: 'Entrada do registro excluída',
    hideTask: 'Ocultar',
    showTask: 'Mostrar',
    hiddenTasks: 'Tarefas ocultas',
    hiddenTasksDescription: 'As tarefas padrão ocultas permanecem salvas. Mostre uma para trazê-la de volta sem restaurar tudo.',
    hideTaskTitle: 'Ocultar {{name}}?',
    hideTaskMessage: 'Sairá da aba Status. Você pode mostrá-la novamente em Tarefas ocultas — sem recriá-la nem restaurar todas as padrões.',
    taskHidden: 'Tarefa ocultada',
    taskShown: 'Tarefa exibida novamente',
    totalMaintenanceCost: 'Custo de manutenção',
    jobLogged: 'Trabalho salvo no registro da impressora',
    customJob: 'Trabalho personalizado',
  ...
  settings: {
    ...
    manageLibraryDescription: 'Enviar, renomear e excluir arquivos da biblioteca',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        downloadFailed: 'Não foi possível baixar o preset',
      },
      partSections: {
        title: 'Seções de processo da peça',
        addSection: 'Adicionar seções de processo',
        sectionName: 'Nome da seção',
        trackParameters: 'Rastrear parâmetros',
        trackParametersHelp: 'Quando ligado, os processos compartilham um contrato de configurações de impressão. Desligue para pular as verificações de divergência.',
        namePlaceholder: 'Peça superior',
        create: 'Criar',
        empty: 'Ainda não há seções de processo da peça. Crie uma para agrupar processos por peça.',
        addProcess: 'Adicionar processo',
        uploadProcess: 'Enviar processo',
        uploadFailed: 'Não foi possível enviar o processo: {{error}}',
        confirmAttachTitle: 'O processo não corresponde à especificação',
        dontUpload: 'Não enviar',
        dontMove: 'Não mover',
        moveToSection: 'Mover para seção',
        pickSection: 'Escolha uma seção de processo da peça',
        noSectionsToMove: 'Crie primeiro uma seção de processo da peça',
        moveFailed: 'Não foi possível mover o processo: {{error}}',
        replace: 'Substituir',
        remove: 'Remover',
        noProcesses: 'Nenhum processo nesta seção',
        pickProcess: 'Escolher um preset de processo',
        noAvailable: 'Não restam presets de processo para adicionar',
        replaceTitle: 'Substituir processo',
        incomingProcess: 'Processo de entrada',
        previewFailed: 'Não foi possível pré-visualizar a substituição: {{error}}',
        replaceFailed: 'Não foi possível substituir o processo: {{error}}',
        createFailed: 'Não foi possível criar a seção: {{error}}',
        addFailed: 'Não foi possível adicionar o processo: {{error}}',
        removeFailed: 'Não foi possível remover o slot: {{error}}',
        deleteSection: 'Excluir seção',
        deleteSectionConfirm: 'Excluir esta seção de peça e seus slots de impressora?',
        unknownPrinter: 'Desconhecida',
        toast: {
          created: 'Seção de peça criada',
          deleted: 'Seção de peça excluída',
          processAdded: 'Processo adicionado',
          uploaded: 'Processo enviado',
          replaced: 'Processo substituído',
          slotRemoved: 'Processo removido',
        },
      },
    },
    connectedAs: 'Conectado como',
    signInExpiredTitle: 'Sessão do Bambu Cloud expirada',
    signInExpiredBody: 'A Bambu Lab não aceita mais o token armazenado. Entre novamente para restaurar os perfis na nuvem e a verificação de firmware.',
    logout: 'Sair',
  ...
  fileManager: {
    ...
    chooseFolderTitle: 'Escolha uma pasta para navegar',
    chooseFolderDescription: 'Selecione uma pasta para ver seu conteúdo.',
    addSection: 'Adicionar seção',
    newSection: 'Nova seção',
    sectionName: 'Nome da seção',
    sectionNamePlaceholder: 'ex.: Produção',
    ungrouped: 'Sem grupo',
    unfiled: 'Sem pasta',
    emptySection: 'Ainda não há pastas nesta seção.',
    moveToSection: 'Mover para seção',
    noSection: 'Sem seção',
    renameSection: 'Renomear seção',
    deleteSection: 'Excluir seção',
    deleteSectionConfirm: 'Excluir esta seção? As pastas dentro dela permanecerão e ficarão sem grupo.',
    sectionCreated: 'Seção criada',
    sectionRenamed: 'Seção renomeada',
    sectionDeleted: 'Seção excluída',
    folderMovedToSection: 'Pasta movida',
    folderSection: 'Seção',
    trackPrintSettings: 'Rastrear configurações de impressão (somente substituição)',
    trackPrintSettingsHelp: 'Esta pasta usa slots de produção. Use Substituir em vez do envio genérico.',
    trackPrintSettingsForcedHelp: 'Esta seção exige rastreamento. As pastas começam vazias — adicione peças e use Adicionar arquivo de produção / Substituir.',
    trackPrintSettingsSectionHelp: 'Todas as pastas nesta seção usam slots de produção. Pastas novas não podem desligar o rastreamento.',
    parameterTracking: 'Rastreamento de parâmetros',
    parameterTrackingChip: 'Restrito',
    printerModel: 'Modelo da impressora',
    printerModelPlaceholder: 'Selecione uma impressora',
    printerModelHelp: 'Esta pasta usa slots de produção para a impressora selecionada.',
    printerModelCustom: 'Código personalizado',
    printerModelCustomPlaceholder: 'ex.: P1S',
    addFolderToSection: 'Adicionar pasta',
    ...
    tags: {
      ...
      fileTitle: 'Tags neste arquivo',
      fileTooltip: 'Adicionar ou remover tags neste arquivo',
      applySave: 'Salvar tags',
      applySaveSuccess: 'Tags deste arquivo atualizadas.',
      addToFileAria: 'Adicionar tags a este arquivo',
      removeFromFileAria: 'Remover a tag {{name}} deste arquivo',
    },
    ...
    sectionParts: {
      title: 'Peças',
      add: 'Adicionar peça',
      addTitle: 'Adicionar peça da seção',
      code: 'Código da peça',
      name: 'Nome',
      setParameters: 'Definir parâmetros',
      setParametersHelp: 'Isto não é um arquivo imprimível — apenas define o contrato de ajustes de impressão desta peça.',
      replaceParameters: 'Substituir parâmetros',
      replaceParametersTitle: 'Substituir parâmetros da peça',
      replaceParametersHelp: 'Envie um 3MF para substituir o contrato de ajustes desta peça. Os arquivos das pastas são verificados de novo em relação à nova especificação.',
      replaceConfirm: 'Substituir parâmetros',
      replaceFailed: 'Não foi possível substituir os parâmetros: {{error}}',
      replaced: 'Parâmetros da peça substituídos',
      previewFailed: 'Não foi possível pré-visualizar a substituição de parâmetros: {{error}}',
      delete: 'Excluir peça',
      deleteConfirm: 'Excluir o modelo de peça {{code}}? As pastas ainda poderão adicionar este código depois.',
      deleteConfirmInUse: 'Excluir o modelo de peça {{code}}? {{count}} instância(s) de pasta permanecerão e continuarão usando este código.',
      empty: 'Esta seção ainda não tem modelos de peça. As pastas podem adicionar peças, o que também cria o modelo.',
      notPrintable: 'Peças de seção não são imprimíveis — só definem o contrato de ajustes.',
      followsSectionSpec: 'Esta pasta deve seguir o contrato de ajustes de impressão da seção.',
      seedFailed: 'Não foi possível definir os parâmetros: {{error}}',
      created: 'Modelo de peça criado',
      deleted: 'Modelo de peça excluído',
      manage: 'Gerenciar peças',
      seeded: 'Parâmetros da peça salvos',
      addFailed: 'Não foi possível criar a peça: {{error}}',
      deleteFailed: 'Não foi possível excluir a peça: {{error}}',
      catalog: 'Peças da seção',
      orCreate: 'Ou criar uma nova peça',
      arrangeHint: 'Arraste para reordenar. TOP primeiro, BOT ao lado — na ordem que quiser.',
      dragHandle: 'Reordenar',
      reorderFailed: 'Não foi possível salvar a ordem das peças: {{error}}',
    },
    production: {
      title: 'Arquivos de produção',
      subtitle: 'Slots de produção {{printer}}',
      addFile: 'Adicionar arquivo de produção',
      replace: 'Substituir',
      delete: 'Excluir',
      proceedAnyway: 'Continuar mesmo assim',
      acceptBaseline: 'Aceitar como nova base',
      cancel: 'Cancelar',
      reason: 'Motivo',
      reasonPlaceholder: 'Por que a base está mudando?',
      parameterNote: 'Observação',
      parameterNotePlaceholder: 'Por que este parâmetro é diferente?',
      notesRequired: 'Explique cada parâmetro divergente antes de continuar.',
      mismatchNote: 'Nota da divergência',
      newSlotConfirm: 'Isso criará um novo slot de produção, sem substituir um arquivo existente.',
      parseFailed: 'Não foi possível analisar o nome do arquivo. Preencha os campos abaixo.',
      versionNotNewer: 'A versão recebida {{incoming}} não é mais nova que {{current}}.',
      matchesSpec: 'Atende à especificação',
      differsByDesign: 'Difere por projeto',
      lastReplaceMismatched: 'A última substituição teve divergências',
      emptyFolder: 'Ainda não há arquivos de produção. Adicione um para criar o primeiro slot.',
      quantity: 'Quantidade',
      version: 'Versão',
      noActiveFile: 'Nenhum arquivo ativo',
      uploadIntoProductionBlocked: 'Use Substituir ou Adicionar arquivo de produção em vez do envio genérico.',
      moveIntoProductionBlocked: 'Gerenciado por Production',
      mismatchCount: '{{count}} parâmetro(s) diferem',
      parameter: 'Parâmetro',
      lockedValue: 'Valor bloqueado',
      incomingValue: 'Valor recebido',
      code: 'Código da peça',
      printer: 'Impressora',
      pickFile: 'Escolher arquivo',
      confirmCreate: 'Criar slot',
      currentVersion: 'Versão atual',
      incomingVersion: 'Versão recebida',
      printerMismatch: 'A impressora do arquivo {{file}} não corresponde a esta pasta ({{folder}}).',
      dropToAdd: 'Solte um arquivo aqui para adicionar um slot de produção',
      print: 'Imprimir',
      loading: 'Carregando arquivos de produção...',
      slotCreated: 'Slot de produção criado',
      slotReplaced: 'Arquivo de produção substituído',
      deleteConfirmTitle: 'Excluir arquivo de produção',
      deleteConfirm: 'Excluir {{code}} x{{quantity}} {{version}} de {{printer}}? Esta ação não pode ser desfeita.',
      deleteConfirmDetail:
        'Os arquivos serão movidos para a lixeira do gerenciador de arquivos, de onde poderão ser restaurados se necessário.',
      slotDeleted: 'Slot de produção excluído',
      deleteFailed: 'Não foi possível excluir o slot: {{error}}',
      createFailed: 'Não foi possível criar o slot: {{error}}',
      replaceFailed: 'Não foi possível substituir o arquivo: {{error}}',
      previewFailed: 'Não foi possível pré-visualizar a substituição: {{error}}',
      slotExists: 'Já existe um slot para esta peça e quantidade. Use Substituir.',
      newPartHint: 'Isso adicionará uma nova peça ({{code}}).',
      newQuantityHint: '{{code}} já tem slots. Será adicionada a quantidade x{{quantity}}.',
      sharedContractHint: 'As variantes de quantidade de {{code}} nesta impressora compartilham o mesmo contrato de configurações de impressão.',
      addPart: 'Adicionar peça',
      addPartTitle: 'Adicionar peça a esta impressora',
      partName: 'Nome da peça',
      partCodeHint: 'Apenas letras maiúsculas, 1–32 caracteres (por exemplo TOP ou LID).',
      confirmAddPart: 'Adicionar peça',
      partAdded: 'Peça adicionada',
      addPartFailed: 'Não foi possível adicionar a peça: {{error}}',
      removePart: 'Remover peça',
      removePartConfirmTitle: 'Remover peça',
      removePartConfirmEmpty: 'Remover {{code}} ({{name}}) de {{printer}}? Você poderá adicioná-la novamente depois.',
      removePartConfirmWithFiles: 'Remover {{code}} ({{name}}) de {{printer}}? {{count}} arquivo(s) de produção serão movidos para a lixeira.',
      partRemoved: 'Peça removida',
      removePartFailed: 'Não foi possível remover a peça: {{error}}',
      addFileToPart: 'Adicionar arquivo',
      emptyPart: 'Ainda não há arquivos para esta peça.',
      previewing: 'Comparando com a especificação...',
      uploading: 'Enviando...',
      suggestedVersion: 'Próxima versão sugerida: {{version}}',
      match: 'Coincide',
      mismatch: 'Diverge',
      specs: {
        view: 'Ver especificações',
        title: 'Especificações de impressão atuais',
        layerHeight: 'Altura da camada',
        initialLayerLineWidth: 'Largura de linha da primeira camada',
        infillDensity: 'Densidade do preenchimento',
        infillPattern: 'Padrão de preenchimento',
        wallLoops: 'Paredes',
        brimType: 'Aba',
        brimWidth: 'Largura do brim',
        brimObjectGap: 'Folga entre brim e objeto',
        fuzzySkin: 'Pele difusa',
        fuzzySkinPainted: 'Pintado',
        fuzzySkinAllowPaint: 'Permite pintar',
        fuzzySkinThickness: 'Espessura da pele difusa',
        fuzzySkinPointDistance: 'Distância dos pontos da pele difusa',
        enableSupport: 'Suportes',
        supportType: 'Tipo de suporte',
        supportStyle: 'Estilo de suporte',
        supportTreeAuto: 'Árvore automática',
        supportTreeManual: 'Árvore manual',
        supportNormalAuto: 'Normal automático',
        supportNormalManual: 'Normal em modo manual',
        supportStyleSlim: 'Árvore fina',
        supportStyleHybrid: 'Híbrido',
        supportStyleStrong: 'Árvore forte',
        supportStyleOrganic: 'Orgânico',
        supportStyleDefault: 'Padrão',
        supportStyleSnug: 'Ajustado',
        supportStyleGrid: 'Grade',
        ...
        on: 'Ativado',
        off: 'Desativado',
        brimAuto: 'Brim automático',
        brimNone: 'Sem brim',
        brimOuter: 'Somente externo',
        brimInner: 'Somente interno',
        brimBoth: 'Externo e interno',
        nozzlesLeft: 'Esquerdo',
        nozzlesRight: 'Direito',
        nozzlesBoth: 'Ambos',
        infillPatterns: {
          concentric: 'Concêntrico',
          rectilinear: 'Retilíneo',
          monotonic: 'Monotônico',
          monotonicLine: 'Linha monotônica',
          alignedRectilinear: 'Retilíneo alinhado',
          hilbertCurve: 'Curva de Hilbert',
          archimedeanChords: 'Cordas de Arquimedes',
          octagramSpiral: 'Espiral de octagrama',
        },
        valueMm: '{{value}}\u00a0mm',
        valuePercent: '{{value}}\u00a0%',
        summaryInfill: '{{value}}% de preenchimento',
        summarySupports: 'Suportes: {{detail}}',
        summaryBrimGap: '{{value}}\u00a0mm de folga',
        summaryBed: 'Mesa: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: 'Clique em um material para escolher o slot AMS',
    chooseMaterialSlot: 'Escolha extrusora/cor para o Material {{n}}',
    mustMapMaterials: 'É preciso selecionar/mapear materiais',
    unmappedSlot: '—',
    emptySlot: 'Vazio',
    noAmsSlots: 'Nenhuma bobina AMS ou externa reportada por esta impressora.',
    useAutoMatch: 'Usar correspondência automática',
    reRead: 'Reler',
    plateN: 'Placa {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Configuração de capacidade',
    applyWeekdayDefaults: 'Aplicar seg–sex 8:00–17:00',
    timezone: 'Fuso horário',
    capacityConfigDescription: 'Horas semanais, início da linha, limpeza da mesa e receita do dispositivo (modelos de peça) para o Stats 2.',
    lineStart: 'Início da linha (HH:MM)',
    preLineBuffer: 'Buffer pré-linha (min)',
    expectedClear: 'Limpeza esperada da mesa (min)',
    weeklyHours: 'Horas semanais com equipe',
    weeklyHoursHint: 'Edite turnos via API por enquanto; editor completo vem com o Stats 2.',
    unstaffed: 'Sem equipe',
    saveGlobals: 'Salvar início da linha e limpeza',
    configSaved: 'Salvo — a capacidade será atualizada',
    unsavedChanges: 'Alterações não salvas',
    deviceRecipe: 'Receita do dispositivo (modelos de peça)',
    printerTimeBlocks: 'Blocos de tempo da impressora (deve estar livre)',
    printerTimeBlocksHint:
      'Janelas semanais recorrentes em que uma impressora deve permanecer ociosa. O cronograma semanal não colocará uma impressão que se sobreponha a esses blocos (incluindo o tempo de limpeza).',
    noPrintersForBlocks: 'Nenhuma impressora ativa para configurar.',
    blockPrinter: 'Impressora',
    noBlocksYet: 'Nenhuma janela reservada para esta impressora.',
    blockLabel: 'Rótulo (opcional)',
    addTimeBlock: 'Adicionar bloco de tempo',
    saveTimeBlocks: 'Salvar blocos de tempo',
    invalidBlockRange: '{{day}}: o início do bloco deve ser antes do fim ({{start}} → {{end}})',
    discoveredCount: '{{count}} arquivo(s) encontrado(s)',
    pageTitle: 'Stats 2 — Capacidade real',
    deviceCapacity: 'Capacidade de dispositivos',
    todaysReadiness: 'Prontidão de hoje',
    printSchedule: 'Agenda de impressão da semana',
    buildPlan: 'Plano de montagem',
    buildPlanHint: 'Cada linha lista o(s) arquivo(s) de placa que o plano semanal inicia para essa peça. Placas e peças são inícios inteiros do dia selecionado — as mesmas barras da linha do tempo acima.',
    targetDevicesDay: 'Dispositivos-alvo / dia',
    whatIf: 'E se',
    capacityMaxHint: 'Máx. ~{{n}}/dia',
    targetNotFeasible: 'Meta acima da capacidade de impressão',
    targetNotFeasibleBody: 'Pedido {{target}}/dia; o plano consegue liberar cerca de {{achievable}}/dia.',
    bindingPartSuffix: 'Peça limitante: {{binding}}.',
    scenarioAtTarget: 'Cenário para {{n}} dispositivos/dia — placas / peças são inícios inteiros de {{day}} acima.',
    scenarioAtCapacity: 'Placas / peças são inícios inteiros de {{day}} acima (capacidade realista). Informe uma meta para simular.',
    dedicatedFleetHint: 'Estimativa de frota dedicada ~{{n}}/dia ignora impressoras compartilhadas (as mesmas máquinas contadas para cada peça). O agendável coincide com a timeline semanal.',
    cleanupFeedback: 'Limpeza: meta vs real',
    productionYield: 'Rendimento de produção',
    leadTimes: 'Lead times no chão',
    qualityReasons: 'Qualidade e motivos de perda',
    printerReliability: 'Confiabilidade das impressoras',
    filamentPerDevice: 'Filamento por dispositivo',
    configuration: 'Configuração',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — precisam de pelo menos mais {{extra}} impressora(s) {{models}}',
    shortPartsHeading: 'Peças em falta (mesmo horário de operadores):',
    shortPartUnknownModels: 'elegíveis',
    shortPartsSharedNote:
      'Impressoras extras são mínimos por peça (mesmo horário). Modelos compartilhados contam uma vez — não some os números.',
    hypotheticalFleetNote:
      'A linha do tempo inclui +{{n}} impressoras hipotéticas ({{detail}}) para este pedido — faixas tracejadas.',
    export: 'Exportar CSV',
  },
