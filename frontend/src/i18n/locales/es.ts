export default {
  ...
  printers: {
    ...
    startPrintOn: 'Iniciar impresión en {{name}}',
    yourFiles: 'Tus archivos',
    printableTypesHint: 'Compatible: .gcode, .gcode.3mf',
    uploadToPrintHint: 'Suelta un archivo imprimible aquí, o elige uno de Tus archivos — las opciones de impresión se abren en este panel.',
    pickFromLibraryHint: 'Elige un archivo imprimible de Tus archivos — las opciones de impresión se abren en este panel.',
    saveToYourFiles: 'Guardar en tus archivos',
    saveToYourFilesHint: 'Desactivado por defecto — la subida solo se usa para esta impresión y no se guarda en Sin clasificar.',
    saveLocation: 'Ubicación de guardado',
    changeFile: 'Cambiar archivo',
    printOptionsAdvanced: 'Opciones avanzadas',
  ...
  maintenance: {
    ...
    printerLog: 'Registro de impresora',
    logCustomJob: 'Registrar trabajo personalizado',
    logReset: 'Registrar y restablecer',
    logResetTitle: '¿Restablecer {{name}}?',
    logResetMessage: 'Esto restablece el intervalo y lo añade al registro de la impresora. Deje una nota solo si ocurrió algo.',
    jobName: 'Trabajo',
    jobNamePlaceholder: 'p. ej. Sustituir boquilla',
    notes: 'Notas',
    notesPlaceholder: '¿Qué ha hecho?',
    resetNotesPlaceholder: 'Notas opcionales…',
    partLink: 'Enlace de pieza (opcional)',
    cost: 'Coste (opcional)',
    saveLog: 'Guardar en el registro',
    editLog: 'Editar registro',
    editLogTitle: 'Editar registro',
    logUpdated: 'Entrada de registro actualizada',
    deleteLog: 'Eliminar registro',
    deleteLogTitle: '¿Eliminar entrada del registro?',
    deleteLogMessage: '¿Quitar "{{name}}" del registro de la impresora? Esto no deshace un restablecimiento programado — solo elimina la fila del registro y su coste.',
    logDeleted: 'Entrada de registro eliminada',
    hideTask: 'Ocultar',
    showTask: 'Mostrar',
    hiddenTasks: 'Tareas ocultas',
    hiddenTasksDescription: 'Las tareas predeterminadas ocultas se conservan. Muestre una para recuperarla sin restaurar todo.',
    hideTaskTitle: '¿Ocultar {{name}}?',
    hideTaskMessage: 'Saldrá de la pestaña Estado. Puede volver a mostrarla desde Tareas ocultas, sin recrearla ni restaurar todas las predeterminadas.',
    taskHidden: 'Tarea oculta',
    taskShown: 'Tarea mostrada de nuevo',
    totalMaintenanceCost: 'Coste de mantenimiento',
    jobLogged: 'Trabajo guardado en el registro de la impresora',
  ...
  settings: {
    ...
    manageLibraryDescription: 'Subir, renombrar y eliminar archivos de la biblioteca',
  ...
  profiles: {
    ...
    localProfiles: {
      ...
      toast: {
        ...
        downloadFailed: 'No se pudo descargar el preajuste',
      },
      partSections: {
        title: 'Secciones de proceso de pieza',
        addSection: 'Añadir secciones de proceso',
        sectionName: 'Nombre de la sección',
        trackParameters: 'Seguir parámetros',
        trackParametersHelp: 'Si está activado, los procesos comparten un contrato de ajustes de impresión. Desactívelo para omitir las comprobaciones de discrepancia.',
        namePlaceholder: 'Pieza superior',
        create: 'Crear',
        empty: 'Aún no hay secciones de proceso de pieza. Cree una para agrupar procesos por pieza.',
        addProcess: 'Añadir proceso',
        uploadProcess: 'Subir proceso',
        uploadFailed: 'No se pudo subir el proceso: {{error}}',
        confirmAttachTitle: 'El proceso no coincide con la especificación',
        dontUpload: 'No subir',
        dontMove: 'No mover',
        moveToSection: 'Mover a sección',
        pickSection: 'Elige una sección de proceso de pieza',
        noSectionsToMove: 'Crea primero una sección de proceso de pieza',
        moveFailed: 'No se pudo mover el proceso: {{error}}',
        replace: 'Sustituir',
        remove: 'Quitar',
        noProcesses: 'No hay procesos en esta sección',
        pickProcess: 'Elegir un preajuste de proceso',
        noAvailable: 'No quedan preajustes de proceso para añadir',
        replaceTitle: 'Sustituir proceso',
        incomingProcess: 'Proceso entrante',
        previewFailed: 'No se pudo previsualizar la sustitución: {{error}}',
        replaceFailed: 'No se pudo sustituir el proceso: {{error}}',
        createFailed: 'No se pudo crear la sección: {{error}}',
        addFailed: 'No se pudo añadir el proceso: {{error}}',
        removeFailed: 'No se pudo quitar la ranura: {{error}}',
        deleteSection: 'Eliminar sección',
        deleteSectionConfirm: '¿Eliminar esta sección de pieza y sus ranuras de impresora?',
        unknownPrinter: 'Desconocida',
        toast: {
          created: 'Sección de pieza creada',
          deleted: 'Sección de pieza eliminada',
          processAdded: 'Proceso añadido',
          uploaded: 'Proceso subido',
          replaced: 'Proceso sustituido',
          slotRemoved: 'Proceso quitado',
        },
      },
    },
    connectedAs: 'Conectado como',
    signInExpiredTitle: 'La sesión de Bambu Cloud ha caducado',
    signInExpiredBody: 'Bambu Lab ya no acepta el token almacenado. Inicie sesión de nuevo para restaurar los perfiles en la nube y las comprobaciones de firmware.',
    logout: 'Cerrar sesión',
  ...
  fileManager: {
    ...
    chooseFolderTitle: 'Elige una carpeta para explorar',
    chooseFolderDescription: 'Selecciona una carpeta para ver su contenido.',
    addSection: 'Añadir sección',
    newSection: 'Nueva sección',
    sectionName: 'Nombre de la sección',
    sectionNamePlaceholder: 'p. ej., Producción',
    ungrouped: 'Sin agrupar',
    unfiled: 'Sin carpeta',
    emptySection: 'Aún no hay carpetas en esta sección.',
    moveToSection: 'Mover a sección',
    noSection: 'Sin sección',
    renameSection: 'Renombrar sección',
    deleteSection: 'Eliminar sección',
    deleteSectionConfirm: '¿Eliminar esta sección? Las carpetas se conservarán y quedarán sin agrupar.',
    sectionCreated: 'Sección creada',
    sectionRenamed: 'Sección renombrada',
    sectionDeleted: 'Sección eliminada',
    folderMovedToSection: 'Carpeta movida',
    folderSection: 'Sección',
    trackPrintSettings: 'Seguir ajustes de impresión (solo reemplazo)',
    trackPrintSettingsHelp: 'Esta carpeta usa ranuras de producción. Use Reemplazar en lugar de la carga genérica.',
    trackPrintSettingsForcedHelp: 'Esta sección exige seguimiento. Las carpetas empiezan vacías: añada piezas y use Añadir archivo de producción / Reemplazar.',
    trackPrintSettingsSectionHelp: 'Todas las carpetas de esta sección usan ranuras de producción. Las nuevas no pueden desactivar el seguimiento.',
    parameterTracking: 'Seguimiento de parámetros',
    parameterTrackingChip: 'Restringido',
    printerModel: 'Modelo de impresora',
    printerModelPlaceholder: 'Seleccionar impresora',
    printerModelHelp: 'Esta carpeta usa ranuras de producción para la impresora seleccionada.',
    printerModelCustom: 'Código personalizado',
    printerModelCustomPlaceholder: 'p. ej., P1S',
    addFolderToSection: 'Añadir carpeta',
    ...
    tags: {
      ...
      fileTitle: 'Etiquetas de este archivo',
      fileTooltip: 'Añadir o quitar etiquetas en este archivo',
      applySave: 'Guardar etiquetas',
      applySaveSuccess: 'Etiquetas de este archivo actualizadas.',
      addToFileAria: 'Añadir etiquetas a este archivo',
      removeFromFileAria: 'Quitar la etiqueta {{name}} de este archivo',
    },
    ...
    sectionParts: {
      title: 'Piezas',
      add: 'Añadir pieza',
      addTitle: 'Añadir pieza de sección',
      code: 'Código de pieza',
      name: 'Nombre',
      setParameters: 'Definir parámetros',
      setParametersHelp: 'Esto no es un archivo imprimible: solo establece el contrato de ajustes de impresión de esta pieza.',
      replaceParameters: 'Reemplazar parámetros',
      replaceParametersTitle: 'Reemplazar parámetros de la pieza',
      replaceParametersHelp: 'Sube un 3MF para reemplazar el contrato de ajustes de esta pieza. Los archivos de las carpetas se vuelven a comprobar con la nueva especificación.',
      replaceConfirm: 'Reemplazar parámetros',
      replaceFailed: 'No se pudieron reemplazar los parámetros: {{error}}',
      replaced: 'Parámetros de la pieza reemplazados',
      previewFailed: 'No se pudo previsualizar el reemplazo de parámetros: {{error}}',
      delete: 'Eliminar pieza',
      deleteConfirm: '¿Eliminar la plantilla de pieza {{code}}? Las carpetas podrán volver a añadir este código más adelante.',
      deleteConfirmInUse: '¿Eliminar la plantilla de pieza {{code}}? Quedarán {{count}} instancia(s) de carpeta que seguirán usando este código.',
      empty: 'Esta sección aún no tiene plantillas de pieza. Las carpetas pueden añadir piezas, y eso también crea la plantilla.',
      notPrintable: 'Las piezas de sección no se imprimen: solo definen el contrato de ajustes.',
      followsSectionSpec: 'Esta carpeta debe seguir el contrato de ajustes de impresión de la sección.',
      seedFailed: 'No se pudieron definir los parámetros: {{error}}',
      created: 'Plantilla de pieza creada',
      deleted: 'Plantilla de pieza eliminada',
      manage: 'Gestionar piezas',
      seeded: 'Parámetros de la pieza guardados',
      addFailed: 'No se pudo crear la pieza: {{error}}',
      deleteFailed: 'No se pudo eliminar la pieza: {{error}}',
      catalog: 'Piezas de la sección',
      orCreate: 'O crear una pieza nueva',
      arrangeHint: 'Arrastra para reordenar. TOP primero, BOT al lado — el orden que quieras.',
      dragHandle: 'Reordenar',
      reorderFailed: 'No se pudo guardar el orden de las piezas: {{error}}',
    },
    production: {
      title: 'Archivos de producción',
      subtitle: 'Huecos de producción de {{printer}}',
      addFile: 'Añadir archivo de producción',
      replace: 'Sustituir',
      delete: 'Eliminar',
      proceedAnyway: 'Continuar de todos modos',
      acceptBaseline: 'Aceptar como nueva base',
      cancel: 'Cancelar',
      reason: 'Motivo',
      reasonPlaceholder: '¿Por qué cambia la base?',
      parameterNote: 'Nota',
      parameterNotePlaceholder: '¿Por qué difiere este parámetro?',
      notesRequired: 'Explica cada parámetro que no coincida antes de continuar.',
      mismatchNote: 'Nota del desajuste',
      newSlotConfirm: 'Esto creará un hueco de producción nuevo, no sustituirá un archivo existente.',
      parseFailed: 'No se pudo interpretar el nombre. Completa los campos abajo.',
      versionNotNewer: 'La versión entrante {{incoming}} no es más reciente que {{current}}.',
      matchesSpec: 'Cumple la especificación',
      differsByDesign: 'Difiere por diseño',
      lastReplaceMismatched: 'La última sustitución tuvo discrepancias',
      emptyFolder: 'Aún no hay archivos de producción. Añade uno para crear el primer hueco.',
      quantity: 'Cantidad',
      version: 'Versión',
      noActiveFile: 'Sin archivo activo',
      uploadIntoProductionBlocked: 'Usa Sustituir o Añadir archivo de producción en lugar de la subida genérica.',
      moveIntoProductionBlocked: 'Gestionado por Production',
      mismatchCount: '{{count}} parámetro(s) difieren',
      parameter: 'Parámetro',
      lockedValue: 'Valor bloqueado',
      incomingValue: 'Valor entrante',
      code: 'Código de pieza',
      printer: 'Impresora',
      pickFile: 'Elegir archivo',
      confirmCreate: 'Crear hueco',
      currentVersion: 'Versión actual',
      incomingVersion: 'Versión entrante',
      printerMismatch: 'La impresora del archivo {{file}} no coincide con esta carpeta ({{folder}}).',
      dropToAdd: 'Suelta un archivo aquí para añadir un hueco de producción',
      print: 'Imprimir',
      loading: 'Cargando archivos de producción...',
      slotCreated: 'Hueco de producción creado',
      slotReplaced: 'Archivo de producción sustituido',
      deleteConfirmTitle: 'Eliminar archivo de producción',
      deleteConfirm: '¿Eliminar {{code}} x{{quantity}} {{version}} de {{printer}}? Esta acción no se puede deshacer.',
      deleteConfirmDetail:
        'Los archivos se moverán a la papelera del administrador de archivos, desde donde se pueden restaurar si hace falta.',
      slotDeleted: 'Hueco de producción eliminado',
      deleteFailed: 'No se pudo eliminar el hueco: {{error}}',
      createFailed: 'No se pudo crear el hueco: {{error}}',
      replaceFailed: 'No se pudo sustituir el archivo: {{error}}',
      previewFailed: 'No se pudo previsualizar la sustitución: {{error}}',
      slotExists: 'Ya existe un hueco para esta pieza y cantidad. Usa Sustituir.',
      newPartHint: 'Esto añadirá una pieza nueva ({{code}}).',
      newQuantityHint: '{{code}} ya tiene huecos. Se añadirá la cantidad x{{quantity}}.',
      sharedContractHint: 'Las variantes de cantidad de {{code}} en esta impresora comparten el mismo contrato de ajustes de impresión.',
      addPart: 'Añadir pieza',
      addPartTitle: 'Añadir pieza a esta impresora',
      partName: 'Nombre de la pieza',
      partCodeHint: 'Solo letras mayúsculas, 1–32 caracteres (por ejemplo TOP o LID).',
      confirmAddPart: 'Añadir pieza',
      partAdded: 'Pieza añadida',
      addPartFailed: 'No se pudo añadir la pieza: {{error}}',
      removePart: 'Quitar pieza',
      removePartConfirmTitle: 'Quitar pieza',
      removePartConfirmEmpty: '¿Quitar {{code}} ({{name}}) de {{printer}}? Podrás volver a añadirla más tarde.',
      removePartConfirmWithFiles: '¿Quitar {{code}} ({{name}}) de {{printer}}? {{count}} archivo(s) de producción se moverán a la papelera.',
      partRemoved: 'Pieza quitada',
      removePartFailed: 'No se pudo quitar la pieza: {{error}}',
      addFileToPart: 'Añadir archivo',
      emptyPart: 'Aún no hay archivos para esta pieza.',
      previewing: 'Comparando con la especificación...',
      uploading: 'Subiendo...',
      suggestedVersion: 'Siguiente versión sugerida: {{version}}',
      match: 'Coincide',
      mismatch: 'No coincide',
      specs: {
        view: 'Ver especificaciones',
        title: 'Especificaciones de impresión actuales',
        layerHeight: 'Altura de capa',
        initialLayerLineWidth: 'Ancho de línea de la primera capa',
        infillDensity: 'Densidad de relleno',
        infillPattern: 'Patrón de relleno',
        wallLoops: 'Paredes',
        brimType: 'Falda',
        brimWidth: 'Ancho de la falda',
        brimObjectGap: 'Holgura falda–objeto',
        fuzzySkin: 'Piel difusa',
        fuzzySkinPainted: 'Pintado',
        fuzzySkinAllowPaint: 'Permite pintar',
        fuzzySkinThickness: 'Grosor de la piel difusa',
        fuzzySkinPointDistance: 'Distancia entre puntos de la piel difusa',
        enableSupport: 'Soportes',
        supportType: 'Tipo de soporte',
        supportStyle: 'Estilo de soporte',
        supportTreeAuto: 'Árbol automático',
        supportTreeManual: 'Árbol manual',
        supportNormalAuto: 'Normal automático',
        supportNormalManual: 'Normal en modo manual',
        supportStyleSlim: 'Árbol delgado',
        supportStyleHybrid: 'Híbrido',
        supportStyleStrong: 'Árbol fuerte',
        supportStyleOrganic: 'Orgánico',
        supportStyleDefault: 'Predeterminado',
        supportStyleSnug: 'Ajustado',
        supportStyleGrid: 'Rejilla',
        enablePrimeTower: 'Torre de purga',
        seamPosition: 'Costura',
        nozzlesUsed: 'Boquillas',
        bed: 'Cama',
        bedTypeTexturedPei: 'PEI texturizado',
        bedTypeSmoothPei: 'PEI liso',
        bedTypeCool: 'Cool Plate',
        bedTypeSuperTack: 'Placa SuperTack',
        bedTypeEngineering: 'Engineering Plate',
        bedTypeHighTemp: 'High Temp Plate',
        on: 'Activado',
        off: 'Desactivado',
        brimAuto: 'Falda automática',
        brimNone: 'Sin falda',
        brimOuter: 'Solo exterior',
        brimInner: 'Solo interior',
        brimBoth: 'Exterior e interior',
        nozzlesLeft: 'Izquierda',
        nozzlesRight: 'Derecha',
        nozzlesBoth: 'Ambas',
        infillPatterns: {
          concentric: 'Concéntrico',
          rectilinear: 'Rectilíneo',
          monotonic: 'Monotónico',
          monotonicLine: 'Línea monotónica',
          alignedRectilinear: 'Rectilíneo alineado',
          hilbertCurve: 'Curva de Hilbert',
          archimedeanChords: 'Espiral de Arquímedes',
          octagramSpiral: 'Espiral octagonal',
        },
        valueMm: '{{value}}\u00a0mm',
        valuePercent: '{{value}} %',
        summaryInfill: '{{value}} % de relleno',
        summarySupports: 'Soportes: {{detail}}',
        summaryBrimGap: '{{value}}\u00a0mm de holgura',
        summaryBed: 'Cama: {{value}}',
      },
    },
  },
  ...
  printModal: {
    ...
    clickMaterialToMap: 'Haz clic en un material para elegir la ranura AMS',
    chooseMaterialSlot: 'Elige extrusor/color para el Material {{n}}',
    mustMapMaterials: 'Debes seleccionar/asignar materiales',
    unmappedSlot: '—',
    emptySlot: 'Vacío',
    noAmsSlots: 'Esta impresora no reporta bobinas AMS ni externas.',
    useAutoMatch: 'Usar coincidencia automática',
    reRead: 'Releer',
    plateN: 'Cama {{n}}',
  ...
  stats2: {
    capacityConfig: 'Stats 2 — Configuración de capacidad',
    applyWeekdayDefaults: 'Aplicar lun–vie 8:00–17:00',
    timezone: 'Zona horaria',
    capacityConfigDescription: 'Horas semanales de impresora, inicio de línea, limpieza de cama y receta del dispositivo (modelos de pieza). Usado por Stats 2.',
    lineStart: 'Inicio de línea (HH:MM)',
    preLineBuffer: 'Buffer previo a la línea (min)',
    expectedClear: 'Limpieza de cama esperada (min)',
    weeklyHours: 'Horas semanales con personal',
    weeklyHoursHint: 'Edita turnos por API por ahora; el editor completo llega con Stats 2.',
    unstaffed: 'Sin personal',
    saveGlobals: 'Guardar inicio de línea y limpieza',
    configSaved: 'Guardado — la capacidad se actualizará',
    unsavedChanges: 'Cambios sin guardar',
    deviceRecipe: 'Receta del dispositivo (modelos de pieza)',
    printerTimeBlocks: 'Bloques de tiempo de impresora (debe estar libre)',
    printerTimeBlocksHint:
      'Ventanas semanales recurrentes en las que una impresora debe permanecer inactiva. El horario semanal no colocará una impresión que se solape con estos bloques (incluido el tiempo de limpieza).',
    noPrintersForBlocks: 'No hay impresoras activas para configurar.',
    blockPrinter: 'Impresora',
    noBlocksYet: 'No hay ventanas reservadas para esta impresora.',
    blockLabel: 'Etiqueta (opcional)',
    addTimeBlock: 'Añadir bloque de tiempo',
    saveTimeBlocks: 'Guardar bloques de tiempo',
    invalidBlockRange: '{{day}}: el inicio del bloque debe ser anterior al fin ({{start}} → {{end}})',
    discoveredCount: '{{count}} archivo(s) descubierto(s)',
    pageTitle: 'Stats 2 — Capacidad real',
    deviceCapacity: 'Capacidad de dispositivos',
    todaysReadiness: 'Disponibilidad de hoy',
    printSchedule: 'Plan de impresión de la semana',
    buildPlan: 'Plan de construcción',
    buildPlanHint: 'Cada fila lista el/los archivo(s) de placa que el plan semanal inicia para esa pieza. Placas y piezas son arranques enteros del día seleccionado — las mismas barras que la línea de tiempo de arriba.',
    targetDevicesDay: 'Dispositivos objetivo / día',
    whatIf: 'Y si',
    capacityMaxHint: 'Máx. ~{{n}}/día',
    targetNotFeasible: 'Objetivo por encima de la capacidad de impresión',
    targetNotFeasibleBody: 'Pedidos {{target}}/día; el plan puede liberar unos {{achievable}}/día.',
    bindingPartSuffix: 'Pieza limitante: {{binding}}.',
    scenarioAtTarget: 'Simulación para {{n}} dispositivos/día — placas / piezas son arranques enteros de {{day}} arriba.',
    scenarioAtCapacity: 'Placas / piezas son arranques enteros de {{day}} arriba (capacidad realista). Introduce un objetivo para simular.',
    dedicatedFleetHint: 'La estimación de flota dedicada ~{{n}}/día ignora impresoras compartidas (las mismas máquinas contadas para cada pieza). Lo programable coincide con la línea de tiempo semanal.',
    cleanupFeedback: 'Limpieza: objetivo vs real',
    productionYield: 'Rendimiento de producción',
    leadTimes: 'Tiempos de ciclo en planta',
    qualityReasons: 'Calidad y motivos de pérdida',
    printerReliability: 'Fiabilidad de impresoras',
    filamentPerDevice: 'Filamento por dispositivo',
    configuration: 'Configuración',
    shortPartLine:
      '{{part}} {{packed}}/{{needed}} — hacen falta al menos {{extra}} impresora(s) {{models}} más',
    shortPartsHeading: 'Piezas cortas (mismo horario de operadores):',
    shortPartUnknownModels: 'elegibles',
    shortPartsSharedNote:
      'Las impresoras extra son mínimos por pieza (mismo horario). Los modelos compartidos cuentan una sola vez — no sume los números.',
    hypotheticalFleetNote:
      'La línea de tiempo incluye +{{n}} impresoras hipotéticas ({{detail}}) para esta petición — carriles discontinuos.',
    export: 'Exportar CSV',
  },
