...
Usage:
    python scripts/fill_spool_effects.py --bambuddy-url http://localhost:7474
    python scripts/fill_spool_effects.py --bambuddy-url http://localhost:7474 --api-key YOUR_KEY
