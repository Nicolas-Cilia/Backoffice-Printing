...
Add yourself (`@Nicolas-Cilia`) to bypass if you want to push directly in emergencies.
...
The `CODEOWNERS` file automatically requests reviews from `@Nicolas-Cilia` for all changes.
...
Example:
```
/backend/ @Nicolas-Cilia @backend-contributor
/frontend/ @Nicolas-Cilia @frontend-contributor
```
